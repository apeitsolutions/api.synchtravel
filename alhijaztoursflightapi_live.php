...
// $token_client='r9fdvwRyF35JUnD6xXdRiDELANYjtfASzPmyGol4-1PN461EY50LbXcqkfEfISsOJDrnFDJbuMzPuxTz37zFWGWBVemQGhi2SYLrr-MZ75vJSAiV73z94UOVrDz5P6R-0KjFqr9XR6P2857snQbcKTUn9YNqjBOQQIkXENeO7tmjxdTJs2KUVoXqo6fFyT9TTq99eKe288N-wyanZXxOsfABWPjtSom2oKLVz6vJnn1WeQwHSp7VnzPUqq53rn80eFXNBSMIiEXBdDmlsokRYSa0evDrQKluhnIzMYkRiazxtnkb-z5Xj0tQReTTHsLz1sgnit2mRGGzP4EIdBK8TiLuEN7GD1kmOT3CMreL7ELrI4yxmEbnYyflICtG-ySk3aZkk8iM9mRZlA7CS10Zuj-C0HEBOFW8vMzy4Eq2CET5WN62S1xe0HPAOrDVwO6jDvVpKEMwm-NiyyjkU8oTTlgYpN77pXtfFjKPTF0julnAMC6cPzxZOGBIkRv0';

$token_client = $_POST['token_authorization'];
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://restapi.myfarebox.com/api/CreateSession',
  //CURLOPT_URL => 'https://restapi.myfarebox.com/api/CreateSession',
...
function search_flights()
{
    ...
    if($token_authorization == $token_client){
        ...
        $data ='{"OriginDestinationInformations": [
        {
        ...
        $data .='
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/Search/Flight");
             //curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/Search/Flight");
...
function revalidation()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/Revalidate/Flight");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function flightfarerules()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/FlightFareRules");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function SeatMap()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/SeatMap/Flight");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function bookflight1()
{
 global $token_client;
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/Book/Flight");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function bookflight_new()
{
 global $token_client;
    ...
    if($token_authorization == $token_client)
    {
          ...
          //print_r($lead_passenger_details);die();
          $ConversationId=$_POST['ConversationId'];
           ...
           //print_r($revalidation_res);die();
            $other_passenger_details=$_POST['other_passenger_details'];
            $other_passenger_details=json_decode($other_passenger_details);
            //print_r($other_passenger_details);die();
            $child_details=$_POST['child_details'];
            $child_details=json_decode($child_details);
            $infant_details=$_POST['infant_details'];
            $infant_details=json_decode($infant_details);
          ...
          "FareSourceCode": "'.$revalidation_res->Data->PricedItineraries[0]->AirItineraryPricingInfo->FareSourceCode.'",
           "TravelerInfo": {
            "AirTravelers": [
              {
                "PassengerType": "ADT",
                "Gender": "'.$lead_passenger_details->gender.'",
                "PassengerName": {
                  "PassengerTitle": "'.$lead_passenger_details->title.'",
                  "PassengerFirstName": "'.$lead_passenger_details->first_name.'",
                  "PassengerLastName": "'.$lead_passenger_details->last_name.'"
                },
                "DateOfBirth": "'.$lead_passenger_details->date_of_birth.'",
                "Passport": {
                  "PassportNumber": "'.$lead_passenger_details->passport_no.'",
                  "ExpiryDate": "'.$lead_passenger_details->passport_expiry_date.'",
                  "Country": "'.$lead_passenger_details->passport_country.'"
                },
                "SpecialServiceRequest": {
                  "SeatPreference": "Any",
                  "MealPreference": "Any",
                  ...
                  if(isset($revalidation_res->Data->PricedItineraries))
                  {
                    foreach($revalidation_res->Data->PricedItineraries[0]->OriginDestinationOptions as $OriginDestinationOptions)
                    {
                        foreach($OriginDestinationOptions->FlightSegments as $FlightSegments)
                        {
                            
                        
                      $data .=' 
                    {
                      "Origin": "'.$FlightSegments->DepartureAirportLocationCode.'",
                      "Destination": "'.$FlightSegments->ArrivalAirportLocationCode.'",
                      "FlightNumber": "'.$FlightSegments->FlightNumber.'",
            ...
            $data .='
             ...
             $data .='
              ...
              $data .='
               "PassengerNationality": "'.$lead_passenger_details->passenger_nationality_id.'",
               "NationalID": "'.$lead_passenger_details->passenger_nationality_id.'"
            ...
            "CountryCode": "'.$lead_passenger_details->passenger_nationality_code.'",
            "AreaCode": "'.$lead_passenger_details->passenger_nationality_code.'",
            "PhoneNumber": "'.$lead_passenger_details->passenger_phone_no.'",
            "Email": "'.$lead_passenger_details->email.'",
            "PostCode": "'.$lead_passenger_details->postal_code.'"
          },
          "Target": "Test",
          "ConversationId": "'.$ConversationId.'",
          "LocHoldBooking": "false"
...
function tripdetails()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/TripDetails/".$UniqueID);
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
...
function multicity_search_flights()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v2/multiCityFaresBETA/Search/Flight");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function CancelBookingflight()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/Booking/Cancel");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function ViewReservationflight()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1.1/TripDetails/".$UniqueID);
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
...
function ScheduleChangeFlight()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/ScheduleChange");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function OrderTicketFlight()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/v1/OrderTicket");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
...
function VoidQuoteRequest()
{
    ...
    if($token_authorization == $token_client)
    {
        ...
        $headers  = array('Accept: application/json','Content-Type: application/json;' , $authorization);
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://restapi.myfarebox.com/api/PostTicketingRequest");
        curl_setopt($ch, CURLOPT_PORT , 443);
        curl_setopt($ch, CURLOPT_VERBOSE, 0);
        curl_setopt($ch, CURLOPT_HEADER, 0);
        curl_setopt($ch, CURLOPT_POST, 1);
