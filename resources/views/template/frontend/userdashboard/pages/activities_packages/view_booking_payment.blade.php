        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding: 15px;">
                    ...
                    <input class="form-control" type="text" value="{{ $decode_customer_data[0]->fname }}">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4" style="padding: 15px;">
                    <label for="">Package Title</label>
                    <input class="form-control" type="text" value="{{ $cart_details->name }}">
                </div>
                <div class="col-md-4" style="padding: 15px;">
                ...
                <div class="col-md-4" style="padding: 35px 0px 0px 17px;">
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#recieve_payment_modal">Receieve Payement</button>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="p-1">
                <div class="modal-body px-3 pt-3 pb-0">
                    <form action="{{ URL::to('super_admin/view_booking_payment_recieve')}}/{{$cart_details->tourId}}" method="post">
                        @csrf
                        
                        <div class="mb-2">
                          <label for="tourId" class="form-label">Tour ID</label>
                          <input readonly value="{{ $cart_details->tourId }}" name="tourId" class="form-control" type="text" id="tourId" required="">
                        </div>
                        ...
                        <div class="mb-2">
                          ...
                          <input readonly name="customer_name" value="{{ $decode_customer_data[0]->fname }}" class="form-control" type="text" id="customer_name" required="">
                        </div>

                        <div class="mb-2">
                          <label for="package_title" class="form-label">Package Title</label>
                          <input readonly name="package_title" value="{{ $cart_details->name }}" class="form-control" type="text" id="package_title" required="" >
                        </div>
