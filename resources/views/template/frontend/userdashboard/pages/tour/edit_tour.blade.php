...
<form action="{{URL::to('super_admin/submit_edit_tour',[$tours->id])}}" method="post" enctype="multipart/form-data">
@csrf
<div class="card-body">

 <h4 class="header-title mb-3">Edit Tour</h4>

<div class="row">
<div class="col-xl-12">
 <div class="mb-3">
    <label for="simpleinput" class="form-label">Title</label>
    <input type="text" id="simpleinput" name="title" value="{{$tours->title}}" class="form-control">
</div>
</div>
...
<div class="col-xl-12">
 <div class="mb-3">
    ...
    <textarea name="content" id="snow-editor" cols="142" rows="10">{{$tours->content}}</textarea>
...
<div class="col-xl-4">
 <div class="mb-3">
    ...
    <input type="text" name="start_date" class="form-control date" value="{{$tours->start_date}}"  id="start_date" data-toggle="date-picker" data-single-date-picker="true">
</div>
</div>
...
<div class="col-xl-4">
 <div class="mb-3">
    ...
    <input type="text" name="end_date" class="form-control date" value="{{$tours->end_date}}" id="enddate" data-toggle="date-picker" data-single-date-picker="true">
</div>
</div>
<div class="col-xl-4">
 <div class="mb-3">
    <label for="simpleinput" class="form-label">Duration</label>
    <input type="text" name="time_duration" value="{{$tours->time_duration}}" id="duration" class="form-control" >
</div>
</div>
...
<div class="col-xl-6">
 <div class="mb-3">
    ...
    <textarea name="tour_real_address" value="{{$tours->tour_real_address}}" class="form-control" id="" cols="10" rows="0"></textarea>
...
<div class="col-xl-6">
 <div class="mb-3">
    ...
    <input type="text" id="simpleinput" value="{{$tours->tour_pricing}}" name="tour_pricing" class="form-control">
</div>
</div>
...
<div class="col-xl-6">
 <div class="mb-3">
    ...
    <input type="text" id="simpleinput" value="{{$tours->tour_sale_price}}" name="tour_sale_price" class="form-control">
</div>
</div>
...
<div class="col-xl-6">
 <div class="mb-3">
    ...
    <select class="select2 form-control select2-multiple" name="attributes[]" data-toggle="select2" multiple="multiple" data-placeholder="Choose ...">
...
<div class="col-xl-6">
 <div class="mb-3">
    ...
    <input type="number" value="{{$tours->tour_min_people}}" id="simpleinput" name="tour_min_people" class="form-control">
</div>
</div>
<div class="col-xl-6">
 <div class="mb-3">
    <label for="simpleinput" class="form-label">Tour Max People</label>
    <input type="number" id="simpleinput" value="{{$tours->tour_max_people}}" name="tour_max_people" class="form-control">
</div>
</div>
...
<button style="float: right;" type="submit" name="submit" class="btn btn-info deletButton">Edit Tour</button>
