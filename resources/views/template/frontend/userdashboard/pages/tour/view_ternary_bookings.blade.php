                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        ...
                                        <!--<table class="table nowrap table-striped table-vcenter dataTable no-footer" id="example_1">-->
                                        <table style="width: 100%;" class="table nowrap table-striped table-vcenter dataTable no-footer" id="my_Table">
                                            
                                            <thead class="table-light">
                                                <tr>
                                                    <th style="text-align: center;display:none;">Booking Id</th>
                                                    <th style="text-align: center;">Sr No.</th>
                                                    <th style="text-align: center;">Customer Name</th>
                                                    <th style="text-align: center;">Package Details</th>
                                                    <th style="text-align: center;">Pax Details</th>
                                                    <th style="text-align: center;">Total Amount</th>
                                                    <th style="text-align: center;display:none">Payment Status</th>
                                                    <th style="text-align: center;width: 85px;display:none">Action</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody id="myTable" style="text-align: center;">
                                                ...
                                                @foreach ($data as $value)
                                                    ...
                                                    ?> 
                                                    <tr>
                                                        <td class="P_Id d-none">{{ $value->booking_id }}</td>
                                                        <td>
                                                            {{ $i }}<br>
                                                            <a id="view_remaining_details_id_{{ $i }}" onclick="view_remaining_details_button({{ $i }})" style="display:none">View More...</a>
                                                            <a id="hide_remaining_details_id_{{ $i }}" onclick="hide_remaining_details_button({{ $i }})" style="display:none">View Less...</a>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span style="display:none" class="badge bg-success" style="font-size: 15px" onclick="add_special_discount('{{ $value->invoice_no }}',{{ $value->price }})">Add Special Discount</span>
                                                        </td>
                                                        <td class="payment_status{{ $value->booking_id }}" style="display:none"></td>
                                                        <td style="padding-right: 50px;padding-top: 40px;display:none">
                                                            <div class="dropdown card-widgets">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                                    ...
                                                                    <!--<a class="dropdown-item" onclick="add_more_passenger({{$value->id}})" data-id="{{ $value->id }}" data-bs-toggle="modal" data-bs-target="#add-more-passenger-modal">Add More Passengers</a>-->
                                                                    <a href="{{ URL::to('super_admin/view_booking_payment')}}/{{$value->booking_id}}/{{$value->tour_id}}/{{$value->id}}" class="dropdown-item"><i class="mdi mdi-eye me-1"></i>View Payment</a>
                                                                    ...
                                                                    <a href="{{URL::to('view_payment_history')}}/{{$value->invoice_no}}/{{$value->booking_id}}/{{$value->tour_id}}" class="dropdown-item"><i class="mdi mdi-eye me-1"></i>View Payment History</a>
                                                                    ...
                                                                    @endif
                                                                    <a href="{{ URL::to('edit_booking/'.$value->invoice_no.'') }}" class="dropdown-item">
                                                                        <i class="mdi mdi-check-circle me-1"></i>
                                                                        Edit
                                                                    </a>
                                                                    <a href="{{ URL::to('delete_booking/'.$value->booking_id.'') }}" class="dropdown-item" onclick="return confirm('Are you sure you want to delete?');">
                                                                        <i class="mdi mdi-check-circle me-1"></i>
                                                                        Delete
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <tr id="remaining_tr_{{ $i }}" style="border: solid #ed722a 2px;display:none">
