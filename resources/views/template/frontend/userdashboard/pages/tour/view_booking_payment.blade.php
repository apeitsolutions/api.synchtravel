        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding: 35px 0px 0px 17px;">
                    <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#recieve_payment_modal">Receieve Payment Package</button>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="p-1">
                <div class="modal-body px-3 pt-3 pb-0">
                    <form action="{{ URL::to('super_admin/view_booking_payment_recieve')}}/{{$cart_details->tour_id}}" method="post">
                        @csrf
