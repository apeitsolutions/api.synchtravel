                  ...
                  <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Confirmed Bookings Activity</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Confirmed Bookings Activity</h4>
                  </div>
              </div>
          </div>
          <!-- end page title --> 
                          ...
                          <thead class="table-light">
                            ...
                            <tbody>
                              @foreach ($data as $key => $value)
                                  @if($value->confirm == 1 && $value->pakage_type == 'activity')
                                    <tr>
