                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                    <h2>Please create your Password By clicking the Button</h2>
{{--                                    <h3>Amazing deals, updates, interesting news right in your inbox</h3>--}}
                                    <p><a class="btn btn-primary" href="{{url('lead_passenger/create_password')}}" target="_blank">Create Password</a>
                                        </p>
