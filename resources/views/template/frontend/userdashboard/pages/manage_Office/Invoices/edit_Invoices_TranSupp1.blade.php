...
<div class="card">
    <div class="card-body">
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('update_Invoices_TranSupp1',[$get_invoice->id])}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <div id="progressbarwizard">
                    ...
                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3" style="margin-right: 1px;margin-left: 1px;">
                        ...
                        @endif
                        @if($get_invoice->flights_details != null || $get_invoice->flights_details_more != null)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <!--<input type="text" id="simpleinput" name="title" class="form-control titleP" >-->
                                            ...
                                            <select class="form-control  external_packages" onchange="selectServices()" data-toggle="select2" multiple="multiple" id="select_services" name="services[]">
                                                ...
                                                <option <?php if($services[0] == '1') echo "selected" ?> value="All Services">All Services</option>
                                                <option <?php if($services[0] == 'accomodation_tab') echo "selected" ?> value="accomodation_tab">Accomodation</option>
                                                <option <?php if($services[0] == 'flights_tab') echo "selected" ?> value="flights_tab">Flights Details</option>
                                                <option <?php if($services[0] == 'visa_tab') echo "selected" ?> value="visa_tab">Visa Details</option>
                                                <option <?php if($services[0] == 'transportation_tab') echo "selected" ?> value="transportation_tab">Transportation</option>
                                            </select>
                                    </div>
                                </div>
                                           ...
                                           <option value="">Choose...</option>
                                            @if(isset($Agents_detail) && $Agents_detail !== null && $Agents_detail !== '')
                                                @foreach($Agents_detail as $Agents_details)
                                                    <option attr_agent="{{ $Agents_details->id }}" <?php if($get_invoice->agent_Name == $Agents_details->agent_Name) echo "selected" ?> value="{{ $Agents_details->agent_Name }}">{{ $Agents_details->agent_Name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                </div>
                                <input type="hidden" value="" id="agent_ids_select" name="agent_id" class="form-control">
                                <div class="col-xl-2">
                                    <div class="mb-3">
                                        <div id="tooltip-container">
                                        ...
                                        <div class="row" style="border: 1px solid #ebebeb;padding: 1rem;border-radius: 6px;">
                                            <div class="col-xl-6">
                                             ...
                                             <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="email" class="form-control" required value="{{$get_invoice->email}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="mobile" class="form-control" required value="{{$get_invoice->mobile}}">
                                                </div>
                                            </div>
                                     ...
                                     <div class="mb-3">
                                        <!--<div id="tooltip-container">-->
                                            @if(isset($get_invoice->services) && $get_invoice->services != null && $get_invoice->services != '')
                                                ...
                                                @else
                                                    <label for="simpleinput" class="form-label">Total Duration</label>
                                                @endif
                                            @endif
                                            <!--<i class="dripicons-information" style="font-size: 17px;" id="title_Icon"-->
                                                ...
                                                <div class="mb-2" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="del_hotelI{{ $i }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <input value="{{ $details->hotel_city_name ?? ''}}" type="text" name="hotel_city_name[]" class="form-control property_city_newInput_I property_city_new_{{ $i }}"/>
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <div class="input-group" id="add_hotel_div{{ $i }}">
                                                                <input type="text" onchange="hotel_funI({{ $i }})" value="{{$details->acc_hotel_name}}" id="acc_hotel_name_{{ $i }}" name="acc_hotel_name[]" class="form-control acc_hotel_name_class_{{ $i }}">
                                                            </div>
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <input type="text" value="{{$details->acc_no_of_nightst}}" id="acomodation_nights_{{$i}}" name="acc_no_of_nightst[]" class="form-control acomodation_nights_class_{{$i}}">
                                                        </div>
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="makkah_acc_room_price_{{$i}}" onchange="makkah_acc_room_price_funsI({{$i}})" value="{{$details->price_per_room_purchase}}" name="price_per_room_purchase[]" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="makkah_acc_price_{{$i}}" onchange="makkah_acc_price_funs({{$i}})" value="{{$details->acc_price_purchase}}" name="acc_price_purchase[]" class="form-control makkah_acc_price_class_{{$i}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" id="exchange_rate_price_funs_{{$i}}" value="{{$details->exchange_rate_price}}" onchange="exchange_rate_price_funsI({{$i}})" value="" name="exchange_rate_price[]" class="form-control">
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        @if(isset($more_details->more_hotel_city) && $more_details->more_hotel_city != null && $more_details->more_hotel_city != '')
                                                                            @if($details->hotel_city_name == $more_details->more_hotel_city)    
                                                                                <div id="click_delete_{{$divId}}" class="mb-2 mt-3" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;">
                                                                                    ...
                                                                                    <input type='hidden' name="more_hotel_city[]" value="{{$more_details->more_hotel_city}}" id="more_hotel_city{{$more_details->more_hotel_city}}"/>
                                                                                    ...
                                                                                    <div class="row" style="padding:20px;">
                                                                                        ...
                                                                                        <input type='hidden' value="{{ $more_details->more_hotel_city }}" id="more_hotel_city{{ $divId }}"/>
                                                                                        ...
                                                                                        <div class="col-xl-3">
                                                                                            ...
                                                                                            <div class="input-group more_hotel_type_add_div_{{ $divId }} more_hotel_type_add_div">
                                                                                                <select onchange="more_hotel_type_fun({{ $divId }})" name="more_acc_type[]" id="more_hotel_type_{{ $divId }}" class="form-control other_Hotel_Type more_hotel_type_class_{{ $divId }}" data-placeholder="Choose ...">
                                                                                                    <option value="">Choose...</option>
                                                                                                    <option <?php if($more_details->more_acc_type == 'Quad') echo 'selected'; ?> attr="4" value="Quad">Quad</option>
                                                                                                    <option <?php if($more_details->more_acc_type == 'Triple') echo 'selected'; ?> attr="3" value="Triple">Triple</option>
                                                                                                    <option <?php if($more_details->more_acc_type == 'Double') echo 'selected'; ?> attr="2" value="Double">Double</option>
                                                                                                </select>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col-xl-3">
                                                                                            <label for="">Quantity</label>
                                                                                            <input value="{{$more_details->more_acc_qty}}" onchange="more_acc_qty_classInvoice({{$divId}})" type="text" id="simpleinput" name="more_acc_qty[]" class="form-control more_acc_qty_class_{{$divId}}">
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-xl-4">
                                                                                            ...
                                                                                            <div class="input-group">
                                                                                                ...
                                                                                                <input type="text"  onchange="more_makkah_acc_room_price_funsI({{$divId}},{{$divId}})" value="{{$more_details->more_price_per_room_purchase}}" id="more_makkah_acc_room_price_funs_{{$divId}}" name="more_price_per_room_purchase[]" class="form-control">
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="col-xl-6" >
                                                                                            ...
                                                                                            <div class="input-group">
                                                                                                ...
                                                                                                <input type="text" id="more_exchange_rate_price_funs_{{$divId}}" onchange="more_exchange_rate_price_funsI({{$divId}})" value="{{$more_details->more_exchange_rate_price}}" name="more_exchange_rate_price[]" class="form-control">
                                                                                            </div>
                                                                                        </div>
                                                        ...
                                                        <div class="mt-2">
                                                            <a href="javascript:;" onclick="add_more_accomodation_Invoice({{ $divId }})" class="btn btn-info" style="float: right;"> + Add More </a>
                                                        </div>
            ...
            <?php
        // dd($get_invoice);
            $direct_data = json_decode($get_invoice->flights_details);
           $indirect_data = $get_invoice;
            ?>
                            ...
                            <div class="row" style="display:none;" id="select_flights_inc">
                                ...
                                <div class="col-xl-6" style="padding-left: 24px;">
                                    ...
                                    <select name="flight_type" id="flights_type" class="form-control flight_direct_type">
                                        ...
                                        @if($direct_data->flight_type == "Direct")
                                         <option attr="Direct" selected value="Direct">Direct</option>
                                         @else
                                          <option attr="Indirect" selected value="Indirect">Indirect</option>
                                          @endif
                                    </select>
                                </div>
                                ...
                                <div class="container Flight_section">
                                    ...
                                    <div class="row" style="padding: 12px">
                                        <div class="col-xl-4">
                                            ...
                                            <input name="departure_airport_code" id="departure_airport_code" readonly value="{{$direct_data->departure_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Departure Location">
                                            <!--<input name="departure_airport_code" id="departure_airport_cod" readonly value="{{$direct_data->departure_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Departure Location">-->
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            ...
                                            <input name="arrival_airport_code" id="arrival_airport_code" readonly value="{{$direct_data->arrival_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Arrival Location">
                                            <!--<input name="arrival_airport_code" id="arrival_airport_cod" readonly value="{{$direct_data->arrival_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Arrival Location">-->
                                            
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Airline Name</label>
                                            <input type="text" id="other_Airline_Name2" readonly value="{{$direct_data->other_Airline_Name2}}" name="other_Airline_Name2" class="form-control other_airline_Name1">
                                            <!--<input type="text" id="other_Airline_Name" readonly value="{{$direct_data->other_Airline_Name2}}" name="other_Airline_Name2" class="form-control other_airline_Name1">-->
                                        ...
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            ...
                                            <select  name="departure_Flight_Type" id="departure_Flight_Type" class="form-control">
                                                ...
                                                @if($direct_data->departure_Flight_Type == "Bussiness")
                                                <option value="Bussiness" selected >Bussiness</option>
                                                @elseif($direct_data->departure_Flight_Type == "Economy")
                                                <option value="Economy" selected>Economy</option>
                                                @elseif($direct_data->departure_Flight_Type == "Standard")
                                        ...
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            ...
                                            <input type="text" id="simpleinput" name="departure_flight_number" value="{{$direct_data->departure_Flight_Type ?? ""}}" class="form-control" placeholder="Enter Flight Number">
                                        </div>
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            <label for="">Departure Date and Time</label>
                                            <input type="datetime-local" id="simpleinput"  value="{{$direct_data->departure_time ?? ""}}" readonly name="departure_time" class="form-control departure_time1" value="" >
                                        </div>
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            <label for="">Arrival Date and Time</label>
                                            <input type="datetime-local" id="simpleinput"  value="{{$direct_data->arrival_time ?? ""}}" readonly name="arrival_time" class="form-control arrival_time1" value="" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container return_Flight_section">
                                    ...
                                    <div class="row" style="padding: 12px">
                                        <div class="col-xl-4">
                                            <label for="">Departure Airport</label>
                                            <input name="return_departure_airport_code" id="return_departure_airport_code" readonly value="{{$direct_data->return_departure_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Return Location">
                                            <!--<input name="return_departure_airport_code" id="return_departure_airport_cod" readonly value="{{$direct_data->return_departure_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Return Location">-->
                                        </div>
                                        <div class="col-xl-1" style="margin-top: 25px;text-align: center;">
                                            <label for=""></label>
                                        ...
                                        <div class="col-xl-4">
                                            <label for="">Arrival Airport</label>
                                            <input name="return_arrival_airport_code" id="return_arrival_airport_code" readonly value="{{$direct_data->return_arrival_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Return Location">
                                            <!--<input name="return_arrival_airport_code" id="return_arrival_airport_cod" readonly value="{{$direct_data->return_arrival_airport_code}}" class="form-control" autocomplete="off" placeholder="Enter Return Location">-->
                                            
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Airline Name</label>
                                            <input type="text" id="return_other_Airline_Name2" value="{{$direct_data->return_other_Airline_Name2 ?? ""}}" readonly  name="return_other_Airline_Name2" class="form-control other_airline_Name1">
                                            <!--<div class="input-group">-->
                                        ...
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            ...
                                            <select  name="return_departure_Flight_Type" id="return_departure_Flight_Type" class="form-control">
                                                <option value="">Select Flight Type</option>
                                                @if($direct_data->return_departure_Flight_Type == "Bussiness")
                                                <option value="Bussiness" selected >Bussiness</option>
                                                @elseif($direct_data->return_departure_Flight_Type == "Economy")
                                                <option value="Economy" selected>Economy</option>
                                                @elseif($direct_data->return_departure_Flight_Type == "Standard")
                                                <option value="Standard" selected>Standard</option>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            <label for="">Flight Number</label>
                                            <input type="text" id="simpleinput" value="{{$direct_data->return_other_Airline_Name2 ?? ""}}" name="return_departure_flight_number" class="form-control" placeholder="Enter Flight Number">
                                        </div>
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            <label for="">Departure Date and Time</label>
                                            <input type="datetime-local" id="simpleinput"  value="{{$direct_data->return_departure_time ?? ""}}" name="return_departure_time" class="form-control return_departure_time1"  >
                                        </div>
                                        <div class="col-xl-3" style="margin-top: 15px;">
                                            <label for="">Arrival Date and Time</label>
                                            <input type="datetime-local" id="simpleinput" name="return_arrival_time" class="form-control return_arrival_time1" value="{{$direct_data->return_arrival_time ?? ""}}" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container" style="display:none" id="return_total_Time_Div">
                                    <div class="row" style="margin-left: 320px">
                                        ...
                                        <div class="col-sm-3">
                                             <label for="">Transit Time</label>
                                            <input type="text" id="return_total_Time" name="return_total_Time" class="form-control return_total_Time1" readonly style="width: 170px;" value="{{$direct_data->return_total_Time ?? ""}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6" style="padding-left: 24px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="flights_per_person_price" value="{{$direct_data->flights_per_person_price ?? ""}}" name="flights_per_person_price" class="form-control">
                                    </div>
                                </div>
                                
                                <div class="col-xl-12 mt-3" style="display:none" id="text_editer">
                                    <label for="">Indirect Flight Duration and Details</label>
                                    <textarea name="connected_flights_duration_details" class="form-control" cols="10" rows="10">{{$direct_data->connected_flights_duration_details ?? ""}}</textarea>
                                </div>
                                
                                <div class="col-xl-12 mt-2" style="padding-left: 24px;">
                                    <label for="">Additional Flight Details</label>
                                    <textarea name="terms_and_conditions" class="form-control" cols="5" rows="5">{{$direct_data->connected_flights_duration_details ?? ""}}</textarea>
                                </div>
                                                                    ...
                                                                    <div class="row" id="costing_accI{{$count}}" style="margin-bottom:20px;">
                                                                                ...
                                                                                <div class="col-xl-12 d-none">
                                                                                    @if(isset($details->markup_price) && $details->markup_price != null && $details->markup_price != '')
                                                                                        @if($details->markup_price == $accomodation_detailsS->hotel_invoice_markup)
                                                                                            <h4> 
                                                                                                Accomodation Details {{ $accomodation_detailsS->hotel_city_name ?? '' }}
                                                                                                <a class="btn">
                                                                                                    (Hotel Name : <b style="color: #cdc0c0;">{{ $accomodation_detailsS->acc_hotel_name ?? '' }}</b>)
                                                                        ...
                                                                        <div class="col-xl-12">
                                                                            ...
                                                                            @if(isset($details->acc_hotel_CityName) && $details->acc_hotel_CityName != null && $details->acc_hotel_CityName != '')
                                                                                <h4> 
                                                                                    Accomodation Details {{ $details->acc_hotel_CityName ?? '' }}
                                                                                    <a class="btn">
                                                                                        (Hotel Name : <b style="color: #cdc0c0;">{{ $details->acc_hotel_HotelName ?? '' }}</b>)
                                                                    ...
                                                                    <div style="padding-bottom: 5px;" class="row click_deleteI_{{$count}}" id="click_deleteI_{{$count}}">
                                                                                ...
                                                                                <div class="col-xl-12 d-none">
                                                                                    @if(isset($details->more_markup_price) && $details->more_markup_price != null && $details->more_markup_price != '')
                                                                                        @if($details->more_markup_price == $accomodation_details_moreS->more_hotel_invoice_markup)
                                                                                            <h4 class="" id="">
                                                                                                More Accomodation Cost {{ $accomodation_details_moreS->more_hotel_city ?? '' }}
                                                                                                <a class="btn">
                                                                                                    (Hotel Name : <b style="color: #cdc0c0;">{{ $accomodation_details_moreS->more_acc_hotel_name ?? '' }}</b>)
                                                                        ...
                                                                        <div class="col-xl-12">
                                                                            ...
                                                                            @if(isset($details->more_acc_hotel_CityName) && $details->more_acc_hotel_CityName != null && $details->more_acc_hotel_CityName != '')
                                                                                <h4> 
                                                                                    Accomodation Details {{ $details->more_acc_hotel_CityName ?? '' }}
                                                                                    <a class="btn">
                                                                                        (Hotel Name : <b style="color: #cdc0c0;">{{ $details->more_acc_hotel_HotelName ?? '' }}</b>)
                                                                            ...
                                                                            @else
                                                                                <h4>
                                                                                    More Accomodation Cost {{ $details->more_acc_hotel_CityName ?? '' }}
                                                                        ...
                                                                        <div class="col-xl-2">
                                                                            ...
                                                                            <input type="hidden" id="" name="" class="form-control">
                                                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                                <input type="text"  class="form-control" id="more_hotel_markup_{{$count}}" value="{{$details->more_markup}}" name="more_markup[]" onchange="get_markup_invoice_price({{ $count }})">
                                                                                <span class="input-group-btn input-group-append">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var data = {!!json_encode($indirect_data)!!};
        var flighttype = JSON.parse(data['flights_details']);
        console.log(flighttype['flight_type']);
        if(flighttype['flight_type'] == "Indirect"){
       
        var moreFlight = data['flights_details_more'];
        var moreFlight = JSON.parse(moreFlight);
        
      
                     var dep_length = moreFlight.length;
                     console.log("length"+dep_length);
             ...
             $('.flight_direct_type').append(flight_option);
              ...
              $('.flights_type_code').val("Indirect");
        ...
        //   console.log(moreFlight);
            $('#flights_arrival_code').val(moreFlight[0]['more_departure_airport_code']);
              for (let i = 0; i < moreFlight.length; i++) {
                
               var flights_details_morez_key = moreFlight[i];
            
                var flight_Data =   `<h3 style="padding: 12px">Departure Details : </h3>
                                     <div class="row" style="padding: 12px">
                                        <div class="col-xl-4">
                                            <label for="">Departure Airport</label>
                                            <input name="more_departure_airport_code[]" readonly value="${flights_details_morez_key['more_departure_airport_code']}" id="departure_airport_code_${i}" class="form-control" autocomplete="off" placeholder="Enter Departure Location">
                                        </div>
                                        <div class="col-xl-1" style="margin-top: 25px;text-align: center;">
                                            <label for=""></label>
                                        ...
                                        <div class="col-xl-4">
                                            <label for="">Arrival Airport</label>
                                            <input name="more_arrival_airport_code[]" readonly value="${flights_details_morez_key['more_arrival_airport_code']}" id="arrival_airport_code_${i}" class="form-control" autocomplete="off" placeholder="Enter Arrival Location">
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Airline Name</label>
                                            <input type="text" id="other_Airline_Name2_${i}" readonly value="${flights_details_morez_key['more_other_Airline_Name2']}" name="more_other_Airline_Name2[]" class="form-control other_airline_Name1_${i}">
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Class Type</label>
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <input type="text" id="simpleinput_${i}" readonly value="${flights_details_morez_key['more_departure_flight_number']}" name="more_departure_flight_number[]" class="form-control" placeholder="Enter Flight Number">
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Departure Date & Time</label>
                                            <input type="datetime-local" id="simpleinput_${i}" readonly  value="${flights_details_morez_key['more_departure_time']}" name="more_departure_time[]" class="form-control departure_time1_${i}" >
                                        </div>
                                        <div class="col-xl-3">
                                            <label for="">Arrival Date and Time</label>
                                            <input type="datetime-local" id="simpleinput_${i}" readonly value="${flights_details_morez_key['more_arrival_time']}" name="more_arrival_time[]" class="form-control arrival_time1_${i}" >
                                        </div>
                                    </div>
                                   ...
                                   <div class="row" style="margin-left: 303px;">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="text" id="total_Time" name="more_total_Time[]" readonly value="${flights_details_morez_key['more_total_Time']}" class="form-control total_Time1_${i}" readonly style="width: 167px;">
                                                    </div>
                                                </div>
                                    </div>`;
                ...
                var return_flight_Data = `<h3 style="padding: 12px">Return Details : </h3>
                                          <div class="row" style="padding: 12px">
                                            <div class="col-xl-4">
                                                <label for="">Departure Airport</label>
                                                <input name="return_more_departure_airport_code[]" readonly value="${flights_details_morez_key['return_more_departure_airport_code']}" id="return_departure_airport_code_${i}" class="form-control" autocomplete="off" placeholder="Enter Return Location">
                                            </div>
                                            <div class="col-xl-1" style="margin-top: 25px;text-align: center;">
                                                <label for=""></label>
                                            ...
                                            <div class="col-xl-3">
                                                <label for="">Airline Name</label>
                                                <input type="text" id="return_other_Airline_Name2_${i}" readonly value="${flights_details_morez_key['return_more_other_Airline_Name2']}" name="return_more_other_Airline_Name2[]" class="form-control other_airline_Name1">
                                            </div>
                                            <div class="col-xl-3">
                                                <label for="">Class Type</label>
                                            ...
                                            <div class="col-xl-3">
                                                <label for="">Flight Number</label>
                                                <input type="text" id="simpleinput_${i}" readonly value="${flights_details_morez_key['return_more_flight_number']}" name="return_more_departure_flight_number[]" class="form-control" placeholder="Enter Flight Number">
                                            </div>
                                            <div class="col-xl-3">
                                                <label for="">Departure Date and Time</label>
                                                <input type="datetime-local" id="simpleinput_${i}" readonly name="return_more_departure_time[]" value="${flights_details_morez_key['return_more_departure_time']}" class="form-control return_departure_time1_${i}" >
                                            </div>
                                            <div class="col-xl-3">
                                                <label for="">Arrival Date and Time</label>
                                                <input type="datetime-local" id="simpleinput_${i}" readonly name="return_more_arrival_time[]" value="${flights_details_morez_key['return_more_arrival_time']}" class="form-control return_arrival_time1_${i}" >
                                            </div>
                                        </div>
                                        <div class="container return_total_Time_Div_data_append">
                                          <div class="row" style="margin-left: 303px;">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <label for="">Flight Duration</label>
                                                        <input type="text" id="total_Time" name="more_total_Time[]" readonly value="${flights_details_morez_key['return_more_total_Time']}" class="form-control total_Time1_${i}" readonly style="width: 167px;">
                                                    </div>
                                                </div>
                                        </div>`;
        ...
        console.log(return_flight_Data);
                $('.Flight_section').hide();
                ...
                // $('.seat_append').append(seattr);
                      ...
                      var datetr =`
                            ...
                            `;
                             var pax = $(".pax_number").val();
                            //  console.log(pax);
                             var reservation = `<td class="text-center"> <input type="number" min="${pax}" max="${direct_seat}" value="${pax}" class="form-control"  placeholder="Enter Reservation"></td>`;
    ...
    // });
     ...
     $('.hide_direct').show();
            ...
            // var flights_per_person_price = $('.flights_per_person_price12345').val();
                    ...
                    $('.return_flight_number').val(direct_return_Flight_number);
...
<script>
    ...
    function selectCitiesI(){
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                $('.property_city_new_selectI').html(result);
    ...
    function put_tour_locationI(id){    
        ...
        $('#acc_hotel_Quantity'+id+'').val(acc_qty_class);
    ...
    $("#add_hotel_accomodation").on('click',function(){
        ...
        if(city_No > 0){
            ...
            for (let i = 1; i <= city_No; i++) {
                ...
                var data = `<div class="mb-2" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="del_hotel${i}">
                                ...
                                <div class="row" style="padding-bottom: 25px;">
                                    ...
                                    <h4 class="mt-4">Purchase Price</h4>
                                        ...
                                        <input type="hidden" id="hotelRoom_type_id_${divId}" name="hotelRoom_type_id[]">
                                        
                                        <input type="hidden" id="hotelRoom_type_idM_${divId}" name="hotelRoom_type_idM[]">
                ...
                // document.getElementById('makkah_accomodation_check_in_'+i+'').setAttribute('min', today);
                // document.getElementById('makkah_accomodation_check_out_date_'+i+'').setAttribute('min', today);
        ...
        var data = `<div class="mb-2" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="del_hotel${i}">
                        ...
                        <div class="row" style="padding-bottom: 25px;">
                            ...
                            <div class="col-xl-3"><label for="">Room Type</label>
                                ...
                                <div class="input-group hotel_type_select_div_${i}" style="display:none">
                                    <select onchange="hotel_type_funInvoice(${i})" name="acc_type_select[]" id="hotel_type_${i}" class="form-control other_Hotel_Type hotel_type_select_class_${i}"  data-placeholder="Choose ...">
                                        <option value="">Choose ...</option>
                                    </select>
                                </div>
                                
                            </div>
                            <div class="col-xl-3"><label for="">Quantity</label><input type="text" onkeyup="acc_qty_classI(${i})" id="simpleinput" name="acc_qty[]" class="form-control acc_qty_class_${i}"></div>
                        ...
                        <div class="row" style="padding:20px;">
                            ...
                            <label for="">Price Per Room/Night</label>
                             <div class="input-group">
                                ...
                                <input type="text" onchange="more_makkah_acc_room_price_funsI(${divId})" id="more_makkah_acc_room_price_funs_${divId}" name="more_price_per_room_purchase[]" class="form-control more_makkah_acc_room_price_funs">
                            </div>
    ...
    function add_more_accomodation_Invoice(id){
        ...
        if(decodeURI_city == null || decodeURI_city == ''){
            ...
            console.log('if : '+decodeURI_city);
        }
        
        var divId = $('#more_acc_new_id').val();
    
        var data1 = `<div id="click_deleteI_${divId}" class="mb-2 mt-3" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;">
                        <div class="row" style="padding:20px;">
    ...
    $(document).ready(function () {
        ...
        var agent_Name = $('#agent_Name').find('option:selected').attr('attr_agent');
        $("#agent_ids_select").val(agent_Name);
        
        $("#agent_Name").on('change', function()
        {
            var value_c = $('option:selected', this).val();
            var attr_agent = $('option:selected', this).attr('attr_agent');
            $("#agent_ids_select").val(attr_agent);
        });
    });
