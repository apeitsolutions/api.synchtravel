...
<div class="card">
    <div class="card-body">
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('request_Invoices_submit')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <div id="progressbarwizard">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                           ...
                                           <option value="">Choose...</option>
                                            @if(isset($Agents_detail) && $Agents_detail !== null && $Agents_detail !== '')
                                                @foreach($Agents_detail as $Agents_details)
                                                    <option attr_agent="{{ $Agents_details->id }}" value="{{ $Agents_details->agent_Name }}">{{ $Agents_details->agent_Name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                    ...
                                    <div id="tooltip-container">
                                        ...
                                        <i class="dripicons-information" style="font-size: 17px;" id="title_Icon"
                                            ...
                                            <select class="form-control" name="currency_conversion" id="currency_conversion">
                                                ...
                                                <option attr_conversion_type="{{$mange_currencies->conversion_type}}" value="{{$mange_currencies->purchase_currency}} TO  {{$mange_currencies->sale_currency}}">{{$mange_currencies->purchase_currency}} TO  {{$mange_currencies->sale_currency}}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="" name="start_date" class="form-control date start_date" id="start_date" required placeholder="yyyy/mm/dd" readonly>
                                        <div class="invalid-feedback">
                                            This Field is Required
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="" name="end_date" class="form-control date end_date" id="end_date" required placeholder="yyyy/mm/dd" readonly>
                                        <div class="invalid-feedback">
                                            This Field is Required
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane" id="Extras_details" >
                            ...
                            <div id="select_meal_option_markup">
                                
                            </div>
                            <div id="more_select_meal_option_markup">
            ...
            for (let i = 1; i <= city_No; i++) {
                var data = `<div class="mb-2" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="del_hotel${i}">
                            ...
                            <div class="col-xl-3">
                                    ...
                                    <select name="additional_hotel_meal_type[]" onchange="additional_hotel_meal_type(${i})" id="additional_hotel_meal_type_${i}" class="form-control" data-placeholder="Choose ...">
                                    <option value="">Choose ...</option>
                                    <option value="Room only">Room only</option>
                                    <option value="Breakfast">Breakfast</option>
                                    <option value="Lunch">Lunch</option>
                                    <option value="Dinner">Dinner</option>
                                            ...
                                            <div style="display:none" class="col-xl-6"  style="margin-top: 2.2rem;" id="NotIncluded_with_price_${i}">
                                                <label for="">Price</label>
                                                <div class="input-group">
                                                <span class="input-group-btn input-group-append">
                                                <a id="" class="btn btn-primary bootstrap-touchspin-up currency_value1"></a>
                                            </span>
                                                <input type="text"  id="NotIncluded_get_price_meals_${i}"  onchange="NotIncluded_meal_option(${i})"  name="NotIncluded_with_price[]" class="form-control">
                                                   </div>         
                                                    </div>   
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="makkah_acc_room_price_${i}" onchange="makkah_acc_room_price_funs(${i})" value="" name="price_per_room_purchase[]" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-xl-4"><label for="">Total Amount/Per Person</label>
                                         <div class="input-group">
                                            ...
                                            <input readonly type="text"  id="makkah_acc_total_amount_${i}" value=""  name="acc_total_amount_purchase[]" class="form-control makkah_acc_total_amount_class_${i}">
                                        </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="exchange_rate_price_funs_${i}" value="" onchange="exchange_rate_price_funs(${i})" value="" name="exchange_rate_price[]" class="form-control">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="price_per_room_exchange_rate_${i}" value=""   name="price_per_room_sale[]" class="form-control">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="price_per_person_exchange_rate_${i}" value=""  name="acc_price[]" class="form-control makkah_acc_price_class_${i}">
                                        </div>
                                        ...
                                        <div class="col-xl-4"><label for="">Total Amount/Per Person</label>
                                         <div class="input-group">
                                            ...
                                            <input readonly type="text"  id="price_total_amout_exchange_rate_${i}" value="" name="acc_total_amount[]" class="form-control">
                                        </div>
                                        </div>
...
function NotIncluded_meal_option(id)
{
    
     var mrkp_data=`<div class="row" style="margin-bottom:20px;">
                
  
                                    <div class="col-xl-3">
                                    <label for="">Meal Type</label>
                                    <input type="text" id="meal_option_type_${id}" readonly="" name="select_meal_type[]" class="form-control">
                                        </div>
                                         <div class="col-xl-3">
                                         <label for="">Meal Price</label>
                                            <div class="input-group">
                                            
                                                <input type="text" id="meal_option_price_${id}" readonly="" name="select_meal_type_price[]" class="form-control">
                                                <span class="input-group-btn input-group-append">
                                                    <a class="btn btn-primary bootstrap-touchspin-up">
                                                                                                 </a>
                                                </span>
                                         ...
                                         <div class="col-xl-2">
                                                 <label for="">Meal Markup Type</label>
                                                  <select name="select_meal_type_markup_type[]" onchange="meal_option_markup_func(${id})" id="meal_option_markup_func_${id}" class="form-control">
                                                        <option value="">Markup Type</option>
                                                        <option value="%">Percentage</option>
                                        ...
                                        <div class="col-xl-2">
                                            <label for="">Meal Markup</label>
                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                <input type="text" class="form-control" id="meal_mrkp_value_${id}" onchange="meal_mrkp_value_func(${id})" name="select_meal_type_markup_value[]">
                                                <span class="input-group-btn input-group-append">
                                                <button class="btn btn-primary bootstrap-touchspin-up" type="button"><div id="meal_option_mrk_${id}"></div></button>
                                                </span>
                                            </div>
                                        </div>
                                    <div class="col-xl-2">
                                     <label for="">Meal Markup Price</label>
                                        <div class="input-group">
                                            <input type="text" id="meal_sale_price_${id}" name="select_meal_type_markup_price[]" class="form-control id_cot">
                                            <span class="input-group-btn input-group-append">
                                                <a class="btn btn-primary bootstrap-touchspin-up">
                                                                                                </a>
                                            </span>
            ...
            $('#select_meal_option_markup').append(mrkp_data); 
    
    
    
 var meal_type =$('#additional_hotel_meal_type_'+id+'').val(); 
 var price_meal =$('#NotIncluded_get_price_meals_'+id+'').val();
 console.log('price_meal'+price_meal);
 $('#meal_option_type_'+id+'').val(meal_type);
 $('#meal_option_price_'+id+'').val(price_meal);
}

function meal_option_markup_func(id)
{
  var meal_type =$('#meal_option_markup_func_'+id+'').val();
  $('#meal_option_mrk_'+id+'').text(meal_type);
}
function meal_mrkp_value_func(id)
{
  var meal_mrkp_value =$('#meal_mrkp_value_'+id+'').val();
    var meal_type =$('#meal_option_markup_func_'+id+'').val();
    var meal_option_price =$('#meal_option_price_'+id+'').val();

  if(meal_type == '%')
  {
      var total1 = (meal_option_price * meal_mrkp_value/100) + parseFloat(meal_option_price);
                    var total = total1.toFixed(2);
                   $('#meal_sale_price_'+id+'').val(total);
  }
  else
  {
       var total1 = parseFloat(meal_option_price) + parseFloat(meal_mrkp_value);
                    var total = total1.toFixed(2);
                    $('#meal_sale_price_'+id+'').val(total);
  }
...
function not_select_meal_option(id)
{
 $('#NotIncluded_with_price_'+id+'').fadeOut();    
}




function more_additional_hotel_meal_type(id)
{
   var more_additional_hotel_meal_type = $('#more_additional_hotel_meal_type_'+id+'').val();
   console.log('more_additional_hotel_meal_type'+more_additional_hotel_meal_type);
   if(more_additional_hotel_meal_type == 'Room only')
   {
       $('#more_NotIncluded_with_price_'+id+'').fadeOut();
   }
   if(more_additional_hotel_meal_type == 'Breakfast')
   {
       $('#more_NotIncluded_with_price_'+id+'').fadeIn();
   }
   if(more_additional_hotel_meal_type == 'Lunch')
   {
       $('#more_NotIncluded_with_price_'+id+'').fadeIn();
   }
   if(more_additional_hotel_meal_type == 'Dinner')
   {
...
function additional_hotel_meal_type(id)
{
   var additional_hotel_meal_type = $('#additional_hotel_meal_type_'+id+'').val();
   console.log('additional_hotel_meal_type'+additional_hotel_meal_type);
   if(additional_hotel_meal_type == 'Room only')
   {
       $('#NotIncluded_with_price_'+id+'').fadeOut();
   }
   if(additional_hotel_meal_type == 'Breakfast')
   {
       $('#NotIncluded_with_price_'+id+'').fadeIn();
   }
   if(additional_hotel_meal_type == 'Lunch')
   {
       $('#NotIncluded_with_price_'+id+'').fadeIn();
   }
   if(additional_hotel_meal_type == 'Dinner')
   {
...
function more_NotIncluded_meal_option(id)
{
  var mrkp_data=`<div class="row" style="margin-bottom:20px;">
                                    ...
                                    <div class="col-xl-3">
                                    <label for="">Meal Type</label>
                                    <input type="text" id="more_meal_option_type_${id}" readonly="" name="select_meal_type[]" class="form-control">
                                        </div>
                                         <div class="col-xl-3">
                                         <label for="">Meal Price</label>
                                            <div class="input-group">
                                            
                                                <input type="text" id="more_meal_option_price_${id}" readonly="" name="select_meal_type_price[]" class="form-control">
                                                <span class="input-group-btn input-group-append">
                                                    <a class="btn btn-primary bootstrap-touchspin-up">
                                                                                                 </a>
                                                </span>
                                         ...
                                         <div class="col-xl-2">
                                                 <label for="">Meal Markup Type</label>
                                                  <select name="select_meal_type_markup_type[]" onchange="more_meal_option_markup_func(${id})" id="more_meal_option_markup_func_${id}" class="form-control">
                                                        <option value="">Markup Type</option>
                                                        <option value="%">Percentage</option>
                                                        <option value="£">Fixed Amount</option>
                                                  </select>
                                        ...
                                        <div class="col-xl-2">
                                            <label for="">Meal Markup</label>
                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                <input type="text" class="form-control" id="more_meal_mrkp_value_${id}" onchange="more_meal_mrkp_value_func(${id})" name="select_meal_type_markup_value[]">
                                                <span class="input-group-btn input-group-append">
                                                <button class="btn btn-primary bootstrap-touchspin-up" type="button"><div id="more_meal_option_mrk_${id}"></div></button>
                                                </span>
                                            </div>
                                        </div>
                                    <div class="col-xl-2">
                                     <label for="">Meal Markup Price</label>
                                        <div class="input-group">
                                            <input type="text" id="more_meal_sale_price_${id}" name="select_meal_type_markup_price[]" class="form-control id_cot">
                                            <span class="input-group-btn input-group-append">
                                                <a class="btn btn-primary bootstrap-touchspin-up">
                                                                                                </a>
                                            </span>
            ...
            $('#more_select_meal_option_markup').append(mrkp_data);   
    
    
 var meal_type =$('#more_additional_hotel_meal_type_'+id+'').val(); 
 var price_meal =$('#more_NotIncluded_get_price_meals_'+id+'').val();

 $('#more_meal_option_type_'+id+'').val(meal_type);
 $('#more_meal_option_price_'+id+'').val(price_meal);
 
 
}

function more_meal_option_markup_func(id)
{
  var meal_type =$('#more_meal_option_markup_func_'+id+'').val();
  $('#more_meal_option_mrk_'+id+'').text(meal_type);
}
function more_meal_mrkp_value_func(id)
{
  var meal_mrkp_value =$('#more_meal_mrkp_value_'+id+'').val();
    var meal_type =$('#more_meal_option_markup_func_'+id+'').val();
    var meal_option_price =$('#more_meal_option_price_'+id+'').val();

  if(meal_type == '%')
  {
      var total1 = (meal_option_price * meal_mrkp_value/100) + parseFloat(meal_option_price);
                    var total = total1.toFixed(2);
                   $('#more_meal_sale_price_'+id+'').val(total);
  }
  else
  {
       var total1 = parseFloat(meal_option_price) + parseFloat(meal_mrkp_value);
...
function more_not_select_meal_option(id)
{
 $('#more_NotIncluded_with_price_'+id+'').fadeOut();    
}
...
$(document).on('change','#meal_type_with_markup' ,function(){
  ...
  <script>
        ...
        var ids = [];
        //  var temp = 1;
        function add_more_accomodation_req_invoice(id){
            ...
            var data1 = `<div id="click_delete_${divId}" class="mb-2 mt-3" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;">
                            ...
                            <div class="col-xl-3">
                                <label for="">Meal Type</label>
                                <select name="more_hotel_meal_type[]" id="more_hotel_meal_type_${divId}" class="form-control"  data-placeholder="Choose ...">
                                    <option value="">Choose ...</option>
                                    <option value="Room only">Room only</option>
                                    <option value="Breakfast">Breakfast</option>
                                    <option value="Lunch">Lunch</option>
                            ...
                            <div class="col-xl-3">
                                <label for="">Additional Meal Type</label>
                                <select name="more_additional_hotel_meal_type[]" onchange="more_additional_hotel_meal_type(${divId})" id="more_additional_hotel_meal_type_${divId}" class="form-control"  data-placeholder="Choose ...">
                                    <option value="">Choose ...</option>
                                    <option value="Room only">Room only</option>
                                    <option value="Breakfast">Breakfast</option>
                                    <option value="Lunch">Lunch</option>
                                    <option value="Dinner">Dinner</option>
                                            ...
                                            <div style="display:none" class="col-xl-6" style="margin-top: 2.2rem;" id="more_NotIncluded_with_price_${divId}">
                                                <label for="">Price</label>
                                                <div class="input-group">
                                                <span class="input-group-btn input-group-append">
                                                <a id="" class="btn btn-primary bootstrap-touchspin-up currency_value1"></a>
                                            </span>
                                                <input type="text" onchange="more_NotIncluded_meal_option(${divId})"  id="more_NotIncluded_get_price_meals_${divId}" name="more_NotIncluded_with_price[]" class="form-control">
                                                   </div>         
                                                    </div>
                            <h4  class="mt-4">Purchase Price</h4 >
