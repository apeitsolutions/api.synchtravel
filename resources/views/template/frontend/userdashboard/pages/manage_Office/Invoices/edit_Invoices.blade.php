                            ...
                            <div class="row"> 
                                ...
                                <div class="col-xl-4 start_date_div">
                                    <div class="mb-3">
                                        ...
                                        <input name="start_date" class="form-control date start_date" value="{{$get_invoice->start_date}}" id="start_date" required placeholder="yyyy/mm/dd" readonly>
                                        <div class="invalid-feedback">
                                            This Field is Required
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 end_date_div">
                                    <div class="mb-3">
                                        ...
                                        <input name="end_date" class="form-control date end_date" value="{{$get_invoice->end_date}}" id="end_date" placeholder="yyyy/mm/dd" readonly>
                                        <div class="invalid-feedback">
                                            This Field is Required
                                        </div>
                                    </div>
                                                ...
                                                <div class="mb-2" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="del_hotelI{{ $i }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            ...
                                                            <input type="text" id="select_hotel_id{{ $i }}"  name="hotel_id[]" value="@isset($details->hotel_id) {{$details->acc_hotel_name}} @endisset">
                                                        </div>
                        ...
                        <div class="tab-pane" id="visa_details">
                            ...
                            <div class="row">                                                  
                                ...
                                <?php 
                                    ...
                                    $visa_details = json_decode($get_invoice->all_visa_price_details)
                                ?>
                                
                                
  
                                <div class="row mt-1 mb-3" style="@if(!$visa_found) display:none @endif" id="select_visa_inc">
                                    ...
                                    <div class="col-md-12" id="visa_occupy_div">
                                        ...
                                        @isset($visa_details)
                                            @foreach($visa_details as $visa_res)
                                            <script>
                                             occupiedVisaArr.push({{ $visa_res->visa_avail_id }});
                                             console.log(occupiedVisaArr);
                                            </script>
                                            <?php 
                                                $supplier_name = '';
                                            ?>
                                              @foreach($visa_supplier as $value)
                                                <?php  
                                                    if($value->id == $visa_res->visa_supplier_id){
                                                        $supplier_name = $value->visa_supplier_name;
                                                    }
                                                ?>
                                                            
                                                        @endforeach
                                                <div class="row" id="visa{{ $visa_row_counter }}">
                                                    <div class="col-xl-4" style="padding: 10px;">
                                                        <label for="">Visa Suppplier</label>
                                                        <input type="text" id="" value="{{ $supplier_name }}" readonly name="" class="form-control">
                                                     </div>
                                                    <div class="col-xl-4" style="padding: 10px;">
                                                        <label for="">Visa Type</label>
                                                        <input type="text" id="visa_type" value="{{ $visa_res->visa_type_name }}" readonly name="visa_type_name[]" class="form-control visa_type_new_cl{{ $visa_row_counter }}">
                                                        <input type="text" name="visa_add_type_new[]" hidden value="false">
                                                        <input type="text" name="visa_country_id[]" hidden value="{{ $visa_res->visa_country_id }}">
                                                        <input type="text" name="visa_supplier_id[]" hidden value="{{ $visa_res->visa_supplier_id }}">
                                                        <input type="text" name="visa_av_from[]" hidden value="{{ $visa_res->visa_av_from }}">
                                                        <input type="text" name="visa_av_to[]" hidden value="{{ $visa_res->visa_av_to }}">
                                                        <input type="text" name="visa_type_id[]" hidden value="{{ $visa_res->visa_type_id }}">
                                                        <input type="text" name="visa_avail_id[]" hidden value="{{ $visa_res->visa_avail_id }}">
                                                    ...
                                                    <div class="col-xl-2" style="padding: 10px;">
                                                        ...
                                                        <input type="text" id="visa_seat_occupied" value="{{ $visa_res->visa_occupied }}" readonly name="visa_Pax[]" class="form-control visa_occupied_new_cl{{ $visa_row_counter }}">
                                                     </div>
                                                       ...
                                                       <div class="col-xl-2" style="padding: 10px;">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="visa_fee" readonly value="{{ $visa_res->visa_fee_purchase }}" name="visa_fee_purchase[]" class="form-control visa_pur_fee_new_cl{{ $visa_row_counter }}">
                                                        </div>
                                                     </div>
                                                     ...
                                                     <div class="col-xl-6" style="padding: 10px;">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" value="{{ $visa_res->exchange_rate_visa }}" id="exchange_rate_visa" onkeyup="calculateVisaPrices({{ $visa_row_counter }},'new')" name="exchange_rate_visa[]" class="form-control visa_exchange_new_cl{{ $visa_row_counter }}">
                                                        </div>
                                                     </div>
                                                     <div class="col-xl-6" style="padding: 10px;">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="exchange_rate_visa_total_amount" value="{{ $visa_res->visa_fee }}" name="visa_fee[]" readonly class="form-control visa_sale_new_cl{{ $visa_row_counter }}">
                                                            <input type="text" id="markup_visa_total_amount" hidden value="{{ $visa_res->visa_price_wi_markup }}" name="markup_visa_total_amount[]" readonly class="form-control markup_visa_total_amount{{ $visa_row_counter }}">
                                                        </div>
                                                     </div>
                                                     <div class="col-xl-12">
                                                        <div class="input-group" style="justify-content: end;">
                                                           <button class="btn btn-danger" style="float:right;" onclick="deleteVisaDiv({{ $visa_row_counter }})">Delete</button>
                                                        </div>
                                                    </div>
                                                        ...
                                                        @foreach($transportation_details_D as $transportation_details_DS)
                                                            @if($transportation_details_DS->transportation_trip_type != null && $transportation_details_DS->transportation_trip_type != '' && $transportation_details_DS->transportation_trip_type != 'All_Round')
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_pick_up_location ?? '' }}" id="transportation_pick_up_location_{{ $TD_id1 }}" name="transportation_pick_up_location[]" class="form-control pickup_location all_one_way_empty_class" value="" onkeyup="TPUL_function({{ $TD_id1 }})">
                                                                </div>
                                                                
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    <label for="">Drop-off Location</label>
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_drop_off_location ?? '' }}" id="transportation_drop_off_location_{{ $TD_id1 }}" name="transportation_drop_off_location[]" class="form-control dropof_location all_one_way_empty_class" onkeyup="TDOL_function({{ $TD_id1 }})">
                                                                </div>
                                                                
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    <label for="">Pick-up Date & Time</label>
                                                                    <input type="datetime-local" value="{{ $transportation_details_DS->transportation_pick_up_date ?? '' }}" id="transportation_pick_up_date_{{ $TD_id1 }}" name="transportation_pick_up_date[]" class="form-control all_one_way_empty_class" onchange="TPUD_function({{ $TD_id1 }})">
                                                                </div>
                                                                
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    <label for="">Drop-of Date & Time</label>
                                                                    <input type="datetime-local" value="{{ $transportation_details_DS->transportation_drop_of_date ?? '' }}" id="transportation_drop_of_date_{{ $TD_id1 }}" name="transportation_drop_of_date[]" class="form-control all_one_way_empty_class" onchange="TDOP_function({{ $TD_id1 }})">
                                                                </div>
                                                                
                                                                <div class="col-xl-3" style="padding: 10px;" id="transportation_Time_Div">
                                                                    <label for="">Estimate Time</label>
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_total_Time ?? '' }}" id="transportation_total_Time_{{ $TD_id1 }}" name="transportation_total_Time[]" class="form-control transportation_total_Time1 all_one_way_empty_class" readonly style="padding: 10px;" value="">
                                                                </div>
                                                                
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    <label for="">Select Trip Type</label>
                                                                    <select name="transportation_trip_type[]" id="slect_trip_{{ $TD_id1 }}" class="form-control" readonly>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <select name="transportation_vehicle_type[]" id="transportation_vehicle_typeI_{{ $TD_id1 }}" class="form-control">
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_no_of_vehicle ?? '' }}" id="transportation_no_of_vehicle_{{ $TD_id1 }}" name="transportation_no_of_vehicle[]" class="form-control all_one_way_empty_class" onkeyup="TNOV_function({{ $TD_id1 }})">
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" value="{{ $transportation_details_DS->transportation_price_per_vehicle ?? '' }}" id="transportation_price_per_vehicle_{{ $TD_id1 }}" name="transportation_price_per_vehicle[]" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value1_T">{{ $transportation_details_DS->currency_SAR ?? '' }}</a></span>
                                                                        <input type="text" value="{{ $transportation_details_DS->transportation_vehicle_total_price ?? '' }}" id="transportation_vehicle_total_price_{{ $TD_id1 }}" name="transportation_vehicle_total_price[]" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3 d-none" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value1_T">{{ $transportation_details_DS->currency_SAR ?? '' }}</a></span>
                                                                        <input type="text" value="{{ $transportation_details_DS->transportation_price_per_person ?? '' }}" id="transportation_price_per_person_{{ $TD_id1 }}" name="transportation_price_per_person[]" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value1_T">{{ $transportation_details_DS->currency_SAR ?? '' }}</a></span>
                                                                        <input type="text" value="{{ $transportation_details_DS->transfer_exchange_rate_destination ?? '' }}" name="transfer_exchange_rate_destination[]" id="transfer_exchange_rate_destination_{{ $TD_id1 }}" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" value="{{ $transportation_details_DS->without_markup_price_converted_destination ?? '' }}" name="without_markup_price_converted_destination[]" id="without_markup_price_converted_destination_{{ $TD_id1 }}" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1_T">{{ $transportation_details_DS->currency_GBP ?? '' }}</a></span>
                                                                        <input type="text" value="{{ $transportation_details_DS->transportation_vehicle_total_price_converted ?? '' }}" name="transportation_vehicle_total_price_converted[]" id="transportation_vehicle_total_price_converted_{{ $TD_id1 }}" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3 d-none" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1_T">{{ $transportation_details_DS->currency_GBP ?? '' }}</a></span>
                                                                        <input type="text" value="{{ $transportation_details_DS->transportation_price_per_person_converted ?? '' }}" name="transportation_price_per_person_converted[]" id="transportation_price_per_person_converted_{{ $TD_id1 }}" class="form-control all_one_way_empty_class" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <select name="vehicle_markup_type[]" id="vehicle_markup_type_{{ $TD_id1 }}" class="form-control all_one_way_empty_class" onchange="vehicle_markup_OWandR1({{ $TD_id1 }})">
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                        ...
                                                                        <input value="{{ $transportation_details_DS->vehicle_per_markup_value ?? '' }}" type="text" class="form-control all_one_way_empty_class" id="vehicle_per_markup_value_{{ $TD_id1 }}" name="vehicle_per_markup_value[]" onkeyup="vehicle_per_markup_OWandR1({{ $TD_id1 }})">
                                                                    </div>
                                                                </div>
                                                                
                                                                <input value="{{ $transportation_details_DS->markup_price_per_vehicle_converted ?? '' }}" type="text" class="form-control d-none all_one_way_empty_class" id="markup_price_per_vehicle_converted_{{ $TD_id1 }}" name="markup_price_per_vehicle_converted[]" readonly>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value1_T">{{ $transportation_details_DS->currency_SAR ?? '' }}</a></span>
                                                                        <input value="{{ $transportation_details_DS->vehicle_total_price_with_markup ?? '' }}" type="text" class="form-control all_one_way_empty_class" id="vehicle_total_price_with_markup_{{ $TD_id1 }}" name="vehicle_total_price_with_markup[]" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1_T">{{ $transportation_details_DS->currency_GBP ?? '' }}</a></span>
                                                                        <input value="{{ $transportation_details_DS->vehicle_markup_value_converted ?? '' }}" type="text" class="form-control all_one_way_empty_class" id="vehicle_markup_value_converted_{{ $TD_id1 }}" name="vehicle_markup_value_converted[]" readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;">
                                                                    ...
                                                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1_T">{{ $transportation_details_DS->currency_GBP ?? '' }}</a></span>
                                                                        <input value="{{ $transportation_details_DS->vehicle_total_price_with_markup_converted ?? '' }}" type="text" class="form-control all_one_way_empty_class" id="vehicle_total_price_with_markup_converted_{{ $TD_id1 }}" name="vehicle_total_price_with_markup_converted[]" readonly>
                                                                    </div>
                                                                </div>
                                                                <!--End Costing-->
                                                            ...
                                                            @foreach($markup_details as $value)
                                                                @if(isset($value->markup_Type_Costing) && $value->markup_Type_Costing != null && $value->markup_Type_Costing != '')
                                                                    @if($value->markup_Type_Costing == 'flight_Type_Costing')
                                                                        <div class="row" id="flights_cost" style="padding-bottom: 25px">
                                                                            ...
                                                                            <div class="col-xl-2">
                                                                                ...
                                                                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                                    ...
                                                                                    <span class="input-group-btn input-group-append">
                                                                                        <button class="btn btn-primary bootstrap-touchspin-up" type="button"><div id="markup_value_markup_mrk">{{ $value->markup_type ?? '' }}</div></button>
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        @if(isset($markup_detailsE) && $markup_detailsE != null && $markup_detailsE != '')
                                                            ...
                                                            @foreach($markup_details as $value)
                                                                ...
                                                                @if(isset($markup_Type_Costing) && $markup_Type_Costing != null && $markup_Type_Costing != '')
                                                                    ...
                                                                    <div class="row" id="visaCost{{ $visa_counter }}">
                                                                        <div class="col-xl-3">
                                                                            <h4 class="" id="">Visa Cost</h4>
                                                                        </div>
                                                                        
                                                                        <div class="col-xl-9">
                                                                            <input type="hidden" id="visa_Type_Costing{{ $visa_counter }}" name="markup_Type_Costing[]" value="visa_Type_Costing" class="form-control">
                                                                        </div>
                                                                        
                                                                        <div class="col-xl-3">
                                                                            <input readonly="" type="text" id="visa_type_select{{ $visa_counter }}" value="{{ $value->hotel_name_markup }}" name="hotel_name_markup[]" class="form-control">
                                                                        </div>
                                                                        
                                                                        <div class="col-xl-3">
                                                                            <div class="input-group">
                                                                                <input readonly="" type="text" id="visa_price_select{{ $visa_counter }}" name="without_markup_price[]" value="{{ $value->without_markup_price }}" class="form-control">
                                                                                <span class="input-group-btn input-group-append">
                                                                                    <a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"><?php echo $currency ?></a>
                                                                                </span>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-xl-2">
                                                                            <select name="markup_type[]" id="visa_markup_type{{ $visa_counter }}" onchange="visa_more_markup_calc(1)" class="form-control">
                                                                        ...
                                                                        <div class="col-xl-2">
                                                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                                <input type="text" class="form-control" id="visa_markup{{ $visa_counter }}" onkeyup="visa_more_markup_calc({{ $visa_counter }})" value="{{ $value->markup }}" name="markup[]">
                                                                                <span class="input-group-btn input-group-append">
                                                                                      <button class="btn btn-primary bootstrap-touchspin-up" type="button">
                                                                                        <div id="visa_mrk">
                                                                                            <?php 
                                                                        ...
                                                                        <div class="col-xl-2">
                                                                            <div class="input-group">
                                                                                <input type="text" id="total_visa_markup{{ $visa_counter }}" name="markup_price[]" value="{{ $value->markup_price }}" class="form-control">
                                                                                <span class="input-group-btn input-group-append">
                                                                                    <a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"><?php echo $currency ?></a>
                                                                                </span>
                                                                            </div>
