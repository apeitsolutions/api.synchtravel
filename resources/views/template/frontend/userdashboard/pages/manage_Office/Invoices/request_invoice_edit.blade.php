...
<div class="card">
    <div class="card-body">
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('request_invoice_edit_submit',[$get_invoice->id])}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                                           ...
                                           <option value="">Choose...</option>
                                            @if(isset($Agents_detail) && $Agents_detail !== null && $Agents_detail !== '')
                                                @foreach($Agents_detail as $Agents_details)
                                                    <option  attr_agent="{{ $Agents_details->id }}" <?php if($get_invoice->agent_Name == $Agents_details->id) echo "selected" ?> value="{{ $Agents_details->agent_Name }}">{{ $Agents_details->agent_Name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
