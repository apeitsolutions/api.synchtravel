...
<?php 
    ...
    $currency   = $get_invoice->currency_symbol;
?>
...
<div class="card">
    <div class="card-body">
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('update_Invoices_TranSupp',[$get_invoice->id])}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                ...
                <div id="progressbarwizard">
                    ...
                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3" style="margin-right: 1px;margin-left: 1px;">
                        ...
                        @endif
                        @if($get_invoice->transportation_details != null)
                                            ...
                                            @foreach($transportation_details_D as $transportation_details_DS)
                                                @if($transportation_details_DS->transportation_trip_type != null && $transportation_details_DS->transportation_trip_type != '' && $transportation_details_DS->transportation_trip_type != 'All_Round')
                                                    ...
                                                    <div class="row" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="select_transportation">
                                                        ...
                                                        <input type="hidden" name="without_markup_price_converted_destination[]" id="without_markup_price_converted_destination" value="{{ $transportation_details_DS->without_markup_price_converted_destination }}">
                                                        <input type="hidden" name="transfer_exchange_rate_destination[]" id="transfer_exchange_rate_destination" value="{{ $transportation_details_DS->transfer_exchange_rate_destination }}">
                                                        
                                                        <h3>Transportation Details :</h3>
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            <label for="">Pick-up Location</label>
                                                            <input type="text" value="{{ $transportation_details_DS->transportation_pick_up_location ?? '' }}" id="transportation_pick_up_location" name="transportation_pick_up_location[]" class="form-control pickup_location" value="">
                                                        </div>
                                                        
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            <label for="">Drop-off Location</label>
                                                            <input type="text" value="{{ $transportation_details_DS->transportation_drop_off_location ?? '' }}" id="transportation_drop_off_location" name="transportation_drop_off_location[]" class="form-control dropof_location">
                                                        </div>
                                                        
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            <label for="">Pick-up Date & Time</label>
                                                            <input type="datetime-local" value="{{ $transportation_details_DS->transportation_pick_up_date ?? '' }}" id="transportation_pick_up_date" name="transportation_pick_up_date[]" class="form-control">
                                                        </div>
                                                        
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            <label for="">Drop-of Date & Time</label>
                                                            <input type="datetime-local" value="{{ $transportation_details_DS->transportation_drop_of_date ?? '' }}" id="transportation_drop_of_date" name="transportation_drop_of_date[]" class="form-control">
                                                        </div>
                                                        
                                                        <div class="col-xl-3" style="display:none" id="transportation_Time_Div">
                                                            <label for="">Estimate Time</label>
                                                            <input type="text" value="{{ $transportation_details_DS->transportation_total_Time ?? '' }}" id="transportation_total_Time" name="transportation_total_Time[]" class="form-control transportation_total_Time1" readonly style="padding: 10px;" value="">
                                                        </div>
                                                        
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            <label for="">Select Trip Type</label>
                                                            <select name="transportation_trip_type[]" id="slect_trip" class="form-control"  data-placeholder="Choose ..." readonly>
                                                        ...
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            ...
                                                            <input type="text" value="{{ $transportation_details_DS->transportation_no_of_vehicle ?? '' }}" id="transportation_no_of_vehicle" name="transportation_no_of_vehicle[]" class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_price_per_vehicle ?? '' }}" id="transportation_price_per_vehicle" name="transportation_price_per_vehicle[]" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_vehicle_total_price ?? '' }}" id="transportation_vehicle_total_price" name="transportation_vehicle_total_price[]" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3" style="padding: 10px;">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_price_per_person ?? '' }}" id="transportation_price_per_person" name="transportation_price_per_person[]" class="form-control">
                                                            </div>
                                                        </div>
                                                        ...
                                                        @else
                                                            <div class="row" id="select_return" style="padding: 10px;">
                                                                ...
                                                                <div class="col-xl-3" style="padding: 10px;" id="return_transportation_Time_Div">
                                                                    <label for="" style="width: 205px;">Estimate Time Return</label>
                                                                    <input type="text" value="{{ $transportation_details_DS->return_transportation_total_Time ?? '' }}" id="return_transportation_total_Time" name="return_transportation_total_Time" class="form-control return_transportation_total_Time1" readonly style="padding: 10px;" value="">
                                                                </div>
                                                ...
                                                @else
                                                    @if($transportation_details_DS->transportation_trip_type != null && $transportation_details_DS->transportation_trip_type != '')
                                                        ...
                                                        <div class="row" style="border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="select_transportation">
                                                            ...
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                <label for="">Pick-up Location</label>
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_pick_up_location ?? '' }}" id="transportation_pick_up_location_{{ $TD_id1 }}" name="transportation_pick_up_location[]" class="form-control pickup_location" value="">
                                                            </div>
                                                            
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                <label for="">Drop-off Location</label>
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_drop_off_location ?? '' }}" id="transportation_drop_off_location_{{ $TD_id1 }}" name="transportation_drop_off_location[]" class="form-control dropof_location">
                                                            </div>
                                                            ...
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                <label for="">No Of Vehicle</label>
                                                                <input type="text" value="{{ $transportation_details_DS->transportation_no_of_vehicle ?? '' }}" id="transportation_no_of_vehicle_{{ $TD_id1 }}" name="transportation_no_of_vehicle[]" class="form-control" onchange="TNOV_function({{ $TD_id1 }})">
                                                            </div>
                                                            ...
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_price_per_vehicle ?? '' }}" id="transportation_price_per_vehicle_{{ $TD_id1 }}" name="transportation_price_per_vehicle[]" class="form-control" onchange="TPPV_function({{ $TD_id1 }})">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_vehicle_total_price ?? '' }}" id="transportation_vehicle_total_price_{{ $TD_id1 }}" name="transportation_vehicle_total_price[]" class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-3" style="padding: 10px;">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                                    <input type="text" value="{{ $transportation_details_DS->transportation_price_per_person ?? '' }}" id="transportation_price_per_person_{{ $TD_id1 }}" name="transportation_price_per_person[]" class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mt-2" style="" id="add_more_destination">
                                                                <a href="javascript:;" id="more_transportationI" class="btn btn-info" style="float: right;">Add More Destinations </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <?php $TD_id1 = $TD_id1 + 1; ?>
                                            @endforeach
                                            <input type="hidden" id="transportation_price_switch" value="{{ $TD_id1 }}">
                                        @endif
                                    @endif
                                        ...
                                        <div id="" class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="row" id="flights_cost" style="display:none;padding-bottom: 25px">
                                                    ...
                                                    <input type="hidden" name="tranf_no_of_vehicle[]">
                                                    <input type="hidden" name="tranf_price_per_vehicle[]">
                                                    <input type="hidden" name="tranf_price_all_vehicle[]">
                                                ...
                                                <div style="" class="row" id="transportation_cost">
                                                    ...
                                                    @if($get_invoice->markup_details != null)
                                                        ...
                                                        @foreach($markup_details as $details)
                                                            @if($details->markup_Type_Costing == 'transportation_Type_Costing')
                                                                ...
                                                                <div class="col-xl-2">
                                                                    <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                        <input type="text" value="{{ $details->markup ?? '' }}" class="form-control" id="transportation_markup" name="markup[]">
                                                                        <span class="input-group-btn input-group-append"><button class="btn btn-primary bootstrap-touchspin-up" type="button"><div id="transportation_markup_mrk">%</div></button></span>
                                                                    </div>
                                                                </div>
                                                                
                                                                <div class="col-xl-2">
                                                                    <div class="input-group">
                                                                        <input type="text" value="{{ $details->markup_price ?? '' }}" id="transportation_markup_total" name="markup_price[]" class="form-control">
                                                                        <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_2"></a></span>
                                                                    </div>
                                                                </div>
...
<script>
    ...
    var destination_details = {!!json_encode($destination_details_edit)!!};
    ...
    function occupy_function(id){
        ...
        console.log('transfer_vehicle_id_td : '+transfer_vehicle_id_td);
        ...
        $.each(destination_details, function(key, value) {
            ...
            if(id_DD == transfer_id_td){
                ...
                if(transfer_Type_td == "One-Way"){
                    ...
                    $('#slect_trip').empty();
                    slect_trip_data =  `<option value="One-Way">One-Way</option>
                    ...
                    if(ocupancy_btn_switch == 0){
                        ...
                        var allR_data = `<h3>Transportation Details :</h3>
                                            ...
                                            <input type="hidden" name="without_markup_price_converted_destination[]" id="without_markup_price_converted_destination_${TD_id1}">
                                            <input type="hidden" name="transfer_exchange_rate_destination[]" id="transfer_exchange_rate_destination_${TD_id1}">
                                            ...
                                            <div class="col-xl-3" style="padding: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                    <input type="text" id="transportation_price_per_vehicle_${TD_id1}" name="transportation_price_per_vehicle[]" class="form-control" onchange="TPPV_function(${TD_id1})">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3" style="padding: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                    <input type="text" id="transportation_vehicle_total_price_${TD_id1}" name="transportation_vehicle_total_price[]" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3" style="padding: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                    <input type="text" id="transportation_price_per_person_${TD_id1}" name="transportation_price_per_person[]" class="form-control">
                                                </div>
                                            </div>
