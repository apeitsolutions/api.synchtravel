...
<div class="card">
    <div class="card-body">
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('add_Invoices_TranSupp')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                            ...
                            <div class="row">                                       
                                <div class="tab-pane" id="trans_details_1">
                                    ...
                                    <div class="row" style="display:none;border:1px solid #ced4da;padding: 20px 20px 20px 20px;" id="select_transportation">
                                        ...
                                        <div class="col-xl-3" style="padding: 10px;">
                                            <label for="">Price Per Vehicle/Converted</label>
                                            <div class="input-group">
                                        ...
                                        <div class="row" id="select_return" style="display:none;padding: 10px;">
                                            ...
                                            <div class="col-xl-3" style="display:none;padding: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up"><?php echo $currency; ?></a></span>
                                                    <input type="text" id="return_transportation_vehicle_total_price" name="return_transportation_vehicle_total_price" class="form-control" readonly>
                                                </div>
                                            </div>
                                        ...
                                        <div id="" class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="row" id="transportation_cost" style="display:none;">
                                                    ...
                                                    <input type="hidden" name="tranf_no_of_vehicle[]" id="tranf_no_of_vehicle">
                                                    <input type="hidden" name="tranf_price_per_vehicle[]" id="tranf_price_per_vehicle">
                                                    <input type="hidden" name="tranf_price_all_vehicle[]" id="tranf_price_all_vehicle">
        ...
        $.each(destination_details, function(key, value) {
            ...
            if(id_DD == transfer_id_td){
                ...
                if(transfer_Type_td == "One-Way"){
                    ...
                    // $('#transportation_price_per_vehicle').attr('readonly', true);
                    ...
                    if(ocupancy_btn_switch == 0){
                        ...
                        // $('#transportation_price_per_vehicle').removeAttr('readonly');
                        ...
                        var allR_data = `<h3>Transportation Details :</h3>
                                            ...
                                            <div class="col-xl-3" style="padding: 10px;">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value1"></a></span>
                                                    <input readonly type="text" id="transportation_price_per_vehicle_${TD_id1}" name="transportation_price_per_vehicle[]" class="form-control" onchange="TPPV_function(${TD_id1})">
                                                </div>
                                            </div>
