                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="cs-bold cs-primary_color cs-f18">Total Amount:</td>
                                ...
                                <td class="cs-bold cs-primary_color cs-f18 cs-text_right">{{ $currency }} 
                                    <?php
                            ...
                            <tr>
                                @if(isset($data->discount_amount) && $data->discount_amount != null && $data->discount_amount != '')
                                    <td class="cs-bold cs-primary_color cs-f18">Discount Included:</td>
                                    <td class="cs-bold cs-primary_color cs-f18 cs-text_right">{{ $currency }} {{ round($data->discount_amount,2) }}</td>
                                @endif
                            </tr>
