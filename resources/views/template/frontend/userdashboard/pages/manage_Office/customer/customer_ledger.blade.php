              ...
              <div class="row">
                  <div class="col-12">
                      <div class="page-title-box">
                        ...
                        <h4 class="page-title">Customer Financial Statement</h4>
                      </div>
                  </div>
              </div>
              <!-- end page title --> 
                                            ...
                                            <table class="table nowrap example23 dataTable no-footer" id="example_23" aria-describedby="example_1_info">
                                                ...
                                                <thead class="table-light">
                                                     ...
                                                     <tr>
                                                          ...
                                                          <td class="cs-text_center cs-semi_bold">Balance</td>
                                                          
                                                          <td class="cs-text_center cs-semi_bold">Description</td>
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                                        <td class="cs-primary_color">Opening Balance</td>
                                                                        <td class="cs-primary_color"></td>
                                                                        <td class="cs-primary_color"></td>
                                                                        <td class="cs-primary_color">{{ $customer_Pers_details->opening_balance }}</td>
                                                                        <td class="cs-primary_color"></td>
                                                                        <td class="cs-primary_color"></td>
                                                        </tr>
                                                        @if(isset($customer_detail))
                                                            ...
                                                            @foreach($customer_detail as $value)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="cs-primary_color">{{ $value->balance }}</td>
                                                                          <td class="cs-primary_color cs-text_center">
                                                                            <?php 
                                                                               ...
                                                                               echo "<br>".$value->remarks
                                                                            
                                                                            ?>
                                                                        </td>
                                                                        <td class="cs-primary_color">{{ date('d-m-Y',strtotime($value->date)) }}</td>
