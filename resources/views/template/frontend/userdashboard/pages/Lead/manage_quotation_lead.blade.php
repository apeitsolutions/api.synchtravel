...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{URL::to('add_manage_Lead_Quotation')}}/{{ $lead_id }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="quotation_validity" class="form-control">
                                </div>
                            </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="mb-3">
                                                <label for="" class="form-label no_of_pax_days">Select Nationality</label>
                                                 <select type="text" class="form-control select2" name="nationality" id="nationality_id" data-placeholder="Choose ...">
                            ...
                            <div class="col-xl-4 start_date_div" style="display:none">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="start_date" class="form-control start_date" id="start_date" required placeholder="yyyy/mm/dd">
                                    <div class="invalid-feedback">
                                        This Field is Required
                                    </div>
                                </div>
                                            ...
                                            <div id="tooltip-container">
                                                ...
                                                <select type="text" class="form-control select2 categories" name="categories"  data-placeholder="Choose ...">
                                                    @foreach($categories as $categories)
                                                        <option value="{{$categories->id}}" required>{{$categories->title}}</option>
                                                        <div class="invalid-feedback">
                                                            This Field is Required
                                                        </div>
                                                    @endforeach
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-4">
                                    <select class="form-control" id="flight_route_type" name="flight_route_type" style="height: 3.4rem;">
                                        <option>Departure Route Type</option>
                                ...
                                <div class="col-4 supplier_select_div" id="supplier_select_div" style="display:none">
                                    <select class="form-control" name="flight_supplier" id="supplier_name_id" style="height: 3.4rem;">
...
<script>
    ...
    $('#supplier_name_id').on('change',function(){
        ...
        var supp_company_name       = $(this).find('option:selected').attr('att-CN');
            ...
            if(swicth_val != 1){
                $.each(all_flight_routes, function(key, value) {
                    ...
                    if(route_id == route_selected_id){
                        ...
                        var  aa = 0;
                        if(aa == 1){
                            console.log('return not work check wala');
                            if(return_objectE != null && return_objectE != ''){
                                var return_object = JSON.parse(return_objectE);
                                if(all_return_appends != 0){
                                    if(return_flight_type == 'Direct'){
                                        var all_return_appendsD = JSON.parse(all_return_appends);
                                        var departureA       = all_return_appendsD[0].departure;
                                        var arivalA          = all_return_appendsD[0].arival;
                                        var departure_timeA  = all_return_appendsD[0].departure_time;
                                        var arrival_timeA    = all_return_appendsD[0].arrival_time;
                                        var departure_match_Status  = false;
                                        
                                        $.each(return_object, function(key, return_objectS) {
                                            var departure       = return_objectS.departure;
                                            var arival          = return_objectS.arival;
                                            var departure_time  = return_objectS.departure_time;
                                            var arrival_time    = return_objectS.arrival_time;
                                            if(departure == departureA && arival == arivalA && departure_time == departure_timeA && arrival_time == arrival_timeA){
                                                $('#no_of_pax_days').val(no_of_seats_count);
                                                departure_match_Status = true;
                                                var R_data = `<div class="main_div_flight_return_${id}" style="margin-top: 10px;">
                                                ...
                                                departure_match_Status = false;
                                            }
                                        });
                                        $('#all_return_appends').val(return_objectE);
                                        
                                        // IF STATUS TRUE COSTING
                                        if(departure_match_Status == true){
                                            var c_count     = $('#c_count_id').val();
                                            var ACI_costing = `<div class="row" id="flight_price_section_adult_${id}" style="margin-top:10px;">
                                                                <h3>Adult Price Section</h3>
                                                                ...
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="flights_total_cost_adult_${id}" name="flights_total_cost_adult[]" class="form-control" readonly value="${adult_price_all_seats}">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row" id="flight_price_section_child_${id}" style="margin-top:10px;">
                                                                ...
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="flights_total_cost_child_${id}" name="flights_total_cost_child[]" class="form-control" readonly value="${flights_per_child_price}">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row" id="flight_price_section_infant_${id}" style="margin-top:10px;">
                                                                ...
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="flights_infant_seats_${id}" name="flights_infant_seats[]" class="form-control" value="1" onkeyup="flights_infant_seats_fun(${id})">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-3">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="flights_total_cost_infant_${id}" name="flights_total_cost_infant[]" class="form-control" readonly value="${flights_per_infant_price}">
                                                                    </div>
                                                                </div>
                                        ...
                                        var current_obj_length          = return_object.length;
                                        var all_return_appendsD         = JSON.parse(all_return_appends);
                                        var all_return_appends_count    = all_return_appendsD.length;
                                        
                                        if(all_return_appends_count == current_obj_length){
                                            for(var l_C=0; l_C<all_return_appends_count; l_C++){
                                                var r_departure       = return_object[l_C].departure;
                                                var r_arival          = return_object[l_C].arival;
                                                var r_departure_time  = return_object[l_C].departure_time;
                                                var r_arrival_time    = return_object[l_C].arrival_time;
                                                var r_departureA       = all_return_appendsD[l_C].departure;
                                                var r_arivalA          = all_return_appendsD[l_C].arival;
                                                var r_departure_timeA  = all_return_appendsD[l_C].departure_time;
                                                var r_arrival_timeA    = all_return_appendsD[l_C].arrival_time;
                                                if(r_departure == r_departureA && r_arival == r_arivalA && r_departure_time == r_departure_timeA && r_arrival_time == r_arrival_timeA){
                                                    var return_match_Status = true;
                                                }else{
                                                    var return_match_Status = false;
                                                }
                                            }
                                        }else{
                                            var return_match_Status = false;
    ...
    function flight_price_calculation(id){
        var total_append    = $('#c_count_id').val();
        var flights_TCA     = 0;
        var flights_MPA     = 0;
        var flights_SPA     = 0;
...
<script>
    ...
    $('#agent_Company_Name').change(function () {
        var agent_Company_Name_value = $('#agent_Company_Name').find('option:selected').attr('value');
        if(agent_Company_Name_value != null && agent_Company_Name_value != ''){
            var agent_Id = $('#agent_Company_Name').find('option:selected').attr('attr-Id');
            $('#agent_Id').val(agent_Id);
            
            var agent_Name = $('#agent_Company_Name').find('option:selected').attr('attr-AN');
    ...
    $('#customer_name').change(function () {
        var customer_name_value = $('#customer_name').find('option:selected').attr('value');
        if(customer_name_value != '-1'){
...
<script>
    ...
    function more_acc_qty_classInvoice(id){
        console.log('function call id is '+id);
