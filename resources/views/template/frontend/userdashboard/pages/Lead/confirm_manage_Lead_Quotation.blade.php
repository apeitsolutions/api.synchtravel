...
<?php $currency=Session::get('currency_symbol'); $account_No=Session::get('account_No'); // dd($get_invoice); ?>
...
<div class="card">
    <div class="card-body">
        <h4 class="header-title">
            @if(isset($get_invoice->services) && $get_invoice->services != null && $get_invoice->services != '')
                ...
                @if($services[0] == 'accomodation_tab')
                    Confirm Lead Hotel Quotation
                @elseif($services[0] == 'flights_tab')
                    Confirm Lead Flight Quotation
                @elseif($services[0] == 'visa_tab')
                    Confirm Lead Visa Quotation
                @elseif($services[0] == 'transportation_tab')
                    Confirm Lead Transfer Quotation
                @else
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('confirm_Lead_Quotation')}}/{{$get_invoice->id}}/{{ $lead_id }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane d-none" id="settings1">
                            ...
                            <div class="row" id="flight_append_div">
                                ...
                                <?php //dd($get_invoice->flights_details); ?>
                                ...
                                @if(isset($get_invoice->flights_details) && $get_invoice->flights_details != null && $get_invoice->flights_details != '')
                                    ...
                                    @if(isset($get_invoice->return_flights_details) && $get_invoice->return_flights_details != null && $get_invoice->return_flights_details != '')
                                        <?php $return_flights_details = json_decode($get_invoice->return_flights_details); ?>
                                        @foreach($return_flights_details as $valueR)
                                            @if(isset($flights_details[0]->departure_airport_code) && $flights_details[0]->departure_airport_code != null && $flights_details[0]->departure_airport_code != '')
                                                @if($flights_details[0]->flight_route_id_occupied == $valueR->return_flight_route_id_occupied)
                                                    <div class="main_div_flight_return_{{ $fR_count }}" style="margin-top: 10px;">
                                                        ...
                                                        <div class="row" style="padding: 12px">
                                                            <div class="col-xl-4">
                                                                <label for="">Departure Airport</label>
                                                                <input name="return_departure_airport_code[]" readonly id="departure_airport_code" value="{{ $valueR->return_departure_airport_code ?? '' }}" class="form-control" placeholder="Enter Departure Location">
                                                            </div>
                                                            <div class="col-xl-1" style="margin-top: 25px;text-align: center;">
                                                                <label for=""></label>
                                                                <span id="Change_Location" readonly class='bi bi-arrow-left-right' style="font-size: 23px;"></span>
                                                            ...
                                                            <div class="col-xl-3" style="margin-top: 15px;">
                                                                <label for="">Class Type</label>
                                                                <select  name="return_departure_Flight_Type[]" readonly  id="departure_Flight_Type" class="form-control">
                                ...
                                @if(isset($get_invoice->flights_details) && $get_invoice->flights_details != null && $get_invoice->flights_details != '')
                                    ...
                                    @if(isset($get_invoice->flights_Pax_details) && $get_invoice->flights_Pax_details != null && $get_invoice->flights_Pax_details != '')
                                        <?php $flights_Pax_details    = json_decode($get_invoice->flights_Pax_details); //dd($flights_Pax_details); ?>
                                        @foreach($flights_Pax_details as $value)
                                            @if(isset($flights_details[0]->departure_airport_code) && $flights_details[0]->departure_airport_code != null && $flights_details[0]->departure_airport_code != '')
                                                @if($flights_details[0]->flight_route_id_occupied == $value->flight_route_id_occupied)
                                        ...
                                        success:function(response){
                                            ...
                                            if(dataId != null && dataId != ''){
                                                ...
                                                if(f_route_id == booking_id){
                                                    ...
                                                    if(flights_number_of_seat > occupied_seat){
                                                        ...
                                                        var FS_data =  `<tr>
                                                                            ...
                                                                            <td><input value="${occupied_seat}" id="avalible_seats_${i}" onkeyup="avalaible_seats(${i})" type="number" class="form-control"></td>
                                                                            <td>
                                                                                <input type="hidden" id="route_availaible_seat_${i}" value="${occupied_seat}">
                        ...
                        if(dep_objectE != null && dep_objectE != ''){
                            ...
                            if(all_departure_appends != 0){
                                if(dep_flight_type == 'Direct'){
                                                ...
                                                $.each(return_object, function(key, return_objectS) {
                                                    ...
                                                    var R_data = `<div class="main_div_flight_return_${id}" style="margin-top: 10px;">
                                                                    ...
                                                                    <div class="row" style="padding: 12px">
                                                                        <div class="col-xl-4">
                                                                            <label for="">Departure Airport</label>
                                                                            <input name="return_departure_airport_code[]" readonly id="departure_airport_code" value="${return_objectS.departure}" class="form-control" placeholder="Enter Departure Location">
                                                                        </div>
                                                                        <div class="col-xl-1" style="margin-top: 25px;text-align: center;">
                                                                            <label for=""></label>
                                                                            <span id="Change_Location" readonly class='bi bi-arrow-left-right' style="font-size: 23px;"></span>
                                    ...
                                    console.log('departure_match_Status : '+departure_match_Status);
