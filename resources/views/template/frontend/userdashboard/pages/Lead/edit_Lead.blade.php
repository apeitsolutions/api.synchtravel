...
<div class="card">
    <div class="card-body">
        ...
        @if($errors->any())
            <h4>{{$errors->first()}}</h4>
        @endif
        <form action="{{URL::to('update_Lead')}}/{{ $lead_details->id }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-3" style="background-color: #eef2f7;">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link d-none" id="v-pills-history-tab" data-bs-toggle="pill" href="#history_Detail_tab" role="tab" aria-controls="v-pills-settings" aria-selected="false">History</a>
                    ...
                    <div class="col-9">
                        <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="communication_channel" name="communication_channel" required>
                                                <option <?php if($lead_details->communication_channel == '') echo 'Selected'; ?> value="">Select Channel</option>
                                                <option <?php if($lead_details->communication_channel == 'Call_Landline') echo 'Selected'; ?> value="Call_Landline">Call - Landline</option>
                                                <option <?php if($lead_details->communication_channel == 'Call_Mobile') echo 'Selected'; ?> value="Call_Mobile">Call - Mobile</option>
                                                <option <?php if($lead_details->communication_channel == 'Call_Whatsapp') echo 'Selected'; ?> value="Call_Whatsapp">Call - Whatsapp</option>
                                                <option <?php if($lead_details->communication_channel == 'Message_Whatsapp') echo 'Selected'; ?> value="Message_Whatsapp">Message - Whatsapp</option>
                                                <option <?php if($lead_details->communication_channel == 'Email') echo 'Selected'; ?> value="Email">Email</option>
                                                <option <?php if($lead_details->communication_channel == 'On_Site') echo 'Selected'; ?> value="On_Site">On Site</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="channel_phone" id="channel_phone" class="form-control" value="{{ $lead_details->channel_phone ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" name="channel_date" id="channel_date" class="form-control" value="{{ $lead_details->channel_date ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="channel_picked_by" id="channel_picked_by" class="form-control" value="{{ $lead_details->channel_picked_by ?? '' }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <select class="form-control" id="client_type" name="client_type">
                                            @if($lead_details->client_type != '-1')
                                                @if($lead_details->client_type == 'New_client')
                                                    <option value="New_client" Selected>New</option>
                                                @else
                                    ...
                                    @if(isset($lead_details->client_type) && $lead_details->client_type != null && $lead_details->client_type != '')
                                        @if($lead_details->client_type == 'Existing')
                                            @if($lead_details->customer_name == '-1')
                                                <div class="col-xl-6" id="agent_main_div" style="margin-top:15px;">
                                                    <input type="checkbox" class="custom-control-input" id="selectAgent" name="customer_select" value="booking_by_customer" checked>
                                                    <label  class="custom-control-label" for="selectAgent">Book for Agent</span></label>
                                                    
                                                    <div class="mb-3" id="agent_div" style="padding-top: 10px;">
                                                           ...
                                                           <option value="-1">Choose...</option>
                                                            @if(isset($Agents_detail) && $Agents_detail !== null && $Agents_detail !== '')
                                                                @foreach($Agents_detail as $Agents_details)
                                                                    <option <?php if($lead_details->agent_Id == $Agents_details->id) echo 'Selected'; ?> attr-Id="{{ $Agents_details->id }}" attr-AN="{{ $Agents_details->agent_Name }}" value="{{ $Agents_details->company_name }}">{{ $Agents_details->company_name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        
                                                        <input type="hidden" name="agent_Id" id="agent_Id" value="{{ $lead_details->agent_Id }}">
                                                        
                                                        <input type="hidden" name="agent_Name" id="agent_Name" value="{{ $lead_details->agent_Name }}">
                                                    </div>
                                                </div>
                                            @else
                                                <div class="col-xl-6" id="agent_main_div" style="margin-top:15px;">
                                            ...
                                            @if($lead_details->customer_name != '-1')
                                                <div class="col-xl-6" id="customer_main_div" style="margin-top:15px;">
                                                    <input type="checkbox" class="custom-control-input" id="selectcustomer" name="customer_select" value="booking_by_customer" checked>
                                                    <label  class="custom-control-label" for="selectcustomer">Book for Customer</span></label>
                                                    
                                                    <div class="mb-3" id="customer_div" style="padding-top: 10px;">
                                                           ...
                                                           <option attr-cusData="-1" value="-1">Choose...</option>
                                                            @if(isset($customers_data) && $customers_data !== null && $customers_data !== '')
                                                                @foreach($customers_data as $customers_res)
                                                                    <option <?php if($lead_details->customer_name == $customers_res->id) echo 'Selected'; ?> attr-cusData='{{ json_encode($customers_res) }}' attr-Id="{{ $customers_res->id }}" value="{{ $customers_res->id }}">{{ $customers_res->name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="passenger_Detail_tab" role="tabpanel" aria-labelledby="v-pills-passenger-tab">
                                ...
                                @if($lead_details->client_type == 'New_client')
                                    <div class="row" id="booked_by_passenger_div">
                                        <div class="col-xl-6">
                                            <div class="mb-3">
                                                <label class="form-label">Passenger Type</label>
                                                <select class="form-control" id="booked_by_passenger" name="booked_by_passenger">
                                                    <option <?php if($lead_details->booked_by_passenger == '-1') echo 'Selected'; ?> value="-1">Select Passenger Type</option>
                                                    <option <?php if($lead_details->booked_by_passenger == 'Agent') echo 'Selected'; ?> value="Agent">Agent</option>
                                                    <option <?php if($lead_details->booked_by_passenger == 'Customer') echo 'Selected'; ?> value="Customer">Customer</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="passenger_details_div">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="title" name="title">
                                                <option <?php if($lead_details->title == '') echo 'Selected'; ?> value="">Select Title</option>
                                                <option <?php if($lead_details->title == 'Mr.') echo 'Selected'; ?> value="Mr.">Mr.</option>
                                                <option <?php if($lead_details->title == 'Mrs.') echo 'Selected'; ?> value="Mrs.">Mrs.</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="first_Name" id="first_Name" class="form-control" required value="{{ $lead_details->first_Name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="last_Name" id="last_Name" class="form-control" value="{{ $lead_details->last_Name ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="gender" name="gender">
                                                <option <?php if($lead_details->gender == '') echo 'Selected'; ?> value="">Select Gender</option>
                                                <option <?php if($lead_details->gender == 'Male') echo 'Selected'; ?> value="Male">Male</option>
                                                <option <?php if($lead_details->gender == 'Female') echo 'Selected'; ?> value="Female">Female</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="{{ $lead_details->date_of_birth ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="email" id="email" class="form-control" onchange="email_validation()" value="{{ $lead_details->email ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 d-none">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="phone_No" id="phone_No" class="form-control" value="{{ $lead_details->phone_No ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="mobile_No" id="mobile_No" class="form-control" value="{{ $lead_details->mobile_No ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 d-none">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="fax" id="fax" class="form-control" value="{{ $lead_details->fax ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 d-none">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="postal_Code" id="postal_Code" class="form-control" value="{{ $lead_details->postal_Code ?? '' }}">
                                        </div>
                                    </div> 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="country" onchange="get_city_lead()" id="passenger_country" class="form-control">
                                                @foreach($all_countries as $country_res)
                                                    <option <?php if($lead_details->country == $country_res->id) echo 'Selected'; ?> value='{{ json_encode($country_res) }}'>{{ $country_res->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="passenger_city" name="city">
                                                <option value="{{ $lead_details->city ?? '' }}" selected>{{ $lead_details->city ?? '' }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control" value="{{ $lead_details->address ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="opening_Balance" id="opening_Balance" class="form-control" value="{{ $lead_details->opening_Balance ?? '' }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4" id="agent_name_div">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="Agent_Name_new" id="Agent_Name_new" class="form-control" value="{{ $lead_details->Agent_Name_new ?? '' }}">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="refered_Detail_tab" role="tabpanel" aria-labelledby="v-pills-refered-tab">
                                ...
                                @if($lead_details->client_type == 'New_client')
                                    <div class="row">
                                        <div class="col-xl-4" id="refered_by_new_div">
                                            <div class="mb-3">
                                                <label class="form-label">Refered By New</label>
                                                <select class="form-control" id="refered_by_new" name="refered_by_new">
                                                    <option <?php if($lead_details->refered_by_new == '-1') echo 'Selected'; ?> value="-1">Select Refered</option>
                                                    <option <?php if($lead_details->refered_by_new == 'Agent') echo 'Selected'; ?> value="Agent">Agent</option>
                                                    <option <?php if($lead_details->refered_by_new == 'Customer') echo 'Selected'; ?> value="Customer">Customer</option>
                                                    <option <?php if($lead_details->refered_by_new == 'Social_Media') echo 'Selected'; ?> value="Social_Media">Social Media</option>
                                                    <option <?php if($lead_details->refered_by_new == 'Website') echo 'Selected'; ?> value="Website">Website</option>
                                ...
                                @if(isset($lead_details->refered_by_new) && $lead_details->refered_by_new != null && $lead_details->refered_by_new != '')
                                    @if($lead_details->refered_by_new == 'Agent')
                                        <div class="col-xl-6" id="refered_agent_main_div" style="margin-top:15px;">
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control" id="refered_agent_Company_Name" name="refered_agent_Name">
                                                   <option value="-1">Choose...</option>
                                                    @if(isset($Agents_detail) && $Agents_detail !== null && $Agents_detail !== '')
                                                        @foreach($Agents_detail as $Agents_details)
                                                            <option <?php if($lead_details->refered_agent_Name == $Agents_details->id) echo 'Selected'; ?> attr-Id="{{ $Agents_details->id }}" attr-AN="{{ $Agents_details->agent_Name }}" value="{{ $Agents_details->id }}">{{ $Agents_details->company_name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    @if($lead_details->refered_by_new == 'Customer')
                                        <div class="col-xl-6" id="refered_customer_main_div" style="margin-top:15px;">
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control" id="refered_customer_name" name="refered_customer_name">
                                                   <option attr-cusData="-1" value="-1">Choose...</option>
                                                    @if(isset($customers_data) && $customers_data !== null && $customers_data !== '')
                                                        @foreach($customers_data as $customers_res)
                                                            <option <?php if($lead_details->refered_customer_name == $customers_res->id) echo 'Selected'; ?> attr-cusData='{{ json_encode($customers_res) }}' attr-Id="{{ $customers_res->id }}" value="{{ $customers_res->id }}">{{ $customers_res->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="emergency_Detail_tab" role="tabpanel" aria-labelledby="v-pills-emergency-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div id="more_lead_address_div">
                                        <?php $more_address = 1; ?>
                                        @if(isset($lead_details->emergency_details) && $lead_details->emergency_details != null && $lead_details->emergency_details != '')
                                            <?php 
                                                $emergency_details          = json_decode($lead_details->emergency_details);
                                                $count_emergency_details    = count($emergency_details);
                                            ?>
                                            @if($count_emergency_details > 0)
                                                @foreach($emergency_details as $emergency_details_value)
                                                    <div id="more_lead_address_div_{{ $more_address }}" class="row" style="margin-top: 20px;">
                                                        <div class="col-xl-3">
                                                            <div class="mb-3">
                                                                <label class="form-label">Name</label>
                                                                <input type="text" name="more_name[]" id="more_name_{{ $more_address }}" class="form-control" value="{{ $emergency_details_value->more_name ?? '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="mb-3">
                                                                <label class="form-label">Email</label>
                                                                <input type="text" name="more_email[]" id="more_email_{{ $more_address }}" class="form-control" value="{{ $emergency_details_value->more_email ?? '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="more_contact[]" id="more_contact_{{ $more_address }}" class="form-control" value="{{ $emergency_details_value->more_contact ?? '' }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="mb-3">
                                                                <label class="form-label">Address</label>
                                                                <input type="text" name="more_address[]" id="more_address_{{ $more_address }}" class="form-control" value="{{ $emergency_details_value->more_address ?? '' }}">
                                                            </div>
                                                        </div>
                                    ...
                                    <input value="{{ $more_address }}" id="more_address_counter" type="hidden">
                                </div>
                                
                            </div>
                            
                            <div class="tab-pane fade d-none" id="history_Detail_tab" role="tabpanel" aria-labelledby="v-pills-history-tab">
                            ...
                            <div class="tab-pane fade" id="note_Detail_tab" role="tabpanel" aria-labelledby="v-pills-note-tab">
                                ...
                                <div class="col-xl-12 mb-3" id="text_editer">
                                    <textarea name="lead_note" class="form-control" cols="10" rows="6" value="{{ $lead_details->lead_note ?? '' }}">{{ $lead_details->lead_note ?? '' }}</textarea>
                                </div>
...
<script>
    ...
    var client_type = {!!json_encode($lead_details->client_type)!!};
    ...
    // Emergency Number
    var more_address = $('#more_address_counter').val();
