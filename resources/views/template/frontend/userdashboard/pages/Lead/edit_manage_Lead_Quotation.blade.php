...
<div class="card">
    <div class="card-body">
        <h4 class="header-title">
            @if(isset($get_invoice->services) && $get_invoice->services != null && $get_invoice->services != '')
                ...
                @elseif($services[0] == 'transportation_tab')
                    Edit Transfer Invoice
                @else
                    Edit Package Invoice
                @endif
            @endif
        </h4>
        @if($errors->any())
        ...
        <!--<div class="tab-content">-->
            <form action="{{URL::to('update_manage_Lead_Quotation',[$get_invoice->id])}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3" style="margin-right: 1px;margin-left: 1px;">
                        <li class="nav-item">
                            <a href="#home1" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                ...
                                <span class="d-none d-md-block">Lead Quotation Details</span>
                            </a>
                        </li>
