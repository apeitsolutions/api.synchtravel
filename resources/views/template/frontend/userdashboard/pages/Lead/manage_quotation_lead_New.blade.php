...
<div class="card">
    <div class="card-body">
        <h4 class="header-title">Create Lead Quotation</h4>
        @if($errors->any())
            <h4>{{$errors->first()}}</h4>
        @endif
        <!--<div class="tab-content">-->
            <form action="{{URL::to('add_manage_Lead_Quotation_New')}}/{{ $lead_id }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane  show active" id="home1">
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        <label class="form-label">Quotation Valid till</label>
                                        <input type="datetime-local" name="quotation_validity" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4" id="agent_div_ALL">
                                ...
                                <div class="col-xl-4" id="customer_div_ALL">
                                ...
                                <div class="col-xl-4 d-none">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="no_of_pax_days" value="1" class="form-control no_of_pax_days" id="no_of_pax_days" required readonly>
                                ...
                                <div class="col-xl-3 more_Div_Acc_All">
                                    <div class="mb-3">
                        ...
                        <div class="tab-pane" id="Extras_details">
                            ...
                            <div class="row">
                                <input type="hidden" id="markupSwitch" name="markupSwitch" value="all_markup_switch">
                                
                                <div class="col-xl-4 markup_all_services_class" style="text-align:right;">
                                    <span>Markup On All Services</span>
                                </div>
                                
                                <div class="col-xl-4" style="text-align: right;display: none;">
                                    <span>Markup On Separate Services</span>
                                </div>
                                
                                <div class="col-xl-4 markup_switch_onoff">
                                    <input type="checkbox" id="switch2" data-switch="bool" checked/>
                                    <label for="switch2" data-on-label="On" data-off-label="On"></label>
                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="row d-none" id="flights_cost" style="display:none;padding-bottom: 25px">
                                                    ...
                                                    <div class="col-xl-2">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="hidden" id="flights_prices_per_seat_all" readonly>
                                                ...
                                                <div id="append_accomodation_data_cost" style="display:none;" class="d-none"></div>
                                                
                                                <hr style="width: 98%;margin-left: 13px;margin-top: 10px;margin-bottom: 10px;color: black;" style="display:none;"></hr>
                                                
                                                <div class="d-none" id="append_accomodation_data_cost1" style="display:none;"></div>
                                                
                                                <div class="row d-none" id="transportation_cost" style="display:none;">
                                                ...
                                                <div class="row d-none" id="visa_cost" style="display:none;">
                            ...
                            <div class="row">
                                <div class="col-xl-12" id="all_services_markup">
                                    <div class="card">
                                               ...
                                               <div class="row">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Markup type"></i>
                                                             <select class="form-control" id="all_markup_type" name="all_markup_type" >
                                                                <option value="-1">Select Markup Type</option>
                                                                <option value="%">Percentage</option>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                                                <input type="text" class="form-control" id="all_markup_add" name="all_markup_add" onkeyup="all_markup_add_function()">
                                                                <span class="input-group-btn input-group-append">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="accomodation_price_hide" class="row mt-2">
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Double Cost Price"></i>
                                                <div class="input-group">
                                                    <input class="form-control" id="without_acc_cost_price" name="without_acc_cost_price" />
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="child_total_cost_price" class="form-control" id="child_total_cost_price">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Quad Sale Price"></i>
                                                <div class="input-group">
                                                    <input type="text" name="infant_total_cost_price" class="form-control" id="infant_total_cost_price">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" id="sale_pr">
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="quad_grand_total_amount_single" class="form-control" id="quad_grand_total_amount" onkeyup="quad_sale_markup()">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="triple_grand_total_amount_single" class="form-control" id="triple_grand_total_amount" onkeyup="triple_sale_markup()">
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="double_grand_total_amount_single" class="form-control" id="double_grand_total_amount" onkeyup="double_sale_markup()">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Double Sale Price"></i>
                                                <div class="input-group">
                                                    <input type="text" name="without_acc_sale_price_single" class="form-control" id="without_acc_sale_price" onkeyup="without_acc_sale_markup()">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Triple Sale Price"></i>
                                                <div class="input-group">
                                                    <input type="text" name="child_total_sale_price" class="form-control" id="child_total_sale_price" onkeyup="child_sale_markup()">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="mb-3">
                                                ...
                                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon" data-bs-toggle="tooltip" data-bs-placement="right" title="Triple Sale Price"></i>
                                                <div class="input-group">
                                                    <input type="text" name="infant_total_sale_price" class="form-control" id="infant_total_sale_price" onkeyup="infant_sale_markup()">
                                                    <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="display:none;" id="markups_all">
                                        <div class="col-xl-2">
                                            ...
                                            <input type="readonly" class="form-control" name="quad_total_markup" id="quad_total_markup">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Triple Markup</label>
                                            <input type="readonly" class="form-control" name="triple_total_markup" id="triple_total_markup">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Double Markup</label>
                                            <input type="readonly" class="form-control" name="double_total_markup" id="double_total_markup">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Without Acc Markup</label>
                                            <input type="readonly" class="form-control" name="without_acc_total_markup" id="without_acc_total_markup">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Child Markup</label>
                                            <input type="readonly" class="form-control" name="child_total_markup" id="child_total_markup">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Infant Markup</label>
                                            <input type="readonly" class="form-control" name="infant_total_markup" id="infant_total_markup">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="pax_all">
                                        <div class="col-xl-2">
                                            ...
                                            <input type="readonly" class="form-control" name="quad_total_pax" id="quad_total_pax" onkeyup="quad_total_pax_fun()">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Triple Pax</label>
                                            <input type="readonly" class="form-control" name="triple_total_pax" id="triple_total_pax" onkeyup="triple_total_pax_fun()">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Double Pax</label>
                                            <input type="readonly" class="form-control" name="double_total_pax" id="double_total_pax" onkeyup="double_total_pax_fun()">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Without Acc Pax</label>
                                            <input type="readonly" class="form-control" name="without_acc_total_pax" id="without_acc_total_pax" onkeyup="without_acc_total_pax_fun()">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Child Pax</label>
                                            <input type="readonly" class="form-control" name="child_total_pax" id="child_total_pax" onkeyup="child_total_pax_fun()">
                                        </div>
                                        
                                        <div class="col-xl-2">
                                            <label class="form-label">Infant Pax</label>
                                            <input type="readonly" class="form-control" name="infant_total_pax" id="infant_total_pax" onkeyup="infant_total_pax_fun()">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2" id="with_pax_cost_all">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="quad_cost_with_Pax" id="quad_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="triple_cost_with_Pax" id="triple_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="double_cost_with_Pax" id="double_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="without_acc_cost_with_Pax" id="without_acc_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="child_cost_with_Pax" id="child_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="infant_cost_with_Pax" id="infant_cost_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2" id="with_pax_prices_all">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="quad_total_with_Pax" id="quad_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="triple_total_with_Pax" id="triple_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="double_total_with_Pax" id="double_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="without_acc_total_with_Pax" id="without_acc_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="child_total_with_Pax" id="child_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2">
                                            ...
                                            <div class="input-group">
                                                <input type="readonly" class="form-control" name="infant_total_with_Pax" id="infant_total_with_Pax" readonly required>
                                                <span class="input-group-btn input-group-append"><a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1"></a></span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul class="list-inline mb-0 wizard" style="margin-top:60px; display:none">
...
<script>
    var lead_deatils    = {!!json_encode($lead_deatils)!!};
    var customers_data  = {!!json_encode($customers_data)!!};
    var all_countries   = {!!json_encode($all_countries)!!};
    var Agents_detail   = {!!json_encode($Agents_detail)!!};
    
    var booked_by_passenger = lead_deatils.customer_name;
    if(booked_by_passenger != '-1'){
        $('#customer_name').empty();
        var customer_name = lead_deatils.customer_name;
        $.each(customers_data, function(key, customers_data_value) {
            if(customer_name == customers_data_value.id){
                $('#agent_div_ALL').css('display','none');
                $('#customer_div').css('display','');
                $('#selectcustomer').prop("checked", true);
                var customer_data = `<option selected attr-cusData='${customers_data_value}' attr-Id="${customers_data_value.id}" value="${customers_data_value.id}">${customers_data_value.name}</option>`;
                $('#customer_name').append(customer_data);
                
                var lead_fname      = customers_data_value.name;
                var lead_lname      = customers_data_value.name;
                var lead_email      = customers_data_value.email;
                var lead_phone      = customers_data_value.phone;
                if(lead_phone != null && lead_phone != ''){
                    lead_phone     = customers_data_value.phone;
                }else{
                    if(lead_deatils.mobile_No != null && lead_deatils.mobile_No != ''){
                        lead_phone     = lead_deatils.mobile_No;  
                    }else{
                        lead_phone     = lead_deatils.phone_No;
                    }
                }
                ...
                $('#lead_mobileI').val(lead_phone);
                
                var gender          = customers_data_value.gender;
                if(gender == 'Male'){
                ...
                var country         = lead_deatils.country;
                $.each(all_countries, function(key, all_countries_value) {
                    if(country == all_countries_value.id){
                        console.log('country Macth: '+all_countries_value.id);
                        var country_data = `<option value="${all_countries_value.id}" selected>${all_countries_value.name}</option>`;
                        $('#nationality_id').append(country_data);
                    }else{
                        var country_data = `<option value="${all_countries_value.id}">${all_countries_value.name}</option>`;
                        $('#nationality_id').append(country_data);
                    }
                });
                
            }else{
                var customer_data = `<option attr-cusData='${customers_data_value}' attr-Id="${customers_data_value.id}" value="${customers_data_value.id}">${customers_data_value.name}</option>`;
                $('#customer_name').append(customer_data);
            }
        });
    }else if(booked_by_passenger == '-1'){
        $('#agent_Company_Name').empty();
        var agent_option = `<option value="-1">Choose...</option>`;
        $('#agent_Company_Name').append(agent_option);
        var agent_Id = lead_deatils.agent_Id;
        $.each(Agents_detail, function(key, Agents_detail_value) {
            if(agent_Id == Agents_detail_value.id){
                
                $('#customer_div_ALL').css('display','none');
                $('#agent_div').css('display','');
                $('#selectAgent').prop("checked", true);
                var agent_data = `<option selected attr-Id="${Agents_detail_value.id}" attr-AN="${Agents_detail_value.agent_Name}" value="${Agents_detail_value.company_name}">${Agents_detail_value.company_name}</option>`;
                $('#agent_Company_Name').append(agent_data);
                
                var company_name    = Agents_detail_value.company_name;
                var lead_email      = Agents_detail_value.agent_Email;
                
                $('#lead_fnameI').val(company_name);
                $('#lead_lnameI').val(company_name);
                $('#lead_emailI').val(lead_email);
                
                $('#agent_Id').val(Agents_detail_value.id);
                $('#agent_Name').val(company_name);
                
                var lead_phone     = Agents_detail_value.agent_contact_number;
                if(lead_phone != null && lead_phone != ''){
                    lead_phone     = Agents_detail_value.agent_contact_number;
                }else{
                    if(lead_deatils.phone_No != null && lead_deatils.phone_No != ''){
                        lead_phone     = lead_deatils.phone_No;
                    }else{
                        lead_phone     = lead_deatils.mobile_No;
                    }
                ...
                var gender          = lead_deatils.gender;
                if(gender == 'Male'){
                    $('#flexRadioDefault3').prop("checked", true);
                }else{
                    $('#flexRadioDefault4').prop("checked", true);
                ...
                var agent_data = `<option attr-Id="${Agents_detail_value.id}" attr-AN="${Agents_detail_value.agent_Name}" value="${Agents_detail_value.company_name}">${Agents_detail_value.company_name}</option>`;
                $('#agent_Company_Name').append(agent_data);
            }
        });
    }else{
    ...
    function double_sale_markup(){
        var double_cost_price           = $('#double_cost_price').val();
        var double_grand_total_amount   = $('#double_grand_total_amount').val();
        var total_markup                = parseFloat(double_grand_total_amount) - parseFloat(double_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#double_total_markup').val(total_markup);
        $('#double_total_pax').val(0);
        
        if(parseFloat(double_cost_price) > 0){
            $('#double_cost_with_Pax').val(parseFloat(double_cost_price));
        }else{
            $('#double_cost_with_Pax').val(0);
        }
        
        if(parseFloat(double_grand_total_amount) > 0){
            $('#double_total_with_Pax').val(parseFloat(double_grand_total_amount));
        }else{
            $('#double_total_with_Pax').val(0);
        }
    }
    
    function triple_sale_markup(){
        var triple_cost_price           = $('#triple_cost_price').val();
        var triple_grand_total_amount   = $('#triple_grand_total_amount').val();
        var total_markup                = parseFloat(triple_grand_total_amount) - parseFloat(triple_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#triple_total_markup').val(total_markup);
        $('#triple_total_pax').val(0);
        
        if(parseFloat(triple_cost_price) > 0){
            $('#triple_cost_with_Pax').val(parseFloat(triple_cost_price));
        }else{
            $('#triple_cost_with_Pax').val(0);
        }
        
        if(parseFloat(triple_grand_total_amount) > 0){
            $('#triple_total_with_Pax').val(parseFloat(triple_grand_total_amount));
        }else{
            $('#triple_total_with_Pax').val(0);
        }
    }
    
    function quad_sale_markup(){
        var quad_cost_price             = $('#quad_cost_price').val();
        var quad_grand_total_amount     = $('#quad_grand_total_amount').val();
        var total_markup                = parseFloat(quad_grand_total_amount) - parseFloat(quad_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#quad_total_markup').val(total_markup);
        $('#quad_total_pax').val(0);
        
        if(parseFloat(quad_cost_price) > 0){
            $('#quad_cost_with_Pax').val(parseFloat(quad_cost_price));
        }else{
            $('#quad_cost_with_Pax').val(0);
        }
        
        if(parseFloat(quad_grand_total_amount) > 0){
            $('#quad_total_with_Pax').val(parseFloat(quad_grand_total_amount));
        }else{
            $('#quad_total_with_Pax').val(0);
        }
    }
    
    function without_acc_sale_markup(){
        var without_acc_cost_price      = $('#without_acc_cost_price').val();
        var without_acc_sale_price      = $('#without_acc_sale_price').val();
        var total_markup                = parseFloat(without_acc_sale_price) - parseFloat(without_acc_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#without_acc_total_markup').val(total_markup);
        $('#without_acc_total_pax').val(0);
        
        if(parseFloat(without_acc_cost_price) > 0){
            $('#without_acc_cost_with_Pax').val(parseFloat(without_acc_cost_price));
        }else{
            $('#without_acc_cost_with_Pax').val(0);
        }
        
        if(parseFloat(without_acc_sale_price) > 0){
            $('#without_acc_total_with_Pax').val(parseFloat(without_acc_sale_price));
        }else{
            $('#without_acc_total_with_Pax').val(0);
        }
    }
    
    function child_sale_markup(){
        var child_total_cost_price      = $('#child_total_cost_price').val();
        var child_total_sale_price      = $('#child_total_sale_price').val();
        var total_markup                = parseFloat(child_total_sale_price) - parseFloat(child_total_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#child_total_markup').val(total_markup);
        $('#child_total_pax').val(0);
        
        if(parseFloat(child_total_cost_price) > 0){
            $('#child_cost_with_Pax').val(parseFloat(child_total_cost_price));
        }else{
            $('#child_cost_with_Pax').val(0);
        }
        
        if(parseFloat(child_total_sale_price) > 0){
            $('#child_total_with_Pax').val(parseFloat(child_total_sale_price));
        }else{
            $('#child_total_with_Pax').val(0);
        }
    }
    
    function infant_sale_markup(){
        var infant_total_cost_price     = $('#infant_total_cost_price').val();
        var infant_total_sale_price     = $('#infant_total_sale_price').val();
        var total_markup                = parseFloat(infant_total_sale_price) - parseFloat(infant_total_cost_price);
        total_markup                    = total_markup.toFixed(2);
        $('#infant_total_markup').val(total_markup);
        $('#infant_total_pax').val(0);
        
        if(parseFloat(infant_total_cost_price) > 0){
            $('#infant_cost_with_Pax').val(parseFloat(infant_total_cost_price));
        }else{
            $('#infant_cost_with_Pax').val(0);
        }
        
        if(parseFloat(infant_total_sale_price) > 0){
            $('#infant_total_with_Pax').val(parseFloat(infant_total_sale_price));
        }else{
            $('#infant_total_with_Pax').val(0);
        }
    }
    
    function double_total_pax_fun(){
        var double_grand_total_amount   = $('#double_grand_total_amount').val();
        var double_cost_price           = $('#double_cost_price').val();
        if(parseFloat(double_grand_total_amount) > 0 && parseFloat(double_cost_price) > 0){
            var double_total_pax        = $('#double_total_pax').val();
            var total_markup            = parseFloat(double_grand_total_amount) * parseFloat(double_total_pax);
            total_markup                = total_markup.toFixed(2);
            $('#double_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(double_cost_price) * parseFloat(double_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#double_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Double Sale Price is 0');
        }
    }
    
    function triple_total_pax_fun(){
        var triple_grand_total_amount   = $('#triple_grand_total_amount').val();
        var triple_cost_price           = $('#triple_cost_price').val();
        if(parseFloat(triple_grand_total_amount) > 0 && parseFloat(triple_cost_price) > 0){
            var triple_total_pax            = $('#triple_total_pax').val();
            var total_markup                = parseFloat(triple_grand_total_amount) * parseFloat(triple_total_pax);
            total_markup                    = total_markup.toFixed(2);
            $('#triple_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(triple_cost_price) * parseFloat(triple_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#triple_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Triple Sale Price is 0');
        }
    }
    
    function quad_total_pax_fun(){
        var quad_grand_total_amount   = $('#quad_grand_total_amount').val();
        var quad_cost_price           = $('#quad_cost_price').val();
        if(parseFloat(quad_grand_total_amount) > 0 && parseFloat(quad_cost_price) > 0){
            var quad_total_pax          = $('#quad_total_pax').val();
            var total_markup            = parseFloat(quad_grand_total_amount) * parseFloat(quad_total_pax);
            total_markup                = total_markup.toFixed(2);
            $('#quad_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(quad_cost_price) * parseFloat(quad_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#quad_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Quad Sale Price is 0');
        }
    }
    
    function without_acc_total_pax_fun(){
        var without_acc_sale_price  = $('#without_acc_sale_price').val();
        var without_acc_cost_price  = $('#without_acc_cost_price').val();
        if(parseFloat(without_acc_sale_price) > 0 && parseFloat(without_acc_cost_price) > 0){
            var without_acc_total_pax   = $('#without_acc_total_pax').val();
            var total_markup            = parseFloat(without_acc_sale_price) * parseFloat(without_acc_total_pax);
            total_markup                = total_markup.toFixed(2);
            $('#without_acc_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(without_acc_cost_price) * parseFloat(without_acc_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#without_acc_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Without Acc Sale Price is 0');
        }
    }
    
    function child_total_pax_fun(){
        var child_total_sale_price  = $('#child_total_sale_price').val();
        var child_total_cost_price  = $('#child_total_cost_price').val();
        if(parseFloat(child_total_sale_price) > 0 && parseFloat(child_total_cost_price) > 0){
            var child_total_pax             = $('#child_total_pax').val();
            var total_markup                = parseFloat(child_total_sale_price) * parseFloat(child_total_pax);
            total_markup                    = total_markup.toFixed(2);
            $('#child_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(child_total_cost_price) * parseFloat(child_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#child_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Child Sale Price is 0');
        }
    }
    
    function infant_total_pax_fun(){
        var infant_total_sale_price  = $('#infant_total_sale_price').val();
        var infant_total_cost_price  = $('#infant_total_cost_price').val();
        if(parseFloat(infant_total_sale_price) > 0 && parseFloat(infant_total_cost_price) > 0){
            var infant_total_pax            = $('#infant_total_pax').val();
            var total_markup                = parseFloat(infant_total_sale_price) * parseFloat(infant_total_pax);
            total_markup                    = total_markup.toFixed(2);
            $('#infant_total_with_Pax').val(total_markup);
            
            var total_markup_cost       = parseFloat(infant_total_cost_price) * parseFloat(infant_total_pax);
            total_markup_cost           = total_markup_cost.toFixed(2);
            $('#infant_cost_with_Pax').val(total_markup_cost);
        }else{
            alert('Infant Sale Price is 0');
        }
    }
...
<script>
                                    ...
                                    if(departure_time_date == start_date_date || departure_time_date == start_dateB || departure_time_date == start_dateA){
                                        $.ajax({
                                            ...
                                            success:function(response){
                                                ...
                                                console.log('flights_number_of_seat : '+flights_number_of_seat);
                                                console.log('occupied_seat1 : '+occupied_seat1);
    ...
    function flight_occupy_function(id){
        ...
        var routes_count_id = $('#routes_count_id').val();
        console.log('routes_count_id : '+routes_count_id);
    ...
    function flight_price_calculation(id){
        ...
        var flights_per_seats_cost_all      = 0;
        var flights_TCA                     = 0;
        var flights_MPA                     = 0;
        var flights_SPA                     = 0;
        ...
        for(var i=1; i<=total_append ;i++){
            ...
            // Per Seat All
            var flights_cost_per_seats_adult = $('#flights_cost_per_seats_adult_'+i+'').val();
            if(flights_cost_per_seats_adult != null && flights_cost_per_seats_adult != ''){
                flights_per_seats_cost_all = parseFloat(flights_per_seats_cost_all) +  parseFloat(flights_cost_per_seats_adult);
                $('#flights_prices_per_seat_all').val(flights_per_seats_cost_all);
            }
            
            var flights_cost_per_seats_child = $('#flights_cost_per_seats_child_'+i+'').val();
            if(flights_cost_per_seats_child != null && flights_cost_per_seats_child != ''){
                flights_per_seats_cost_all = parseFloat(flights_per_seats_cost_all) +  parseFloat(flights_cost_per_seats_child);
                $('#flights_prices_per_seat_all').val(flights_per_seats_cost_all);
            }
            
            var flights_cost_per_seats_infant = $('#flights_cost_per_seats_infant_'+i+'').val();
            if(flights_cost_per_seats_infant != null && flights_cost_per_seats_infant != ''){
                flights_per_seats_cost_all = parseFloat(flights_per_seats_cost_all) +  parseFloat(flights_cost_per_seats_infant);
                $('#flights_prices_per_seat_all').val(flights_per_seats_cost_all);
            }
            // Per Seat All
...
<script>
        ...
        $.each(selectedServices, function(key, value) {
            if(value != null && value != ''){
                if((value == '1')){
                    ...
                    $('.markup_all_services_class').css('display','');
                    $('#markupSwitch').val('all_markup_switch');
                    $('.markup_all_separate_class').css('display','none');
                    $('.markup_switch_onoff').css('display','');
                    $('#all_services_markup').css('display','');
                    $('#markup_services').css('display','none');
                    
                    $('#accomodation_price_hide').css('display','');
                    $('#sale_pr').css('display','');
                    
                    $('#flights_cost').css('display','none');
                    $('#append_accomodation_data_cost').css('display','none');
                    $('#append_accomodation_data_cost1').css('display','none');
                    $('#transportation_cost').css('display','none');
                    $('#visa_cost').css('display','none');
                    
                }else if(value == 'accomodation_tab'){
                    $('.start_date_label').html('Start Date');
                    $('.more_Div_Acc_All').css('display','');
                    $('.no_of_Nights_Other').html('No Of Nights');
                    $('.start_date_div').css('display','');
                    ...
                    $('.markup_all_services_class').css('display','none');
                    $('#markupSwitch').val('single_markup_switch');
                    $('.markup_all_separate_class').css('display','');
                    $('.markup_switch_onoff').css('display','');
                    $('#all_services_markup').css('display','none');
                    $('#markup_services').css('display','');
    ...
    function calculateGrandWithoutAccomodation(){
        ...
        // GrandWAcprice           = parseFloat(GrandWAcprice);
        // GrandWAcprice           = GrandWAcprice.toFixed(2);
        // console.log('Grand total is '+GrandWAcprice);
        
        var flightCostPrice     = 0;
        var visa_price_select   = 0;
        var transportCostPrice  = 0;
        
        var flightCostPrice = $('#flights_prices_per_seat_all').val();
        console.log('flightCostPrice : '+flightCostPrice);
        if(flightCostPrice > 0){
            flightCostPrice = parseFloat(flightCostPrice);
            flightCostPrice = flightCostPrice.toFixed(2);
        }else{
            flightCostPrice = 0;
        }
        
        var visa_price_select  = $('#visa_price_select').val();
        console.log('visa_price_select : '+visa_price_select);
        if(visa_price_select > 0){
            // var visa_Pax        = $('#visa_Pax').val();
            // visa_price_select   = visa_price * visa_Pax;
            visa_price_select   = parseFloat(visa_price_select);
            visa_price_select   = visa_price_select.toFixed(2);
        }else{
            visa_price_select = 0;
        }
        
        var transport_Price  = $('#transportation_price_per_person_select').val();
        console.log('transport_Price : '+transport_Price);
        if(transport_Price > 0){
            transportCostPrice = parseFloat(transport_Price);
            transportCostPrice = transportCostPrice.toFixed(2);
        }else{
            transportCostPrice = 0;
        }
        
        var GrandWAcprice       = parseFloat(transportCostPrice) + parseFloat(visa_price_select) + parseFloat(flightCostPrice);
        GrandWAcprice           = parseFloat(GrandWAcprice);
        GrandWAcprice           = GrandWAcprice.toFixed(2);
        ...
        if(GrandWAcprice > 0){
            ...
            $('#without_acc_cost_price').val(0);
            $('#without_acc_sale_price').val(0);
        }
    }
...
<script>
    ...
    $(document).on('click','#visa_inc',function(){
        ...
        $.ajax({    
            ...
            success: function(data){  
                ...
                var visa_type_select = data2['visa_type'][0]['other_visa_type'];
                $('#visa_type_select').val(visa_type_select);
            }
        });
    });
    ...
    //     $.ajax({    
    //       url: '{{URL::to('get_other_visa_type_detail')}}',
    ...
    function all_markup_add_function(){
        var id                      = $('#all_markup_type').find('option:selected').attr('value');
        ...
        if(id == '-1'){
            ...
            if(quad_cost_price != 0){
                ...
                $('#quad_grand_total_amount').val(total_quad_cost_price);
                $('#quad_cost_with_Pax').val(total_quad_cost_price);
                $('#quad_total_with_Pax').val(total_quad_cost_price);
            }else{
               $('#quad_markup').val(0);
            }
            ...
            if(triple_cost_price != 0){
                ...
                $('#triple_grand_total_amount').val(total_triple_cost_price);
                $('#triple_cost_with_Pax').val(total_triple_cost_price);
                $('#triple_total_with_Pax').val(total_triple_cost_price);
            }else{
                $('#triple_markup').val(0);
            }
            ...
            if(double_cost_price != 0){
                ...
                $('#double_grand_total_amount').val(total_double_cost_price);
                $('#double_cost_with_Pax').val(total_double_cost_price);
                $('#double_total_with_Pax').val(total_double_cost_price);
            }else{
                $('#double_markup').val(0);
            }
            
            if(without_acc_cost_price != 0 && without_acc_cost_price != null && without_acc_cost_price != ''){
                ...
                $('#without_acc_sale_price').val(total_without_acc_cost_price);
                $('#without_acc_cost_with_Pax').val(total_without_acc_cost_price);
                $('#without_acc_total_with_Pax').val(total_without_acc_cost_price);
            }else{
                $('#without_acc_sale_price').val(0);
            }
            
            if(child_total_cost_price != 0){
                var child_total_cost_price1 = (child_total_cost_price * markup_val/100) + parseFloat(child_total_cost_price);
                var child_total_cost_price2 = child_total_cost_price1.toFixed(2); 
                $('#child_total_sale_price').val(child_total_cost_price2);
                $('#child_cost_with_Pax').val(child_total_cost_price2);
                $('#child_total_with_Pax').val(child_total_cost_price2);
            }else{
               $('#child_total_sale_price').val(0);
            }
            
            if(infant_total_cost_price != 0){
                var infant_total_cost_price1 = (infant_total_cost_price * markup_val/100) + parseFloat(child_total_cost_price);
                var infant_total_cost_price2 = infant_total_cost_price1.toFixed(2); 
                $('#infant_total_sale_price').val(infant_total_cost_price2);
                $('#infant_cost_with_Pax').val(infant_total_cost_price1);
                $('#infant_total_with_Pax').val(infant_total_cost_price1);
            }else{
               $('#infant_total_sale_price').val(0);
            }
            ...
            if(child_total_cost_price != 0){
                var child_total_cost_price1 = parseFloat(child_total_cost_price) + parseFloat(markup_val);
                var child_total_cost_price2 = child_total_cost_price1.toFixed(2); 
                $('#child_total_sale_price').val(child_total_cost_price2);
                $('#child_cost_with_Pax').val(child_total_cost_price2);
                $('#child_total_with_Pax').val(child_total_cost_price2);
            ...
            if(infant_total_cost_price != 0){
                var infant_total_cost_price1 = parseFloat(infant_total_cost_price) + parseFloat(markup_val);
                var infant_total_cost_price1 = infant_total_cost_price1.toFixed(2); 
                $('#infant_total_sale_price').val(infant_total_cost_price1);
                $('#infant_cost_with_Pax').val(infant_total_cost_price1);
                $('#infant_total_with_Pax').val(infant_total_cost_price1);
            }else{
               $('#infant_total_sale_price').val(0);
...
<script>
    ...
    $('#transportation_no_of_vehicle').keyup(function() {
        ...
        // }else{
        //     var total_trans1    = parseFloat(transportation_price_per_vehicle);
        // }
        var total_trans = parseFloat(total_trans);
        total_trans     = total_trans.toFixed(2);
        ...
        var transportation_price_per_person = parseFloat($('#transportation_price_per_person').val());
        transportation_price_per_person     = transportation_price_per_person.toFixed(2);
        ...
        if(select_exchange_type == 'Divided'){
            ...
            var transportation_price_per_person_converted     = parseFloat(transportation_price_per_person)/parseFloat(exchange_Rate);
        }else{
            var without_markup_price_converted_destination    = parseFloat(transportation_price_per_vehicle) * parseFloat(exchange_Rate);
            var transportation_vehicle_total_price_converted  = parseFloat(t_trans) * parseFloat(exchange_Rate);
            var transportation_price_per_person_converted     = parseFloat(transportation_price_per_person) * parseFloat(exchange_Rate);
        ...
        $('#transportation_price_per_person_select').val(transportation_price_per_person_converted);
...
<script>
    ...
    function add_numberElseI(){
        var flights_prices = parseFloat($("#flights_prices_per_seat_all").val());  
        ...
        var visa_price_select = parseFloat($("#visa_price_select").val());  
        ...
        var transportation_price_per_person_select = parseFloat($("#transportation_price_per_person_select").val());
        ...
        var sumData = parseFloat(flights_prices) + parseFloat(visa_price_select) + parseFloat(transportation_price_per_person_select);
        if(quad_hotel != 0){
...
<script>
                ...
                $('#property_city_new'+i+'').on('change',function(){
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            ...
                            var amenities_details   = result['amenities_details'];
                            ...
                            $.each(user_hotels, function(key, value) {
                                ...
                                var attr_Amenities      = '';
                                if(amenities_details != null && amenities_details != ''){
                                    $.each(amenities_details, function(key, amenities_details_value) {
                                        if(amenities_details_value['id'] == attr_ID){
                                            attr_Amenities = amenities_details_value.amenities;
                                        }
                                    });
                                }
                                var data_append = `<option attr_Amenities='${attr_Amenities}' attr_ID="${attr_ID}" value="${property_name}">${property_name}</option>`;
    ...
    function get_room_types(id){
        ...
        var hotel_attr_amenities    = $('.get_room_types_'+id+'').find('option:selected').attr('attr_amenities');
        $('#hotel_whats_includedID_'+id+'').empty();
        $('#hotel_whats_includedID_'+id+'').append(hotel_attr_amenities);
    ...
    function makkah_acc_room_price_funsI(id){
        ...
        if(room_select_type == 'false'){
            ...
            var room_type_Obj = JSON.parse(room_type_data);
             ...
             hotel_type_price            =  parseFloat(room_type_Obj['no_of_persons']);
    ...
    $("#currency_conversion1").on('change', function(){
        ...
        $('.currency_value_exchange_1').html(value_1);
        ...
        var data = `<div id="vehicle_div_${divId}" class="row">
                        ...
                        <div class="col-md-2" style="padding: 15px;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="vehicle_Fare${divId}" name="vehicle_Fare[]" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2" style="padding: 15px;">
                            <label for="">Exchage Rate</label>
                            <div class="input-group">
                                <input type="text" id="exchange_Rate${divId}" name="exchange_Rate[]" class="form-control" onkeyup="exchange_Rate_function(${divId})">
                                <span class="input-group-btn input-group-append">
                                    <a class="btn btn-primary bootstrap-touchspin-up currency_value1_modal"></a>
                                </span>
                            </div>
                        ...
                        <div class="col-md-2" style="padding: 15px;">
                            <label for="">Total Fare</label>
                            <div class="input-group">
                                <input type="text" id="vehicle_total_Fare${divId}" name="vehicle_total_Fare[]" class="form-control">
                                <span class="input-group-btn input-group-append">
                                    <a class="btn btn-primary bootstrap-touchspin-up currency_value_exchange_1_modal"></a>
                                </span>
                            </div>
...
<script>
                                    ...
                                    $.each(vehicle_details, function(key, value1) {
                                        ...
                                        if(transfer_supplier_id == transfer_supplier_Id){
                                            if(transfer_vehicle_id_td == vehicle_id){
                                                ...
                                                $('#transportation_price_per_person').val(vehicle_Fare);
                                        ...
                                        $.each(vehicle_details, function(key, value1) {
                                            ...
                                            if(transfer_supplier_id == transfer_supplier_Id){
                                                if(transfer_vehicle_id_td == vehicle_id){
                                                    ...
                                                    $('#transportation_price_per_person_'+TD_id1+'').val(vehicle_Fare);
    ...
    function TNOV_function(id){
        ...
        var transportation_price_per_person = parseFloat($('#transportation_price_per_person_'+id+'').val());
        transportation_price_per_person     = transportation_price_per_person.toFixed(2);
        ...
        var Tran_price_all_vehicleC     = 0;
        for(x=1; x<transportation_price_switch; x++){
            var transportation_price_per_person                 = $('#transportation_price_per_person_converted_'+x+'').val();
            var transportation_no_of_vehicle                    = $('#transportation_no_of_vehicle_'+x+'').val();
            var transportation_price_per_vehicle                = $('#transportation_price_per_vehicle_'+x+'').val();
            var transportation_vehicle_total_price              = $('#transportation_vehicle_total_price_'+x+'').val();
            var transportation_vehicle_total_price_converted    = $('#transportation_vehicle_total_price_converted_'+x+'').val();
            
            // console.log('transportation_price_per_person : '+transportation_price_per_person);
            
            if(transportation_price_per_person != null && transportation_price_per_person != ''){
                Tran_Orignal_price = parseFloat(Tran_Orignal_price) + parseFloat(transportation_price_per_person);
                Tran_Orignal_price = Tran_Orignal_price.toFixed(2);
                // console.log('Tran_Orignal_price : '+Tran_Orignal_price);
                $('#transportation_price_per_person_select').val(Tran_Orignal_price);
            }
