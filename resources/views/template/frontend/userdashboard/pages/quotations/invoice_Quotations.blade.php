<?php $currency = $data->currency_symbol ?? '';  // dd($data);?>
        ...
        <div class="cs-container">
            <div class="cs-invoice cs-style1">
                <div class="cs-invoice_in" id="download_section">
                    <img src="{{ asset('/public/admin_package/frontend/images/letter-head.png') }}" alt="letterhead">
                   
                    <div class="cs-invoice_head cs-mb10">
                        <div class="cs-invoice_left">
                            <p style="color: #cead65;font-size: 30px; text-transform: uppercase;margin-top: 17px;">
                                <b class="cs-invoice_number cs-mb0">Quotation No:</b><b style="color: #000;"> {{  $data->generate_id ?? '' }} </b>
                                </p>
                                <p>
                                <b class="cs-primary_color">
                                    @if($data->confirm != 1)
                                        <img src="{{ asset('/public/admin_package/frontend/images/tentative.png') }}" alt="tentative">
                                    @else
                                        <img src="{{ asset('/public/admin_package/frontend/images/conf.png') }}" alt="confirmed">
                                    @endif
                                
                                </b><br>
                                <?php $service_select = json_decode($data->services); ?>
                                @if(isset($service_select) && $service_select != null && $service_select != '')
                                    @if($service_select[0] != 'flight_tab' && $service_select[0] != 'transportation_tab' && $service_select[0] != 'visa_tab')
                                        <b class="cs-primary_color d-none"> Duration : {{ $data->time_duration ?? '' }} Nights</b> <br>
                                    @endif
                                @endif
                                
                                @if(isset($customer_data))
                                    <b class="cs-primary_color">Created By {{ $data->tour_author ?? 'Admin' }}</b> <br>
                                @endif
                                <b class="cs-primary_color">
                                 <?php
                        ...
                        <div class="cs-invoice_right cs-text_right">
                            @if(isset($agent_data))
                                <b style="margin-top:25px; display: block;"></b>
                                <b class="cs-primary_color"> Agent Company Name:  {{ $agent_data->company_name ?? '' }}</b> <br>
                            @endif
                    
                            @if(isset($data->f_name) && $data->f_name != null && $data->f_name != '')
                                <b class="cs-primary_color"> Lead Passenger Name :  {{$data->f_name}} {{ $data->middle_name }} </b><br>
                            @endif
                            
                            @if(isset($data->quotation_validity) && $data->quotation_validity != null && $data->quotation_validity != '')
                                <?php
                                    $quotation_validity = date('d-m-Y H:i',strtotime($data->quotation_validity));
                                ?>
                                <div style="margin-top: 140px;font-size: 20px;">
                                    <b class="cs-primary_color"> Quotation Valid till :  {{ $quotation_validity }} </b><br>
                                </div>
                            @endif
                        </div>
                    </div>
                    
                    <div class="cs-invoice_head cs-50_col cs-mb25 d-none">
                            ...
                            @if($service_select[0] == '1' || $service_select[0] == 'accomodation_tab')
                                <div class="cs-invoice_right">
                                    <ul class="cs-bar_list">
                                        <li>
                                            <b class="cs-primary_color"><img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/plane-departure-solid.svg" alt="Logo"> </b>
                                            <?php
                                        ...
                                        <li><b class="cs-primary_color"> <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/plane-arrival-solid.svg"alt="Logo"></b>
                                            <?php
                    ...
                    @if(isset($data->more_Passenger_Data) && $data->more_Passenger_Data != null && $data->more_Passenger_Data != '')
                                    ...
                                    @foreach($accomodation_details as $accomodation_details)
                                        <li>
                                            <div class="cs-list_left" style="font-size: 13px;">
                                                ...
                                                <p class="cs-mb0">
                                                    <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/calendar-check-solid.svg"alt="Logo">   Check In:{{$accomodation_details->acc_check_in}} 
                                                    <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/calendar-check-solid.svg"alt="Logo">  Check Out: {{$accomodation_details->acc_check_out}}<br>
                                    ...
                                    <ul class="cs-list cs-style2">
                                        ...
                                        <li>
                                            <div class="cs-list_left">
                                                ...
                                                <p class="cs-mb0">
                                                    <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/location-dot-solid.svg"alt="Logo">  Pick Up :{{$transportation_details->transportation_pick_up_location}} <br>
                                                    <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/location-dot-solid.svg"alt="Logo">  Drop Off: {{$transportation_details->transportation_drop_off_location}}<br>
                                                    <img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/calendar-solid.svg"alt="Logo">  Pick Up Date: 
                                                        <?php
                                                            $transportation_pick_up_date = date('d-m-Y H:i',strtotime($transportation_details->transportation_pick_up_date));
                                                        ?>
                    ...
                    @if(isset($service_select) && $service_select != null && $service_select != '')
                                    ...
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                <tr class="d-none"><td>Total Adults : {{ $data->no_of_pax_days }}</td></tr>
                                                ...
                                                @if(isset($more_visa_detailsE) && $more_visa_detailsE != null && $more_visa_detailsE != '')  
                                                    ...
                                                    @foreach($more_visa_details as $more_visa_details1)
                                                        <tr style="text-align:center;">
                                                            ...
                                                            <td>{{ $currency }} {{ $more_visa_details1->more_total_visa_markup_value ?? '0' }}</td>
                                                            <td>{{ $currency }} {{ $more_visa_details1->more_total_visa_markup_value ?? '0' * $more_visa_details1->more_visa_Pax ?? '0' }}</td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </tbody>
                        ...
                        @elseif($service_select[0] == 'transportation_tab')  
                            ...
                            <div class="cs-table cs-style1">
                                <div class="cs-round_border">
                                    <div class="t-heading-top"><i class="fa-solid fa-bus"></i> Transportation Invoice Details</div>
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                <tr style="border: 2px solid #000000; text-align:center;">
                                                    ...
                                                    <td class="cs-primary_color cs-semi_bold">Vehicle Details</td>
                                                    <td class="cs-primary_color cs-semi_bold">Price Per Vehicle</td>
                                                    <td class="cs-primary_color cs-semi_bold">Total Price</td>
                                                </tr>
                                                
                                                @if(isset($transportation_details_E) && $transportation_details_E != null && $transportation_details_E != '')
                                                    <?php 
                                                        $transportation_details_D = json_decode($transportation_details_E); 
                                                        // dd($transportation_details_D);
                                                        // $transportation_no_of_vehicle = 0;
                                                    ?>
                                                    @foreach($transportation_details_D as $transportation_details_DS)
                                                        @if($transportation_details_DS->transportation_trip_type != null && $transportation_details_DS->transportation_trip_type != '')
                                                            ...
                                                            <tr style="text-align:center;">
                                                                ...
                                                                <td>{{ $transportation_details_DS->transportation_no_of_vehicle ?? ''}}({{ $transportation_details_DS->transportation_vehicle_type ?? '' }})</td>
                                                                <td>
                                                                    <a class="btn btn-primary bootstrap-touchspin-up">{{ $transportation_details_DS->currency_GBP ?? '' }}</a>
                                                                    {{ $transportation_details_DS->markup_price_per_vehicle_converted ?? ''}}
                                                                </td>
                                                                <td>
                                                                    <a class="btn btn-primary bootstrap-touchspin-up">{{ $transportation_details_DS->currency_GBP ?? '' }}</a>
                                                                    {{ $transportation_details_DS->vehicle_total_price_with_markup_converted ?? '' }}
                                                                </td>
                                                            </tr>
                            ...
                            <div class="cs-table cs-style1">
                                <div class="cs-round_border">
                                    <div class="t-heading-top"><i class="fa-solid fa-bus"></i> Destination Details</div>
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                <tr style="border: 2px solid #000000; text-align:center;">
                                                    <td class="cs-primary_color cs-semi_bold">Pickup Location</td>
                                                    <td class="cs-primary_color cs-semi_bold">Dropoff Location</td>
                                                    <td class="cs-primary_color cs-semi_bold">Pickup Time</td>
                                                    <td class="cs-primary_color cs-semi_bold">Dropoff Time</td>
                                                    <td class="cs-primary_color cs-semi_bold">Total Duration</td>
                                                </tr>
                                                    ...
                                                    @foreach($transportation_details_D as $transportation_details_DS)
                                                        @if($transportation_details_DS->transportation_trip_type != null && $transportation_details_DS->transportation_trip_type != '')
                                                            <tr style="text-align:center;">
                                                                ...
                                                                <td>
                                                                    <?php
                                                                        $dateValue  = strtotime(date("d-m-Y", strtotime($transportation_details_DS->transportation_pick_up_date ?? '' )));
                                                                        $dateNo     = date('d',$dateValue);
                                                                        $monthNum   = date('m',$dateValue);
                                                                        $year       = date('Y',$dateValue);
                                                                        $timeFormat = date("d-m-Y H:i", strtotime($transportation_details_DS->transportation_pick_up_date ?? '' ));
                                                                        // echo $dateNo . '/' . $monthNum . '/' . $year;
                                                                        echo $timeFormat;
                                                                    ?>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                        $timeFormat = date("d-m-Y H:i", strtotime($transportation_details_DS->transportation_drop_of_date ?? '' ));
                                                                        echo $timeFormat;
                                                                    ?>
                                                                </td>
                                                                <td>{{ $transportation_details_DS->transportation_total_Time ?? '' }}</td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                                @endif 
                                                @if(isset($transportation_details_more_E) && $transportation_details_more_E != null && $transportation_details_more_E != '')
                                                    ...
                                                    @foreach($transportation_details_more_D as $transportation_details_more_DS)        
                                                        <tr style="text-align:center;">
                                                            ...
                                                            <td>
                                                                <?php
                                                                    $timeFormat = date("d-m-Y H:i", strtotime($transportation_details_more_DS->more_transportation_pick_up_date ?? '' ));
                                                                    echo $timeFormat;
                                                                ?>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                    $timeFormat = date("d-m-Y H:i", strtotime($transportation_details_more_DS->more_transportation_drop_of_date ?? '' ));
                                                                    echo $timeFormat;
                                                                ?>
                                                            </td>
                    ...
                    @if(isset($accomodation_details) && $accomodation_details != null && $accomodation_details != '')
                        @if($data->all_services_quotation != '1')
                            <div class="cs-table cs-style1">
                                <div class="t-heading-top"><i class="fa-solid fa-bed"></i> Room Details</div>
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                <tr>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16" colspan="3">Rooms</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Hotel Name/City</td>
                                                    <!--<td class="cs-primary_color cs-semi_bold cs-f16">Dates</td>-->
                                                    <!--<td class="cs-primary_color cs-semi_bold cs-f16">Check-out</td>-->
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Price/Room</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Total Room Price</td>
                                                </tr>
                                                @foreach($accomodation_details as $accomodation_details)
                                                    <tr>
                                                        ...
                                                        <td class="cs-f14">
                                                            ...
                                                            <img style="border: 0;max-width: 4%;height: auto;vertical-align: middle;" src="https://system.alhijaztours.net/public/invoice/assets/img/calendar-check-solid.svg"alt="Logo">
                                                            <?php
                                                        ...
                                                        <td class="cs-f14">{{ $currency ?? '' }} {{ $accomodation_details->hotel_invoice_markup ?? '0'}}</td>
                                                        <td class="cs-f14">
                                                            {{ $currency ?? '' }}
                                                        ...
                                                        @foreach($accomodation_details_more as $accomodation_details_more1)
                                                            @if($accomodation_details_more1->more_hotel_city == $accomodation_details->hotel_city_name)
                                                                <tr>
                                                                    ...
                                                                    <td class="cs-f14">{{ $currency ?? '' }} {{ $accomodation_details_more1->more_hotel_invoice_markup ?? '0'}}</td>
                                                                    <td class="cs-f14">
                                                                        {{ $currency ?? '' }} 
                                            ...
                                            @if(isset($accomodation_details_more) && $accomodation_details_more != null && $accomodation_details_more != '')
                                                @foreach($accomodation_details_more as $accomodation_details_more1)
                                                    @if($accomodation_details_more1->more_hotel_city == $accomodation_details->hotel_city_name)
                                                        <li>
                                                            <div class="cs-list_left" style="font-size: 15px;">
                                                                <b class="cs-primary_color"> <i class="fa-solid fa-hotel"></i> Hotel Name :{{$accomodation_details_more1->more_acc_hotel_name}} </b> <br><br>
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <img style="max-width: 17px;margin-right: 5px;" src="{{asset('public/invoice/assets/img/calendar-check-solid.svg')}}" alt="Logo">   Check In:{{$accomodation_details_more1->more_acc_check_in}} 
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <img style="max-width: 17px;margin-right: 5px;" src="{{asset('public/invoice/assets/img/calendar-check-solid.svg')}}"alt="Logo">  Check Out: {{$accomodation_details_more1->more_acc_check_out}}
                                                                    </div>
                                                                    @if(isset($accomodation_details_more1->more_hotel_meal_type) && $accomodation_details_more1->more_hotel_meal_type != null && $accomodation_details_more1->more_hotel_meal_type != '')
                                                                        <div class="col-sm-4">
                                                                            <img style="max-width: 17px;margin-right: 5px;" src="{{asset('public/invoice/assets/img/meal-icon.png')}}"alt="Logo">  Meal Type: {{$accomodation_details_more1->more_hotel_meal_type}}
                                                                        </div>
                                                                    @else
                                                                    @endif
                                                                </div>
                    ...
                    <?php 
                        $adultfinalqty              = $data->adultfinalqty ?? '';
                        $childfinalqty              = $data->childfinalqty ?? '';
                        $infantfinalqty             = $data->infantfinalqty ?? '';
                        $adult_total_with_markup    = $data->adult_total_with_markup ?? '0';
                        $child_total_with_markup    = $data->child_total_with_markup ?? '0';
                        $infant_total_with_markup   = $data->infant_total_with_markup ?? '0';
                        $adult_markup_price1        = $data->adult_markup_price1 ?? '0';
                        $total_markup_for_child     = $data->total_markup_for_child ?? '0';
                        $total_markup_for_infant    = $data->total_markup_for_infant ?? '0';
                    ?>
                    <?php 
                        $flights_details        = $data->flights_details;
                        $return_flights_details = $data->return_flights_details; 
                        $flights_Pax_details    = $data->flights_Pax_details; 
                    ?>
                    
                    @if($data->all_services_quotation != '1')
                        @if(isset($flights_details) && $flights_details != null && $flights_details != '')
                            <?php $flights_details_E = json_decode($flights_details); // dd($flights_details_E); ?>
                            @if(is_array($flights_details_E))
                                <div class="cs-table cs-style1">
                                    <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Departure Details ({{ $flights_details_E[0]->departure_flight_route_type }})</div>
                                    <div class="row">
                                        <div class="col-lg-6" style="font-size: 25px;background: white;color: black;padding: 10px;">
                                            <i class="fa-solid fa-plane"></i>
                                            {{ $flights_details_E[0]->departure_airport_code ?? '' }}
                                        </div>
                                        
                                        <div class="col-lg-6" style="font-size: 25px;background: white;color: black;padding: 10px;text-align: right;">
                                            <i class="fa-solid fa-plane"></i>
                                            {{ $flights_details_E[1]->arrival_airport_code ?? '' }}
                                        </div>
                                    </div>
                                    <div class="cs-round_border">
                                        <div class="cs-table_responsive">
                                            <table class="cs-border_less">
                                                <tbody>
                                                    <tr style="text-align: center;">
                                                        <td class="cs-primary_color cs-semi_bold cs-f16">Departure</td>
                                                        <td class="cs-primary_color cs-semi_bold cs-f16">Arrival</td>
                                                        <td class="cs-primary_color cs-semi_bold cs-f16">Airline Name</td>
                                                        <td class="cs-primary_color cs-semi_bold cs-f16">Duration</td>
                                                    </tr>
                                                    @foreach($flights_details_E as $flights_details_D)
                                                        <tr style="text-align: center;">
                                                            <td class="cs-f14">{{ $flights_details_D->departure_airport_code ?? '' }} <br> ({{ $flights_details_D->departure_time ?? '' }})</td>
                                                            <td class="cs-f14">{{ $flights_details_D->arrival_airport_code ?? '' }} <br> ({{ $flights_details_D->arrival_time ?? '' }})</td>
                                                            <td class="cs-f14">{{ $flights_details_D->other_Airline_Name2 }} <br> ({{ $flights_details_D->departure_flight_number ?? '' }})</td>
                                                            <td class="cs-f14">{{ $flights_details_D->total_Time ?? '' }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                        ...
                        @if(isset($return_flights_details) && $return_flights_details != null && $return_flights_details != '')
                            <?php $return_flights_details_E = json_decode($return_flights_details); ?>
                            <div class="cs-table cs-style1">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Return Details ({{ $return_flights_details_E[0]->return_flight_route_type }})</div>
                                <div class="row">
                                <div class="col-lg-6" style="font-size: 25px;background: white;color: black;padding: 10px;">
                                    <i class="fa-solid fa-plane"></i>
                                    {{ $return_flights_details_E[0]->return_departure_airport_code ?? '' }}
                                </div>
                                
                                <div class="col-lg-6" style="font-size: 25px;background: white;color: black;padding: 10px;text-align: right;">
                                    <i class="fa-solid fa-plane"></i>
                                    {{ $return_flights_details_E[1]->return_arrival_airport_code ?? '' }}
                                </div>
                            </div>
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                @foreach($return_flights_details_E as $return_flights_details_D)
                                                    <tr style="text-align: center;">
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_departure_airport_code ?? '' }} <br> ({{ $return_flights_details_D->return_departure_time ?? '' }})</td>
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_arrival_airport_code ?? '' }} <br> ({{ $return_flights_details_D->return_arrival_time ?? '' }})</td>
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_other_Airline_Name2 ?? '' }} <br> ({{ $return_flights_details_D->return_departure_flight_number ?? '' }})</td>
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_total_Time ?? '' }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                        ...
                        @if(isset($flights_Pax_details) && $flights_Pax_details != null && $flights_Pax_details != '')
                            <?php $flights_Pax_details_E = json_decode($flights_Pax_details); //dd($flights_Pax_details_E); ?>
                            <div class="cs-table cs-style1">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Flight Costing Details</div>
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                <tr style="text-align: center;">
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Type</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Price/Seat</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Seats</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Total Price</td>
                                                </tr>
                                                @foreach($flights_Pax_details_E as $flights_Pax_details_D)
                                                    <tr style="text-align: center;">
                                                        
                                                        <td class="cs-f14">
                                                            <b>{{ $flights_Pax_details_D->flights_adult_type ?? '' }}</b><br>
                                                            <b>{{ $flights_Pax_details_D->flights_child_type ?? '' }}</b><br>
                                                            <b>{{ $flights_Pax_details_D->flights_infant_type ?? '' }}</b><br>
                                                        </td>
                                                        
                                                        <td class="cs-f14">
                                                            <b>{{ $currency }} {{ $flights_Pax_details_D->flights_sale_price_per_seat_adult ?? '' }}</b><br>
                                                            <b>{{ $currency }} {{ $flights_Pax_details_D->flights_sale_price_per_seat_child ?? '' }}</b><br>
                                                            <b>{{ $currency }} {{ $flights_Pax_details_D->flights_sale_price_per_seat_infant ?? '' }}</b><br>
                                                        </td>
                                                        
                                                        <td class="cs-f14">
                                                            <b>{{ $flights_Pax_details_D->flights_adult_seats ?? '' }}</b><br>
                                                            <b>{{ $flights_Pax_details_D->flights_child_seats ?? '' }}</b><br>
                                                            <b>{{ $flights_Pax_details_D->flights_infant_seats ?? '' }}</b><br>
                                                        </td>
                                                        
                                                        <td class="cs-f14">
                                                            <?php
                                                                $flights_sale_price_adult   = $flights_Pax_details_D->flights_sale_price_adult ?? '0';
                                                                $flights_sale_price_child   = $flights_Pax_details_D->flights_sale_price_child ?? '0';
                                                                $flights_sale_price_infant  = $flights_Pax_details_D->flights_sale_price_infant ?? '0';
                                                                $flight_total               = $flights_sale_price_adult + $flights_sale_price_child + $flights_sale_price_infant;
                                                            ?>
                                                            <b> {{ $currency }} {{ $flights_sale_price_adult ?? '' }}</b><br>
                                                            <b> {{ $currency }} {{ $flights_sale_price_child ?? '' }}</b><br>
                                                            <b> {{ $currency }} {{ $flights_sale_price_infant ?? '' }}</b><br>
                                                        </td>
                    ...
                    @else
                        @if(isset($flights_details) && $flights_details != null && $flights_details != '')
                            <?php
                                $flights_details_E  = json_decode($flights_details);
                                $arry_count         = sizeOf($flights_details_E ?? '');
                                $departure          = $flights_details_E[0]->departure_airport_code ?? '';
                                $return_departure   = $flights_details_E[$arry_count - 1]->arrival_airport_code ?? '';
                            ?>
                            
                            <div class="cs-table cs-style1 mb-5">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Departure Details ({{ $flights_details_E[0]->departure_flight_route_type }})</div>
                                    ...
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                @foreach($flights_details_E as $flights_details_D)
                                                    <?php
                                                        $departure_time = date('d-m-Y H:i',strtotime($flights_details_D->departure_time));
                                                        $arrival_time   = date('d-m-Y H:i',strtotime($flights_details_D->arrival_time));
                                                    ?>
                                                    <tr style="text-align: center;">
                                                        <td class="cs-f14">{{ $flights_details_D->departure_airport_code ?? '' }} <br> ({{ $departure_time ?? '' }})</td>
                                                        <td class="cs-f14">{{ $flights_details_D->arrival_airport_code ?? '' }} <br> ({{ $arrival_time ?? '' }})</td>
                                                        <td class="cs-f14">{{ $flights_details_D->other_Airline_Name2 }} <br> ({{ $flights_details_D->departure_flight_number ?? '' }})</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        ...
                                        <div class="cs-table_responsive">
                                            <table class="cs-border_less">
                                                <tbody>
                                                    ...
                                                    @foreach($return_flights_details_E as $return_flights_details_D)
                                                        <?php
                                                            $return_departure_time = date('d-m-Y H:i',strtotime($return_flights_details_D->return_departure_time));
                                                            $return_arrival_time   = date('d-m-Y H:i',strtotime($return_flights_details_D->return_arrival_time));
                                                        ?>
                                                        <tr style="text-align: center;">
                                                            <td class="cs-f14">{{ $return_flights_details_D->return_departure_airport_code ?? '' }} <br> ({{ $return_departure_time ?? '' }})</td>
                                                            <td class="cs-f14">{{ $return_flights_details_D->return_arrival_airport_code ?? '' }} <br> ({{ $return_arrival_time ?? '' }})</td>
                                                            <td class="cs-f14">{{ $return_flights_details_D->return_other_Airline_Name2 ?? '' }} <br> ({{ $return_flights_details_D->return_departure_flight_number ?? '' }})</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                        ...
                        @if(isset($data->transportation_details))
                            <div class="cs-table cs-style1 mb-5">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Transportation Details</div>
                                ...
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                <tr style="text-align: center;">
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Trip Type</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Drop Up</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Pick Up Date</td>
                                                    <td class="cs-primary_color cs-semi_bold cs-f16">Drop Up Date</td>
                                                </tr>
                                                @foreach($transportation_details as $transportation_details_value)
                                                    <?php // dd($transportation_details); ?>
                                                    @if($transportation_details_value->transportation_pick_up_location != null)
                                                        <tr style="text-align: center;">
                                                            <td class="cs-f14">{{ $transportation_details_value->transportation_trip_type }} <br></td>
                                                            <td class="cs-f14">{{ $transportation_details_value->transportation_pick_up_location ?? '' }}</td>
                                                            <td class="cs-f14">{{ $transportation_details_value->transportation_drop_off_location ?? '' }} <br></td>
                                                            <td class="cs-f14">
                                                                <?php
                                                                    $transportation_pick_up_date = date('d-m-Y H:i',strtotime($transportation_details_value->transportation_pick_up_date));
                                                                ?>
                                                                {{ $transportation_pick_up_date }}<br>
                                                            </td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="cs-bold cs-primary_color cs-f18">Total Amount:</td>
                                <?php
                                    ...
                                    if(isset($accomodation_detailsE) && $accomodation_detailsE != null && $accomodation_detailsE != ''){
                                        ...
                                        if(isset($accomodation_details_moreE) && $accomodation_details_moreE != 'null' && $accomodation_details_moreE != ''){
                                            ...
                                            if($accomodation_details_more != 'null'){
                                            foreach($accomodation_details_more as $accomodation_details_more1){
                                                if(isset($accomodation_details_more1->more_hotel_invoice_markup) && $accomodation_details_more1->more_hotel_invoice_markup != null && $accomodation_details_more1->more_hotel_invoice_markup != '' && $accomodation_details_more1->more_hotel_invoice_markup != 'null'){
                                ...
                                <td class="cs-bold cs-primary_color cs-f18 cs-text_right">{{ $data->currency_symbol ?? "" }} 
                                    <?php
                                        if(isset($total_Payable) && $total_Payable != null && $total_Payable != '' && $total_Payable != 0){
                    ...
                    <div class="cs-table cs-style1 d-none">
                    ...
                    <div class="cs-table cs-style1 cs-type1 d-none">
                        <div class="cs-table_responsive">
                            <table>
                                <tbody>
                    ...
                    <div class="cs-table cs-style1">
                        ...
                        <div class="cs-table_responsive">
                            ...
                            <ul>
                                <li>Account Holder Name: Al Hijaz Tours Ltd</li>
                                <li>Account Number: 13785580</li>
                                <li>Sort Code: 20-08-64</li>
                                <li>IBAN: GB30BUKB20086413785580</li>
                                <li>SWIFTBIC: BUKBGB22</li>
                            </ul>
                            <div>
                             ...
                             <img style="width:100%;" src="{{ asset('/public/admin_package/frontend/images/footer2.png') }}" alt="letterhead">
                        </div>
                    </div>
                ...
                <div class="cs-invoice_btns cs-hide_print">
                    ...
                    <a class="cs-invoice_btn cs-color1 d-none" href="{{URL::to('invoiceI')}}/{{$data->generate_id}}">
                        View Voucher
                    </a>
