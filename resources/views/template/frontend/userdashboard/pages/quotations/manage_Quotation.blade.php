        ...
        <div class="row">
          <div class="col-lg-12 col-6">
            <nav class="breadcrumb push">
              ...
              <span class="breadcrumb-item active">Manage Quotation</span>
            </nav>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12 col-6">
            ...
            <form action="{{URL::to('add_Manage_Quotation')}}" method="POST" id="quatation" class="js-wizard-validation-material-form" novalidate="novalidate">
              @csrf
              <div class="block-content block-content-full tab-content" style="min-height: 274px;background-color: white;">
                  ...
                  <div class="row" style="padding: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="f_name" class="form-control valid" type="text" id="fname" required="" aria-describedby="fname-error" aria-invalid="false">
                      </div>
                      @error('f_name')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="middle_name" class="form-control valid" type="text" id="middle-name" aria-describedby="middle-name-error" aria-invalid="false">
                      </div>
                      @error('middle_name')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="surname" class="form-control valid" type="text" id="surname"  required="" aria-describedby="surname-error" aria-invalid="false">
                      </div>
                      @error('surname')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="email" class="form-control valid" type="email" id="customer-email" required="" aria-describedby="customer-email-error" aria-invalid="false">
                      </div>
                      @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input name="contact_landline" type="text" class="js-masked-phone form-control js-masked-enabled valid" id="landline"  autocomplete="off" aria-describedby="landline-error" aria-invalid="false">
                      </div>
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input name="mobile" type="text" class="js-masked-phone form-control js-masked-enabled valid" id="mobile" autocomplete="off" aria-describedby="mobile-error" aria-invalid="false">
                      </div>
                      @error('mobile')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="contact_work" type="text" class="js-masked-phone form-control js-masked-enabled valid" id="example-masked2-phone" autocomplete="off" aria-describedby="example-masked2-phone-error" aria-invalid="false">
                      </div>
                      @error('contact_work')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <input name="postCode" class="form-control valid" type="text" id="pcode" required="" aria-describedby="pcode-error" aria-invalid="false">
                      </div>
                      @error('postCode')
                        <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <select onchange="selectCities()" name="country" class="form-control valid" id="property_country" required="" aria-describedby="country-error" aria-invalid="false">
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating open">
                        ...
                        <select name="city" class="form-control valid" id="property_city" required="" aria-describedby="city-error" aria-invalid="false"><option></option>
                    ...
                    <div class="form-group col-sm-6">
                      <div class="form-material">
                        ...
                        <textarea name="primery_address" class="form-control valid" id="primery-address" placeholder="Enter Primery Address" rows="3" autocomplete="off" aria-describedby="primery-address-error" aria-invalid="false"></textarea>
                      </div>
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating open">
                        ...
                        <input name="quotation_prepared" class="form-control valid" type="text" id="quotation-prepared" autocomplete="off" aria-describedby="quotation-prepared-error" aria-invalid="false">
                      </div>
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material">
                        ...
                        <input name="quotation_valid_date" type="date" class="js-datepicker form-control js-datepicker-enabled valid" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off" aria-describedby="example-datepicker6-error" aria-invalid="false">
                      </div>
                  ...
                  <div class="row" style="padding: 10px;">
                    ...
                    <div class="block">
                      <div class="block-content block-content-full">
                        ...
                        class="btn btn-square btn-outline-info min-width-125 mb-10"  data-target="#modal-popout">Add More Details</button>
                      </div>
                    </div>
                    <!-- END Pop Out Modal -->
                  </div>
                ...
                <div class="tab-pane" id="wizard-step3" role="tabpanel" style="padding: 10px;">
                  ...
                  <div id="checkbox_div" style="margin-left:1rem;">
                    <input checked class="form-check-input" type="radio" name="flight_return_type" id="one_way" value="One Way">
                    <label class="form-check-label mr-4" for="one_way">
                      One Way
                    </label>
                    <input class="form-check-input" type="radio" name="flight_return_type" id="round_trip" value="Round Trip">
                    <label class="form-check-label mr-4" for="round_trip">
                      Round Trip
                    </label>
                    <input class="form-check-input" type="radio" name="flight_return_type" id="multiCity" value="multiCity">
                    <label class="form-check-label mr-4" for="multiCity">
                      Multi City
                    </label>
                  </div>
                    ...
                    <div class="form-group col-sm-2">                                    
                      <div class="form-material floating">
                        <div class="flight">
                          ...
                          <input type="text" required="" name="departure[]" class="form-control get_flight_name" autocomplete="off" id="search-box" data-suggestion="suggesstion-box" placeholder="Departure..">
                    ...
                    <div class="form-group col-sm-2">                                    
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input name="deprturedate[]" type="date" required="" id="dep_date" class="js-datepicker form-control js-datepicker-enabled" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                          </div>
                        </div>
                    </div>                       
                    <div class="form-group col-sm-2">                                    
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input name="deprturetime[]" type="time" id="dep_time" required="" class="form-control" placeholder="Airline">
                          </div>
                        </div>
                    </div>                       
                    <div class="form-group col-sm-2">                                    
                        <div class="form-material floating">
                          <div class="flight3">
                            ...
                            <input name="arrival[]" type="text" required="" class="form-control get_flight_name" autocomplete="off" id="search-box2" data-suggestion="suggesstion-box2" placeholder="Arrival">
                    ...
                    <div class="form-group col-sm-2">                                    
                      <div class="form-material floating">
                        <div class="flight1">
                          ...
                          <input name="ArrivalDate[]" type="date" required="" id="arr_Date" class="js-datepicker form-control js-datepicker-enabled" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                        </div>
                      </div>
                    </div>                       
                    <div class="form-group col-sm-2">                                    
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input name="ArrivalTime[]" type="time" required="" id="arrival_time" class="form-control" placeholder="Airline">
                          </div>
                        </div>
                    </div>                       
                    <div class="form-group col-sm-4">                                    
                      <div class="form-material floating">
                        <div class="flight1">
                          ...
                          <input name="airline_name[]" type="text" required="" class="form-control" autocomplete="off" id="ariline" placeholder="Airline">
                        </div>
                      </div>
                    </div>
                  </div>

                  <div class="row" id="round_way_div" style="display:none">
                      ...
                      <div class="form-group col-sm-2"> 
                        <div class="form-material floating">
                          <div class="flight">
                            ...
                            <input type="text" name="departure_return[]" class="form-control get_flight_name" autocomplete="off" id="search-box_return" data-suggestion="suggesstion-box_return" placeholder="Departure..">
                      ...
                      <div class="form-group col-sm-2">                                                        
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input name="deprturedate_return[]" type="date" id="dep_date_return" class="js-datepicker form-control js-datepicker-enabled" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                          </div>
                        </div>
                      </div>                        
                      <div class="form-group col-sm-2">                                                          
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input type="time" id="dep_time_return" class="form-control" name="deprturetime_return[]" placeholder="Airline">                    
                          </div>
                        </div>
                      </div>                          
                      <div class="form-group col-sm-2">                                                          
                        <div class="form-material floating">
                          <div class="flight3">
                            ...
                            <input type="text" name="arrival_return[]" class="form-control get_flight_name" autocomplete="off" id="search-box_return2" data-suggestion="suggesstion-box_return2" placeholder="Arrival">                      
                      ...
                      <div class="form-group col-sm-2">                                                          
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input name="ArrivalDate_return[]" type="date" id="arr_Date_return" class="js-datepicker form-control js-datepicker-enabled"  data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">                      
                          </div>
                        </div>
                      </div>                          
                      <div class="form-group col-sm-2">                                                        
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input type="time" id="arrival_time_return" class="form-control" name="ArrivalTime_return[]" placeholder="Airline">                      
                          </div>
                        </div>
                      </div>                          
                      <div class="form-group col-sm-4">                                                          
                        <div class="form-material floating">
                          <div class="flight1">
                            ...
                            <input type="text" class="form-control" name="airline_name_return[]" autocomplete="off" id="ariline_return" placeholder="Airline">                      
                          </div>
                        </div>
                      </div>
                  </div> 
                    ...
                    <div class="form-group col-sm-2">                                    
                      <div class="form-material floating">
                       <div class="flight1">
                        ...
                        <input name="f_date" type="text" id="date_f" class="js-datepicker form-control js-datepicker-enabled" autocomplete="off" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="mm/dd/yy" placeholder="mm/dd/yy">
                      </div>
                    </div>
                  </div>                        
                  <div class="form-group col-sm-2">                                    
                          ...
                          <div class="form-material floating">
                               <div class="flight1">
                                 <label for="flighttype">Type</label>
                                  <select class="form-control flighttype" required="" id="flighttype" name="flighttype">
                          ...
                          <div class="form-material floating">
                               <div class="flight1">
                                 <label for="flight_price">Price</label>
                                  <input value="" type="text" class="form-control input" id="flight_price" required="" name="flight_price" placeholder="Price">
                ...
                <div class="tab-pane" id="wizard-step4" role="tabpanel">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input name="dateinmakkah" type="date" class="js-datepicker mt-4 form-control datein js-datepicker-enabled" id="dateInMakkah" required="" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                      </div>
                    </div>                        
                    <div class="form-group col-sm-4">
                        <div class="form-material floating">
                          <label for="dateOutMakkah"> Date Out</label>
                          <input name="dateoutmakkah" type="date" class="js-datepicker mt-4 form-control dateout js-datepicker-enabled" id="dateOutMakkah" required="" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                        </div>
                    </div>                        
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input type="number" class="form-control mt-4" required="" id="no_of_rooms_makkah" name="no_of_rooms_makkah" value="" placeholder="No Of Rooms Makkah">
                      </div>
                    </div>
                    <div class="form-group col-sm-4 NONmakkah" style="display: none;">
                      <div class="form-material floating">
                        <label for="no_Of_Nights_Makkah">No of Nights Makkah</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="no_Of_Nights_Makkah" name="no_Of_Nights_Makkah" value="" placeholder="No Of Nights Makkah">
                      </div>
                    </div>                         
                    <div class="form-group col-sm-4 PPNmakkah" style="display: none;">
                      <div class="form-material floating">
                        <label for="price_per_night_makkah"> Price Per Nights Makkah</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="price_per_night_makkah" name="Price_Per_Nights_Makkah" value="" placeholder="Price Per Nights Makkah">
                      </div>
                    </div>
                    <div class="form-group col-sm-4 MakkahTPNights" style="display: none;">
                      <div class="form-material floating">
                        <label for="Makkah_total_price_night_cal">Makkah Total Price Nights</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="Makkah_total_price_night_cal" name="Makkah_total_price_night_cal" value="" placeholder="Makkah Total Price Nights">                      </div>
                    </div>

                    <div class="form-group col-sm-4 MakkahTP" style="display: none;">
                      <div class="form-material floating">
                        <label for="Makkah_total_price_cal"> Makkah Total Price</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="Makkah_total_price_cal" name="Makkah_total_price_cal" value="" placeholder="Makkah Total Price">                      </div>
                    </div>
                  </div>
                  ...
                  <div class="block loaderaddhere mload">
                    <span id="makres"></span> 
                  </div>
                </div>
                <!-- END STEP-4 -->
                  ...
                  <div class="row" style="padding: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-material floating">
                          ...
                          <input name="dateinmadinah" type="date" 
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input type="date" name="dateoutmadinah" id="dateoutmadinah" class="js-datepicker mt-4 form-control dateout js-datepicker-enabled" required="" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off">
                      </div>
                    </div> 
                    ...
                    <div class="form-group col-sm-4">
                      <div class="form-material floating">
                        ...
                        <input type="number" class="form-control mt-4" required="" id="no_of_rooms_madina" name="no_of_rooms_madina" value="" placeholder="No Of Rooms Madinah">
                      </div>
                    </div>

                    <div class="form-group col-sm-4 NONmadinah" style="display: none;">
                      <div class="form-material floating">
                        <label for="no_Of_Nights_Madinah">No of Nights Madinah</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="no_Of_Nights_Madinah" name="no_Of_Nights_Madinah" value="" placeholder="No Of Nights Madinah">
                      </div>
                    </div>                         
                    <div class="form-group col-sm-4 PPNmadinah" style="display: none;">
                      <div class="form-material floating">
                        <label for="price_per_night_madinah"> Price Per Nights Madinah</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="price_per_night_madinah" name="price_per_night_madinah" value="" placeholder="Price Per Madinah Makkah">
                      </div>
                    </div>
                    <div class="form-group col-sm-4 madinahTPNights" style="display: none;">
                      <div class="form-material floating">
                        <label for="Madinah_total_price_night_cal">Madinah Total Price Nights</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="Madinah_total_price_night_cal" name="Madinah_total_price_night_cal" value="" placeholder="Madinah Total Price Nights">                      </div>
                    </div>

                    <div class="form-group col-sm-4 MadinahTP" style="display: none;">
                      <div class="form-material floating">
                        <label for="Madinah_total_price_cal"> Madinah Total Price</label>
                        <input readonly type="text" class="form-control mt-4" required="" id="Madinah_total_price_cal" name="madinah_total_price_cal" value="" placeholder="Madinah Total Price">                      </div>
                    </div>
                  ...
                  <div class="row" style="padding: 10px;">
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating">
                        ...
                        <input type="date" name="pickuplocat" id="piclocation" required="" class="form-control mt-4 input-group" value="">
                      </div>
                    </div>
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating">
                        ...
                        <input type="date" name="dropoflocat" id="drop_location" required="" class="form-control mt-4" value="">
                      </div>
                    </div>
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating open">
                        ...
                        <select class="dest_type form-control mt-4" id="ret_type" name="dest_t">
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating open">              
                        ...
                        <select class="passengers form-control mt-4" onchange="doWork_transfers()" required="" id="trans_passenger" name="passenger">
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating open">   
                        ...
                        <select class="passengers form-control mt-4" id="trans_vehicle" required="" name="transfer_vehicle">
                    ...
                    <div class="form-group col-sm-3">
                      <div class="form-material floating">    
                        ...
                        <input type="text" name="transf_price" required="" id="transfers_price" class="form-control mt-4" value="">
                      </div>
                    </div>
                              
                    <div class="form-group col-sm-3 mt-3">
                      <label for="transfers_price">Total</label>
                      <input type="text" name="transfers_head_total" required="" id="transfers_head_total" class="form-control mt-2" value="">
                    </div>
                ...
                <div class="tab-pane" id="wizard-step7" role="tabpanel">
                  <div class="row" style="padding: 10px;">
                    <div class="form-group col-sm-3">
                      <div class="form-material floating visa_fees_adult" style="display: none;">
                        <label for="visa_fees_adult"> Adult Visa Price </label>
                        <input class="form-control mt-4" type="text" id="visa_fees_adult" name="visa_fees_adult" required="" placeholder="visa price" value="">
                      </div>
                    </div>

                    <div class="form-group col-sm-3">
                      <div class="form-material floating visa_fees_child" style="display: none;">
                        <label for="visa_fees_child"> Child Visa Price </label>
                        <input class="form-control mt-4" type="text" id="visa_fees_child" name="visa_fees_child" required="" placeholder="visa price">
                      </div>
                    </div>
                                  
                    <div class="form-group col-sm-3" id="childs_visa">
                      <div class="form-material floating visa_fees_price" style="display: none;">
                        <label for="visa_fees_price"> Visa Fee Total </label>
                        <input readonly value="" class="form-control mt-4" type="text" id="visa_fees_price" name="visa_fees_price" required="" placeholder="visa price">
                        <input readonly value="" class="form-control" type="text" id="grand_total_price" name="grand_total_price" placeholder="grand_price">
                      </div>
                    </div>
                  </div>
                </div>
    ...
    $(document).ready(function(){
        ...
        $('#dateOutMakkah').on('change',function(){
          ...
          $.ajax({
            ...
            success:function(data) {
              ...
              $("#Makkah_hotel_name").append('<option>Select</option>');
              var result = [];
              $.each(a, function (i, e) {
        ...
        $('#dateoutmadinah').on('change',function(){
          ...
          $.ajax({
            ...
            success:function(data) {
              ...
              $("#Madinah_hotel_name").append('<option>Select</option>');
              var result = [];
              $.each(a, function (i, e) {
                  var matchingItems = $.grep(result, function (item) {
                     return item.property_name === e.property_name && item.id === e.id;
      ...
      // ON 3rd
        $('#one_way').on('click',function(){
          $('#round_way_div').css('display','none');
          $('#multicity_div').css('display','none');
        });

        $('#round_trip').on('click',function(){
          $('#round_way_div').css('display','');
          $('#multicity_div').css('display','none');
          $('#return_heading').css('display','');
          $('#multi_heading').css('display','none');
        });

        $('#multiCity').on('click',function(){
          $('#round_way_div').css('display','');
          $('#return_heading').css('display','none');
          $('#multi_heading').css('display','');
          $('#multicity_div').css('display','');
        });

        $("#multicity_div").click(function(){
          ...
          if(total_element < max ){
            $(".element1:last").after("<div class='element1' id='div1_"+ nextindex +"'></div>");
            $("#div1_" + nextindex).append('<div class="row"><div class="form-group col-sm-11"><hr><h5>Flight Multi city Details</h5></div><div class="form-group col-sm-1"><button id="remove_' + nextindex + '" type="button" class="btn btn-danger mt-4 remove">X</button></div><div class="form-group col-sm-2"> <div class="form-material floating"><div class="flight"><label for="search-box_return">Departure</label><input type="text" name="departure_return[]" class="form-control get_flight_name" autocomplete="off" id="search-box_return" data-suggestion="suggesstion-box_return" placeholder="Departure.."><div id="suggesstion-box_return"></div><input class="departure shrtcode" type="hidden"></div></div></div><div class="form-group col-sm-2"><div class="form-material floating"><div class="flight1"><label for="dep_date_return">Departure Date</label><input type="date" id="dep_date_return" class="js-datepicker form-control js-datepicker-enabled" name="deprturedate_return[]" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off"></div></div></div><div class="form-group col-sm-2"><div class="form-material floating"><div class="flight1"><label for="dep_time_return">Departure Time</label><input type="time" id="dep_time_return" class="form-control" name="deprturetime_return[]" placeholder="Airline"></div></div></div><div class="form-group col-sm-2"><div class="form-material floating"><div class="flight3"><label for="search-box_return2">Arrival</label><input type="text" name="arrival_return[]" class="form-control get_flight_name" autocomplete="off" id="search-box_return2" data-suggestion="suggesstion-box_return2" placeholder="Arrival"><div id="suggesstion-box_return2"></div><input class="arrival shrtcode" type="hidden"></div></div></div><div class="form-group col-sm-2"><div class="form-material floating"><div class="flight1"><label for="arr_Date_return">Arrival Date</label><input name="ArrivalDate_return[]" type="date" id="arr_Date_return" class="js-datepicker form-control js-datepicker-enabled"  data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" autocomplete="off"></div></div></div><div class="form-group col-sm-2"><div class="form-material floating"><div class="flight1"><label for="arrival_time_return">Arrival Time</label><input type="time" id="arrival_time_return" class="form-control" name="ArrivalTime_return[]" placeholder="Airline"></div></div></div><div class="form-group col-sm-4"><div class="form-material floating"><div class="flight1"><label for="ariline_return">Airline</label><input type="text" class="form-control" name="airline_name_return[]" autocomplete="off" id="ariline_return" placeholder="Airline"></div></div></div></div>');
          }

        });
        
        $('.add_multiCity').on('click','.remove',function(){
          var id = this.id;
