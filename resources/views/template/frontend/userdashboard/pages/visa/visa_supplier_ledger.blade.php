              ...
              <div class="row">
                  <div class="col-12">
                      <div class="page-title-box">
                        ...
                        <h4 class="page-title">Visa Supplier Ledger</h4>
                        <div style="display: flex;justify-content: space-between;">
                            <h6 class="" style="font-size: 1rem;">Supplier Name: {{ $supplier_Pers_details->visa_supplier_name }}</h6>
                        </div>
                      </div>
                  </div>
              </div>
                                    ...
                                    <thead class="theme-bg-clr">
                                        ...
                                        <tbody style="text-align: center;" id="tbody_all_data_acc">
                                                        <tr role="row">
                                                            ...
                                                            <td>{{ $currency }} {{ $supplier_Pers_details->opening_payable }}</td>
                                                            <td></td>
                                                        </tr>
                                                                    ...
                                                                    <?php 
                                                                                if(isset($value->deposit_id)){
                                                                                 ...
                                                                                 if(isset($value->package_invoice_no)){
                                                                                    ...
                                                                                    echo "Package Invoice $remarks "."<br>";
                                                                                     ?>
                                                                                    <a href="{{ URL::to('invoice/'.$value->package_invoice_no.'') }}" target="blank"><?php echo "Invoice No :".$value->package_invoice_no; ?>
                                                                                        <img height="15px" width="15px" src="{{ asset('public/invoice_icon.png') }}">
                                                                                    </a>
                                                                                ...
                                                                                if(isset($value->website_booking_id)){
                                                                                    echo "Website Booking";
                                                                                    ?>
                                                                                    <br><a href="#" target="blank"><?php echo "Booking No :".$value->website_booking_id; ?>
                                                                                        <img height="15px" width="15px" src="{{ asset('public/invoice_icon.png') }}">
                                                                                    </a>
                                                                                    <?php
                                                                                }
