...
// dd($visa_supplier_availability);
?>
<div class="card mt-5">
    <div class="card-body">
        <h4 class="header-title">Add Visa Supplier</h4>
        <form action="{{URL::to('update_visa_type_against_id')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
                <div class="row">
                ...
                @endif
                    ...
                    <div class="col-xl-4">
                        <div class="mb-3">
                            ...
                            <input type="date" name="availability_from"  class="form-control " id="" value="{{$visa_supplier_availability->availability_from ?? ""}}" required>
                            <input type="hidden" name="visa_availability_id"  class="form-control"  value="{{$visa_supplier_availability->visa_id ?? ""}}" required>
                    ...
                    <div class="col-xl-4">
                        <div class="mb-3">
                            ...
                            <input type="date" name="availability_to"  class="form-control " id="" value="{{$visa_supplier_availability->availability_to ?? ""}}" required>
                    ...
                    <div class="col-xl-4" style="padding-left: 24px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{$visa_supplier_availability->visa_price_conversion_rate ?? ""}}" name="visa_price_conversion_rate"  class="form-control " onchange="selectCurrencyrate()" id="exchange_pricez" required>
                                    </div>
                                </div>
                     <div class="col-xl-4" style="padding-left: 24px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="visa_price" value="{{$visa_supplier_availability->visa_price ?? ""}}"  class="form-control " onchange="selectCurrencyrate()" id="visa_pricez" required>
                                    </div>
                                </div>
                                <div class="col-xl-4" style="padding-left: 24px;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="visa_converted_price" value="{{$visa_supplier_availability->visa_converted_price ?? ""}}"  class="form-control " onchange="selectCurrencyrate()" id="converted_pricez" required>
                                    </div>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="visa_qty" name="visa_qty" value="{{$visa_supplier_availability->visa_qty ?? ""}}"  class="form-control " id="" required>
