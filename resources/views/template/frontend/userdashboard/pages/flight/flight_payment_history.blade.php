...
@extends('template/frontend/userdashboard/layout/default')
 ...
 <div id="bs-example-modal-lg_approve" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="{{URL::to('super_admin/flight/payment/approved')}}" method="post" class="modal-body p-4">
                @csrf
 ...
 <div id="bs-example-modal-lg_decline" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form action="{{URL::to('super_admin/flight/payment/declined')}}" method="post" class="modal-body p-4">
                @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Hotel Payment History</h4>
                                                ...
                                                <table id="example_2" class="table dt-responsive nowrap w-100">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        if(isset($flight_payment_details))
                                                        {
                                                            foreach($flight_payment_details as $payment_history)
                                                            {
                                                                
                                                            $client = DB::table('customer_subcriptions')->where('Auth_key',$payment_history->auth_token)->first();
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td>
                                                             {{$client->currency_symbol}} {{$payment_history->payment_received_amount ?? ''}}
