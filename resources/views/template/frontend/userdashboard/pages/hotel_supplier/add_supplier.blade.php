...
<div class="card mt-5">
    <div class="card-body">
        ...
        <form action="{{URL::to('submit_hotel_suppliers')}}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
                <div class="row">
                    ...
                    <div class="col-xl-6">
                     ...
                     <div class="col-xl-6">
                        <div class="mb-3">
                            <div id="tooltip-container">
                                <label for="simpleinput" class="form-label no_of_pax_days">Opening Total Balance</label>
                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon"
                                    data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="right" title="No Of Pax for this package">
                                </i>
                            </div>
                          
                            <input type="number" step=".01" name="opening_balance"  class="form-control " id="" required>
                     ...
                     <div class="col-xl-6">
                        <div class="mb-3">
                            <div id="tooltip-container">
                                <label for="simpleinput" class="form-label no_of_pax_days">Opening Payable Balance</label>
                                <i class="dripicons-information" style="font-size: 17px;" id="title_Icon"
                                    data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="right" title="No Of Pax for this package">
                                </i>
                            </div>
                          
                            <input type="number" step=".01" name="payable_balance"  class="form-control " id="" required>
