              ...
              <div class="row">
                  <div class="col-12">
                      <div class="page-title-box">
                        ...
                        <h4 class="page-title">Flight Supplier Ledger</h4>
                        <div style="display: flex;justify-content: space-between;">
                            <h6 class="" style="font-size: 1rem;">Supplier Name: {{ $supplier_Pers_details->contactpersonname }}</h6>
                        </div>
                      </div>
                  </div>
              </div>
                                                                    ...
                                                                    <?php 
                                                                                if(isset($value->deposit_id)){
                                                                                 ...
                                                                                 if(isset($value->package_invoice_no)){
                                                                                     $remarks = '- New';
                                                                                     if($value->remarks == 'Package Invoice Updated'){
                                                                                         $remarks = '- Update';
                                                                                     }
