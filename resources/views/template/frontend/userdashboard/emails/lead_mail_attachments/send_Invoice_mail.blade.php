    ...
    <body>
        <div class="cs-container">
            <div class="cs-invoice cs-style1">
                <div class="cs-invoice_in" id="download_section">
                    ...
                    <div class="cs-invoice_head cs-mb10">
                        <div class="cs-invoice_left">
                            <p style="color: #cead65;font-size: 30px; text-transform: uppercase;margin-top: 17px;">
                                <b class="cs-invoice_number cs-mb0">Invoice No:</b><b style="color: #000;"> {{  $data->generate_id ?? '' }} </b>
                                </p>
                                <p>
                                ...
                                @if(isset($service_select) && $service_select != null && $service_select != '')
                                    @if($service_select[0] != 'flights_tab' && $service_select[0] != 'transportation_tab')
                                        <b class="cs-primary_color"> Duration : {{ $data->time_duration ?? '' }} Nights</b> <br>
                                    @endif
                                @endif
                        ...
                        <div class="cs-invoice_right cs-text_right">
                             ...
                             <b style="margin-top:25px; display: block;"></b>
                               <b class="cs-primary_color"> Agent Name:  {{ $data->agent_Name ?? '' }}</b> <br>
                            @endif
                            ...
                            @if($service_select[0] == '1' || $service_select[0] == 'accomodation_tab')
                                <div class="cs-invoice_right">
                                    ...
                                    <ul class="cs-bar_list">
                                        <li>
                                            <b class="cs-primary_color"><img style="border: 0;max-width: 3%;height: auto;vertical-align: middle;" src="{{ asset('/public/invoice/assets/img/plane-departure-solid.svg') }}" alt="Logo"> </b>
                                            <?php
                    ...
                    <div class="cs-invoice_head cs-50_col cs-mb25">
                        ...
                        <?php $accomodation_details = json_decode($accomodation_details); ?>
                            <div class="cs-invoice_left">
                    ...
                    @if(isset($service_select) && $service_select != null && $service_select != '')
                        ...
                        @elseif($service_select[0] == 'transportation_tab')  
                            ...
                            <div class="cs-table cs-style1">
                                <div class="cs-round_border">
                                    <div class="t-heading-top"><i class="fa-solid fa-passport"></i> Destination Details</div>
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                <tr style="border: 2px solid #000000; text-align:center;">
                                            ...
                                            @foreach($accomodation_details as $accomodation_details)
                                                <tr>
                                                    ...
                                                    <td class="cs-f14">
                                                        ...
                                                        <img style="border: 0;max-width: 4%;height: auto;vertical-align: middle;" src="{{ asset('/public/invoice/assets/img/calendar-check-solid.svg') }}" alt="Logo">
                                                        <?php
                    ...
                    @if($service_select[0] == 'flights_tab')
                        <?php 
                        ...
                        @if(isset($flights_details) && $flights_details != null && $flights_details != '')
                            <?php $flights_details_E = json_decode($flights_details);?>
                            <div class="row">
                                ...
                                <div class="col-lg-6" style="font-size: 25px;background: white;color: black;padding: 10px;text-align: right;">
                                    <i class="fa-solid fa-plane"></i>
                                    {{ $flights_details_E[0]->arrival_airport_code ?? '' }}
                                </div>
                            </div>
                            
                            <div class="cs-table cs-style1">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Departure Details</div>
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                @foreach($flights_details_E as $flights_details_D)
                                                    <tr style="text-align: center;">
                                                        <td class="cs-f14">{{ $flights_details_D->departure_flight_route_type ?? '' }}</td>
                                                        <td class="cs-f14">{{ $flights_details_D->departure_airport_code ?? '' }}</td>
                                                        <td class="cs-f14">{{ $flights_details_D->arrival_airport_code ?? '' }}</td>
                                                        <td class="cs-f14">{{ $flights_details_D->other_Airline_Name2 }}</td>
                        ...
                        @if(isset($return_flights_details) && $return_flights_details != null && $return_flights_details != '')
                            ...
                            <div class="cs-table cs-style1">
                                <div class="t-heading-top"><i class="fa-solid fa-plane"></i> Return Details</div>
                                <div class="cs-round_border">
                                    <div class="cs-table_responsive">
                                        <table class="cs-border_less">
                                            <tbody>
                                                ...
                                                @foreach($return_flights_details_E as $return_flights_details_D)
                                                    <tr style="text-align: center;">
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_flight_route_type ?? '' }}</td>
                                                        
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_departure_airport_code ?? '' }}</td>
                                                        
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_arrival_airport_code ?? '' }}</td>
                                                        
                                                        <td class="cs-f14">{{ $return_flights_details_D->return_other_Airline_Name2 ?? '' }}</td>
            ...
            <div class="cs-invoice_btns cs-hide_print">
                <a href="javascript:window.print()" class="cs-invoice_btn cs-color1 d-none">
