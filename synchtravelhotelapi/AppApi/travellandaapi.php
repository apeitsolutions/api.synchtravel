                                ...
                                <Room>
                                    ...
                                    <PaxNames>";
                                        ...
                                        for($adult = 0; $adult < $rooms_data->adults; $adult++){
                                                if($index_counter == 0){
                                                    $title = $request_data->lead_passenger_data->lead_title;
                                                    $name = $request_data->lead_passenger_data->lead_first_name;
                                                    $surname = $request_data->lead_passenger_data->lead_last_name;
                                                }else{
                                                    if(isset($request_data->other_passenger_data[$index_counter]->other_title) && !empty($request_data->other_passenger_data[$index_counter]->other_title)){
                                                        $title = $request_data->other_passenger_data[$index_counter]->other_title;
                                                        $name = $request_data->other_passenger_data[$index_counter]->other_first_name;
                                                        $surname =$request_data->other_passenger_data[$index_counter]->other_last_name;
                                                        $index_counter++;
                                                    }else{
                                                        $title = $request_data->lead_passenger_data->lead_title;
                                                        $name = $request_data->lead_passenger_data->lead_first_name;
