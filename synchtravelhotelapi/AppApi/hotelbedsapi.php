...
if($case =='get_view_reservation'){
get_view_reservation();
}
    ...
    if(isset($hotel_data->rooms_list)){
        ...
        foreach($hotel_data->rooms_list as $index => $room_res){
            ...
            for($adult = 0; $adult < $total_adults; $adult++){
                ...
                if($index_counter == 0){
                    $name = $request_data->lead_passenger_data->lead_first_name;
                    $surname = $request_data->lead_passenger_data->lead_last_name;
                }else{
                    if(isset($request_data->other_passenger_data[$index_counter - 1]->other_first_name) && !empty($request_data->other_passenger_data[$index_counter - 1]->other_first_name)){
                        $name = $request_data->other_passenger_data[$index_counter - 1]->other_first_name;
                        $surname =$request_data->other_passenger_data[$index_counter -1]->other_last_name;
                    }else{
                        $name = $request_data->lead_passenger_data->lead_first_name;
                        $surname = $request_data->lead_passenger_data->lead_last_name;
                    }
...
function get_view_reservation(){
    ...
    $signature = pr($refrence_id);
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://api.test.hotelbeds.com/hotel-api/1.0/bookings/'.$bookingId,
