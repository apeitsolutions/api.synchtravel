<?php
    ...
    function serach_hotelbeds(){
        ...
        $data               = array(
            'platform'      => "207",
            'stay'          => array('checkIn'=>$newstart,'checkOut'=>$newend),
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://api.hotelbeds.com/hotel-api/1.0/checkrates',
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => '',
      CURLOPT_MAXREDIRS => 1,
      CURLOPT_TIMEOUT => 0,
    ...
    function hotel_details(){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://api.hotelbeds.com/hotel-content-api/1.0/hotels/'.$hotel_beds_code.'/details?language=ENG&useSecondaryLanguage=False',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 1,
          CURLOPT_TIMEOUT => 0,
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://api.hotelbeds.com/hotel-api/1.0/bookings',
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => '',
      CURLOPT_MAXREDIRS => 1,
      CURLOPT_TIMEOUT => 0,
    ...
    function cancellation_booking(){
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://api.hotelbeds.com/hotel-api/1.0/bookings/'.$refrence_id.'?cancellationFlag=CANCELLATION',
