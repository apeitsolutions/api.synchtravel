...
class ActivityController_Admin extends Controller
{
    ...
    public function view_activities_new_Admin(Request $request){
        $activities = DB::table('new_activites')->select('id','title','sale_price','child_sale_price','duration','featured_image','banner_image','location','activity_content','activity_date','currency_symbol','min_people','max_people','Availibilty','activity_content','package_author','starts_rating','customer_id')->orderBy('created_at', 'desc')->get();
        $all_Users  = DB::table('customer_subcriptions')->get();
        return view('template/frontend/userdashboard/pages/activities_packages/view_activities_new',compact(['all_Users','activities']));
    }
    
    public function view_ternary_bookings_Activity_Admin(){
        ...
        $all_Users  = DB::table('customer_subcriptions')->get();
        return view('template/frontend/userdashboard/pages/tour/view_ternary_bookings_Activity',compact('all_Users','data'));
    }
