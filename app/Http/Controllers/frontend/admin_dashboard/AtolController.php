...
/*
|--------------------------------------------------------------------------
| AtolController Function Started
|--------------------------------------------------------------------------
*/
...
|--------------------------------------------------------------------------
| In this Function, we coded the logic to Display All Atol List for our client.
*/
...
*/
public function atol_Report(Request $req){
        $customer_id            = $req->customer_id;
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)->whereJsonContains('services',['flights_tab'])->get();
        $atol_detail            = DB::table('addAtol')->where('customer_id',$req->customer_id)->get();
        $addAtolFlightPackage   = DB::table('addAtolFlightPackage')->where('customer_id',$req->customer_id)->first();
        ...
        if(isset($cart_details) && $cart_details != null && $cart_details != ''){
            foreach($cart_details as $value){
                ...
                if(isset($cart_total_data_E) && $cart_total_data_E != null && $cart_total_data_E != ''){
                    ...
                    // Adult
                    if(isset($cart_total_data->double_adults) && $cart_total_data->double_adults != null && $cart_total_data->double_adults != '' && $cart_total_data->double_adults != 'null'){
                        $double_adults = $cart_total_data->double_adults;
                    }else{
                        $double_adults = 0;
                    }
                    
                    if(isset($cart_total_data->triple_adults) && $cart_total_data->triple_adults != null && $cart_total_data->triple_adults != '' && $cart_total_data->triple_adults != 'null'){
                        $triple_adults = $cart_total_data->triple_adults;
                    }else{
                        $triple_adults = 0;
                    }
                    
                    if(isset($cart_total_data->quad_adults) && $cart_total_data->quad_adults != null && $cart_total_data->quad_adults != '' && $cart_total_data->quad_adults != 'null'){
                        $quad_adults = $cart_total_data->quad_adults;
                    }else{
                        $quad_adults = 0;
                    }
                    
                    if(isset($cart_total_data->without_acc_adults) && $cart_total_data->without_acc_adults != null && $cart_total_data->without_acc_adults != '' && $cart_total_data->without_acc_adults != 'null'){
                        $without_acc_adults = $cart_total_data->without_acc_adults;
                    }else{
                        $without_acc_adults = 0;
                    }
                    $total_adults  = $double_adults + $triple_adults + $quad_adults + $without_acc_adults;
                    
                    // Child
                    if(isset($cart_total_data->double_childs) && $cart_total_data->double_childs != null && $cart_total_data->double_childs != '' && $cart_total_data->double_childs != 'null'){
                        $double_childs = $cart_total_data->double_childs;
                    }else{
                        $double_childs = 0;
                    }
                    
                    if(isset($cart_total_data->triple_childs) && $cart_total_data->triple_childs != null && $cart_total_data->triple_childs != '' && $cart_total_data->triple_childs != 'null'){
                        $triple_childs = $cart_total_data->triple_childs;
                    }else{
                        $triple_childs = 0;
                    }
                    
                    if(isset($cart_total_data->quad_childs) && $cart_total_data->quad_childs != null && $cart_total_data->quad_childs != '' && $cart_total_data->quad_childs != 'null'){
                        $quad_childs = $cart_total_data->quad_childs;
                    }else{
                        $quad_childs = 0;
                    }
                    $total_childs  = $double_childs + $triple_childs + $quad_childs;
                    
                    // Infant
                    if(isset($cart_total_data->double_infant) && $cart_total_data->double_infant != null && $cart_total_data->double_infant != '' && $cart_total_data->double_infant != 'null'){
                        $double_infant = $cart_total_data->double_infant;
                    }else{
                        $double_infant = 0;
                    }
                    
                    if(isset($cart_total_data->triple_infant) && $cart_total_data->triple_infant != null && $cart_total_data->triple_infant != '' && $cart_total_data->triple_infant != 'null'){
                        $triple_infant = $cart_total_data->triple_infant;
                    }else{
                        $triple_infant = 0;
                    }
                    
                    if(isset($cart_total_data->quad_infant) && $cart_total_data->quad_infant != null && $cart_total_data->quad_infant != '' && $cart_total_data->quad_infant != 'null'){
                        $quad_infant = $cart_total_data->quad_infant;
                    }else{
                        $quad_infant = 0;
                    }
                    $total_infant  = $double_infant + $triple_infant + $quad_infant;
                    
                    $tour_booking_data =  DB::table('tours_bookings')->where('customer_id',$req->customer_id)->where('id',$value->booking_id)->select('passenger_detail')->first();;
                    ...
                    // $agent_name = $cart_total_data->agent_name;
                    // if(isset($cart_total_data->agent_name) && $cart_total_data->agent_name != null && $cart_total_data->agent_name != '' && $cart_total_data->agent_name != 0 && $cart_total_data->agent_name != -1){
                    //     $Agents_detail  = DB::table('Agents_detail')->where('id',$cart_total_data->agent_name)->where('customer_id',$req->customer_id)->first();
                    //     $agent_id       = $Agents_detail->id;
                    //     $agent_name     = $Agents_detail->company_name;
                    // }else{
                    //     if(isset($cart_total_data->customer_id) && $cart_total_data->customer_id != null && $cart_total_data->customer_id != '' && $cart_total_data->customer_id != 0 && $cart_total_data->customer_id != -1){
                    //         $customer_data  = DB::table('booking_customers')->where('id',$cart_total_data->customer_id)->where('customer_id',$req->customer_id)->first();
                    //         $agent_id       = $customer_data->id;
                    //         $agent_name     = $customer_data->name;
                    //     }else{
                    //         $agent_id   = '';
                    //         $agent_name = '';
                    //     }
        ...
        return response()->json([
            ...
            'atol_detail'           => $atol_detail,
            'addAtolFlightPackage'  => $addAtolFlightPackage,
            'package_Flights'       => $package_Flights,
        ]);
    }
/*
|--------------------------------------------------------------------------
...
*/
public function atol_Report_Weekly(Request $req){
        $customer_id            = $req->customer_id;
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)
                                    ->whereBetween('created_at', [Carbon::now()->subWeek()->startOfWeek(), Carbon::now()->subWeek()->endOfWeek()])
                                    ->whereJsonContains('services',['flights_tab'])->get();
        $atol_detail            = DB::table('addAtol')->where('customer_id',$req->customer_id)->get();
        $addAtolFlightPackage   = DB::table('addAtolFlightPackage')->where('customer_id',$req->customer_id)->first();
        ...
        // Package
        $cart_details           = DB::table('cart_details')->where('client_id',$req->customer_id)->whereBetween('created_at', [Carbon::now()->subWeek()->startOfWeek(), Carbon::now()->subWeek()->endOfWeek()])->where('pakage_type','tour')->get();
        if(isset($cart_details) && $cart_details != null && $cart_details != ''){
            foreach($cart_details as $value){
                $cart_total_data_E = $value->cart_total_data;
                if(isset($cart_total_data_E) && $cart_total_data_E != null && $cart_total_data_E != ''){
...
*/
public function atol_Report_Monthly(Request $req){
        $customer_id            = $req->customer_id;
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)
        ...
        // Package
        $cart_details           = DB::table('cart_details')->where('client_id',$req->customer_id)
                                    ->whereBetween('created_at', [Carbon::now()->subMonth()->startOfMonth(), Carbon::now()->subMonth()->endOfMonth()])
...
*/    
public function atol_Report_Quarter(Request $req){
        $customer_id            = $req->customer_id;
        $startDate              = \Carbon\Carbon::parse('January 1 last year');
        $endDate                = $startDate->copy()->addMonths(4)->subDay();
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)->whereJsonContains('services',['flights_tab'])->whereBetween('created_at', [$startDate, $endDate])->get();
        $atol_detail            = DB::table('addAtol')->where('customer_id',$req->customer_id)->get();
        $addAtolFlightPackage   = DB::table('addAtolFlightPackage')->where('customer_id',$req->customer_id)->first();
        
        // Package
        $package_Flights        = [];
        $cart_details           = DB::table('cart_details')->where('client_id',$req->customer_id)->where('pakage_type','tour')->whereBetween('created_at', [$startDate, $endDate])->get();
        if(isset($cart_details) && $cart_details != null && $cart_details != ''){
            foreach($cart_details as $value){
                $cart_total_data_E = $value->cart_total_data;
                if(isset($cart_total_data_E) && $cart_total_data_E != null && $cart_total_data_E != ''){
...
*/
public function atol_Report_Half_Yearly(Request $req){
        $customer_id            = $req->customer_id;
        $startDate              = \Carbon\Carbon::parse('January 1 last year');
...
*/
public function atol_Report_Yearly(Request $req){
        $customer_id            = $req->customer_id;
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)
...
*/
public function atol_Certificate(Request $req){
        $customer_id            = $req->customer_id;
        $all_countries          = country::all();
        $flight_invoice         = DB::table('add_manage_invoices')->where('customer_id',$req->customer_id)->whereJsonContains('services',['flights_tab'])->get();
        $atol_detail            = DB::table('addAtol')->where('customer_id',$req->customer_id)->get();
