...
class FlightReactController extends Controller
{
/*
|--------------------------------------------------------------------------
| FlightReactController Function Started
|--------------------------------------------------------------------------
*/ 
...
public function flight_search(Request $request){
        ...
        // $data = $request->all();
        $url = "https://api.synchtravel.com/alhijaztoursflightapi.php";
...
public function flight_invoice_new(Request $request){
    ...
    //print_r($result_view_reservation);die();
